...
Props for the [TooltipPopup](#tooltippopup) React component.

***

### TooltipPositionerProps {#tooltippositionerprops}

Props for the [TooltipPositioner](#tooltippositioner) React component.
...
Props for the [TooltipRoot](#tooltiproot) React component.
...
Props for the [TooltipTrigger](#tooltiptrigger) React component.
