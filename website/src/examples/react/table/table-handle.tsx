...
export function TableHandle() {
  ...
  return (
    <TableHandleRoot className="contents">
      <TableHandleColumnRoot className={Themes.CSS_TABLE_COLUMN_HANDLE}>
        <TableHandleColumnTrigger>
          <div className={Themes.CSS_ICON_TABLE_COLUMN_HANDLE}></div>
        </TableHandleColumnTrigger>
        <TableHandlePopoverContent className={Themes.CSS_TABLE_HANDLE_MENU}>
          {editor.commands.addTableColumnBefore.canExec() && (
            <TableHandlePopoverItem
              className={Themes.CSS_TABLE_CELL_MENU_ITEM}
          ...
          {editor.commands.deleteCellSelection.canExec() && (
            ...
            >
              ...
              <span className={Themes.CSS_TABLE_CELL_MENU_ITEM_SHORTCUT}>Del</span>
            </TableHandlePopoverItem>
          )}
      ...
      <TableHandleRowRoot className={Themes.CSS_TABLE_ROW_HANDLE}>
        <TableHandleRowTrigger>
