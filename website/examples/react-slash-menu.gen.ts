...
import file266588379 from '../../examples/react/src/slash-menu/app.tsx?raw'
import file1605607987 from '../../examples/react/src/slash-menu/extension.ts?raw'
import file1281700841 from '../../examples/react/src/slash-menu/slash-menu.css?raw'
...
const files = {
  '/app.tsx': { hidden: false, code: file266588379 },
  '/extension.ts': { hidden: false, code: file1605607987 },
  '/slash-menu.css': { hidden: false, code: file1281700841 },
