...
export const loaders = {
  ...
  'dsl-dot': lazy(() => import('./examples/dsl-dot').then((m) => ({ default: m.ExampleEditor }))),
  'dsl-mermaid': lazy(() => import('./examples/dsl-mermaid').then((m) => ({ default: m.ExampleEditor }))),
  'dsl-typst': lazy(() => import('./examples/dsl-typst').then((m) => ({ default: m.ExampleEditor }))),
