 ...
 * children.
 */
interface NodeBuilder<Attrs extends AnyAttrs = AnyAttrs> {
  /**
 ...
 */
interface NodeAction<Attrs extends AnyAttrs = AnyAttrs> extends NodeBuilder<Attrs> {
  /**
 ...
 * children.
 */
interface MarkBuilder<Attrs extends AnyAttrs = AnyAttrs> {
  /**
 ...
 */
interface MarkAction<Attrs extends AnyAttrs = AnyAttrs> extends MarkBuilder<Attrs> {
  /**
 ...
 */
type ExtractNodeBuilders<E extends Extension> = ToNodeBuilder<ExtractNodes<E>>;
/**
 ...
 */
type ExtractMarkBuilders<E extends Extension> = ToMarkBuilder<ExtractMarks<E>>;
/**
...
export { NodeChild as $, ExtractMarkBuilders as A, Priority as B, StepJSON as C, ExtractCommandCreators as D, ExtractCommandActions as E, ExtractTyping as F, ToMarkAction as G, NodeTyping as H, PlainExtension as I, CommandTyping as J, CommandAction as K, Union as L, ExtractNodeActions as M, ExtractNodeBuilders as N, ExtractCommands as O, ExtractNodes as P, NodeBuilder as Q, SimplifyUnion as R, StateJSON as S, ExtensionTyping as T, ToNodeAction as U, PickSubType as V, MarkTyping as W, MarkBuilder as X, MarkAction as Y, NodeAction as Z, nodeFromHTML as _, DOMDocumentOptions as a, NodeJSON as b, JSONParserOptions as c, htmlFromJSON as d, AnyAttrs as et, htmlFromNode as f, nodeFromElement as g, jsonFromState as h, createEditor as i, ExtractMarks as j, ExtractMarkActions as k, elementFromJSON as l, jsonFromNode as m, EditorInstance as n, DOMParserOptions as o, jsonFromHTML as p, CommandCreator as q, EditorOptions as r, DOMSerializerOptions as s, Editor as t, AttrSpec as tt, elementFromNode as u, nodeFromJSON as v, Extension as w, SelectionJSON as x, stateFromJSON as y, SimplifyDeeper as z };
