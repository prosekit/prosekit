 ...
 * @public
 */
export const TableHandleRowPositioner: Component<TableHandleRowPositionerProps> = TableHandleRowPositionerComponent as unknown as Component<TableHandleRowPositionerProps>;
