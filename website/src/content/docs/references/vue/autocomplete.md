...
Props for the [AutocompleteEmpty](#autocompleteempty) Vue component.

***

### AutocompleteItemProps {#autocompleteitemprops}

Props for the [AutocompleteItem](#autocompleteitem) Vue component.
...
Props for the [AutocompletePopup](#autocompletepopup) Vue component.
...
Props for the [AutocompletePositioner](#autocompletepositioner) Vue component.
...
Props for the [AutocompleteRoot](#autocompleteroot) Vue component.
...
<code data-typedoc-code><i>const</i> <a id="autocompleteempty" href="#autocompleteempty">AutocompleteEmpty</a>: `DefineSetupFnComponent`\<[`AutocompleteEmptyProps`](#autocompleteemptyprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="autocompleteitem" href="#autocompleteitem">AutocompleteItem</a>: `DefineSetupFnComponent`\<[`AutocompleteItemProps`](#autocompleteitemprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="autocompletepopup" href="#autocompletepopup">AutocompletePopup</a>: `DefineSetupFnComponent`\<[`AutocompletePopupProps`](#autocompletepopupprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="autocompletepositioner" href="#autocompletepositioner">AutocompletePositioner</a>: `DefineSetupFnComponent`\<[`AutocompletePositionerProps`](#autocompletepositionerprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="autocompleteroot" href="#autocompleteroot">AutocompleteRoot</a>: `DefineSetupFnComponent`\<[`AutocompleteRootProps`](#autocompleterootprops) & `HTMLAttributes`\></code>
