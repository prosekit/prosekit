...
Props for the [TooltipPopup](#tooltippopup) Vue component.

***

### TooltipPositionerProps {#tooltippositionerprops}

Props for the [TooltipPositioner](#tooltippositioner) Vue component.
...
Props for the [TooltipRoot](#tooltiproot) Vue component.
...
Props for the [TooltipTrigger](#tooltiptrigger) Vue component.
...
<code data-typedoc-code><i>const</i> <a id="tooltippopup" href="#tooltippopup">TooltipPopup</a>: `DefineSetupFnComponent`\<[`TooltipPopupProps`](#tooltippopupprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="tooltippositioner" href="#tooltippositioner">TooltipPositioner</a>: `DefineSetupFnComponent`\<[`TooltipPositionerProps`](#tooltippositionerprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="tooltiproot" href="#tooltiproot">TooltipRoot</a>: `DefineSetupFnComponent`\<[`TooltipRootProps`](#tooltiprootprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="tooltiptrigger" href="#tooltiptrigger">TooltipTrigger</a>: `DefineSetupFnComponent`\<[`TooltipTriggerProps`](#tooltiptriggerprops) & `HTMLAttributes`\></code>
