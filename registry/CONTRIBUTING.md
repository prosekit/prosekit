...
Add the `'use client'` directive to all React `.tsx` component files. Do not use it in Vue, Svelte, Solid, Preact, or other frameworks as it is specific to React Server Components.
