var mapping = {
  ...
  CSS_EDITOR_SCROLLING: "relative w-full flex-1 box-border overflow-y-scroll",
  CSS_EDITOR_CONTENT:
  ...
  CSS_INLINE_MENU_LINK_REMOVE_BUTTON:
  ...
  CSS_AUTOCOMPLETE_MENU_KEYBOARD:
    "text-xs font-mono text-gray-400 dark:text-gray-500",
  CSS_LANGUAGE_WRAPPER:
  ...
  CSS_IMAGE_UPLOAD_INPUT:
    "flex h-9 rounded-md w-full bg-white dark:bg-gray-950 px-3 py-2 text-sm placeholder:text-gray-500 dark:placeholder:text-gray-500 transition border box-border border-gray-200 dark:border-gray-800 border-solid ring-0 ring-transparent focus-visible:ring-2 focus-visible:ring-gray-900 dark:focus-visible:ring-gray-300 focus-visible:ring-offset-0 outline-none focus-visible:outline-none file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:cursor-not-allowed disabled:opacity-50",
  CSS_IMAGE_UPLOAD_BUTTON:
  ...
  CSS_IMAGE_RESIZEALE_IMAGE:
    "h-full w-full max-w-full max-h-full object-contain",
  CSS_IMAGE_RESIZEALE_HANDLE:
  ...
  CSS_IMAGE_UPLOAD_ERROR_MESSAGE: "hidden opacity-80 @xs:block",
  CSS_DROP_CURSOR: "transition-all bg-blue-500",
  CSS_BLOCK_HANDLE_POPOVER:
  ...
  CSS_TABLE_CELL_MENU_ITEM_SHORTCUT:
    "text-xs tracking-widest text-gray-500 dark:text-gray-500",
  CSS_TOOLTIP_TRIGGER: "block",
  CSS_TOOLTIP_CONTENT:
  ...
  CSS_SEARCH_CONTROLLER: "flex items-center justify-between gap-1",
  CSS_KEYMAP_FIELDSET:
    "mt-4 box-border flex max-w-full w-full overflow-x-auto border p-4 rounded-md shadow min-w-0",
  CSS_TOGGLE_ROTATE: "transition-transform data-[rotate]:rotate-90",
  CSS_ICON_ITALIC: "i-lucide-italic h-5 w-5",
  CSS_ICON_BOLD: "i-lucide-bold h-5 w-5",
  CSS_ICON_UNDERLINE: "i-lucide-underline h-5 w-5",
  CSS_ICON_STRIKE: "i-lucide-strikethrough h-5 w-5",
  CSS_ICON_CODE: "i-lucide-code h-5 w-5",
  CSS_ICON_H1: "i-lucide-heading-1 h-5 w-5",
  CSS_ICON_H2: "i-lucide-heading-2 h-5 w-5",
  CSS_ICON_H3: "i-lucide-heading-3 h-5 w-5",
  CSS_ICON_H4: "i-lucide-heading-4 h-5 w-5",
  CSS_ICON_H5: "i-lucide-heading-5 h-5 w-5",
  CSS_ICON_H6: "i-lucide-heading-6 h-5 w-5",
  CSS_ICON_UNDO: "i-lucide-undo-2 h-5 w-5",
  CSS_ICON_REDO: "i-lucide-redo-2 h-5 w-5",
  CSS_ICON_IMAGE: "i-lucide-image h-5 w-5",
  CSS_ICON_LINK: "i-lucide-link h-5 w-5",
  CSS_ICON_LIST_BULLET: "i-lucide-list h-5 w-5",
  CSS_ICON_LIST_ORDERED: "i-lucide-list-ordered h-5 w-5",
  CSS_ICON_LIST_TASK: "i-lucide-list-checks h-5 w-5",
  CSS_ICON_LIST_TOGGLE: "i-lucide-list-collapse h-5 w-5",
  CSS_ICON_LIST_INDENT: "i-lucide-indent-increase h-5 w-5",
  CSS_ICON_LIST_DEDENT: "i-lucide-indent-decrease h-5 w-5",
  CSS_ICON_CODE_BLOCK: "i-lucide-square-code h-5 w-5",
  CSS_ICON_CORNER_HANDLE: "i-lucide-arrow-down-right h-4 w-4",
  CSS_ICON_LOADER: "i-lucide-loader-circle h-4 w-4 animate-spin",
  CSS_ICON_DRAG_HANDLE: "i-lucide-grip-vertical h-5 w-5",
  CSS_ICON_PLUS: "i-lucide-plus h-5 w-5",
  CSS_ICON_SEARCH: "i-lucide-search h-5 w-5",
  CSS_ICON_CLOSE: "i-lucide-x h-5 w-5",
  CSS_ICON_ARROW_LEFT: "i-lucide-arrow-left h-5 w-5",
  CSS_ICON_ARROW_RIGHT: "i-lucide-arrow-right h-5 w-5",
  CSS_ICON_CHEVRON_RIGHT: "i-lucide-chevron-right h-5 w-5",
  CSS_ICON_TABLE_COLUMN_HANDLE: "i-lucide-grip-horizontal h-5 w-5",
  CSS_ICON_TABLE_ROW_HANDLE: "i-lucide-grip-vertical h-5 w-5",
  CSS_ICON_BLOCKQUOTE: "i-lucide-text-quote h-5 w-5",
  CSS_ICON_MINUS: "i-lucide-minus h-5 w-5",
  CSS_ICON_IMAGE_ERROR: "i-lucide-image-off h-8 w-8",
};
function replaceClassNames(code) {
