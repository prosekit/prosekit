---
title: Page
description: Page-break-aware container that paginates content for printing
---
...
The page extension supports printing via the browser's print dialog. The print output matches the on-screen page layout, so each page in the editor becomes a page in the printed document.
