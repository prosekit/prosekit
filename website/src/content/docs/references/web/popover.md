...
### PopoverPopupElement {#popoverpopupelement}

`<prosekit-popover-popup>` custom element.

Properties: [PopoverPopupProps](#popoverpopupprops)
...
<code data-typedoc-code>new <a id="constructor" href="#constructor">PopoverPopupElement</a>(): [`PopoverPopupElement`](#popoverpopupelement)</code>
...
### PopoverPositionerElement {#popoverpositionerelement}

`<prosekit-popover-positioner>` custom element.

Properties: [PopoverPositionerProps](#popoverpositionerprops)
...
<code data-typedoc-code>new <a id="constructor-1" href="#constructor-1">PopoverPositionerElement</a>(): [`PopoverPositionerElement`](#popoverpositionerelement)</code>
...
Properties: [PopoverRootProps](#popoverrootprops)

Events: [PopoverRootEvents](#popoverrootevents)
...
<code data-typedoc-code>new <a id="constructor-2" href="#constructor-2">PopoverRootElement</a>(): [`PopoverRootElement`](#popoverrootelement)</code>
...
<code data-typedoc-code><a id="modal" href="#modal">modal</a>: `boolean`</code>
...
Properties: [PopoverTriggerProps](#popovertriggerprops)

Events: [PopoverTriggerEvents](#popovertriggerevents)
...
<code data-typedoc-code>new <a id="constructor-3" href="#constructor-3">PopoverTriggerElement</a>(): [`PopoverTriggerElement`](#popovertriggerelement)</code>
...
<code data-typedoc-code><a id="openonhover" href="#openonhover">openOnHover</a>: `boolean`</code>
...
<code data-typedoc-code><a id="delay" href="#delay">delay</a>: `number`</code>
...
<code data-typedoc-code><a id="modal-1" href="#modal-1">modal</a>: `boolean`</code>
...
<code data-typedoc-code><a id="openonhover-1" href="#openonhover-1">openOnHover</a>: `boolean`</code>
...
<code data-typedoc-code><a id="delay-1" href="#delay-1">delay</a>: `number`</code>
...
### registerPopoverRootElement() {#registerpopoverrootelement}

<dl>

<dt>

<code data-typedoc-code><i>function</i> <a id="registerpopoverrootelement" href="#registerpopoverrootelement">registerPopoverRootElement</a>(): `void`</code>
...
### registerPopoverTriggerElement() {#registerpopovertriggerelement}

<dl>

<dt>

<code data-typedoc-code><i>function</i> <a id="registerpopovertriggerelement" href="#registerpopovertriggerelement">registerPopoverTriggerElement</a>(): `void`</code>
...
### registerPopoverPopupElement() {#registerpopoverpopupelement}

<dl>

<dt>

<code data-typedoc-code><i>function</i> <a id="registerpopoverpopupelement" href="#registerpopoverpopupelement">registerPopoverPopupElement</a>(): `void`</code>
...
### registerPopoverPositionerElement() {#registerpopoverpositionerelement}

<dl>

<dt>

<code data-typedoc-code><i>function</i> <a id="registerpopoverpositionerelement" href="#registerpopoverpositionerelement">registerPopoverPositionerElement</a>(): `void`</code>
