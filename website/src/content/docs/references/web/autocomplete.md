...
<code data-typedoc-declaration><i></i> new <a id="constructorautocompleteemptyelement" href="#constructorautocompleteemptyelement">AutocompleteEmptyElement</a>(): [`AutocompleteEmptyElement`](#autocompleteemptyelement)</code>
...
<code data-typedoc-declaration><i></i> new <a id="constructorautocompleteitemelement" href="#constructorautocompleteitemelement">AutocompleteItemElement</a>(): [`AutocompleteItemElement`](#autocompleteitemelement)</code>
...
<code data-typedoc-declaration><i></i> new <a id="constructorautocompletelistelement" href="#constructorautocompletelistelement">AutocompleteListElement</a>(): [`AutocompleteListElement`](#autocompletelistelement)</code>
...
<code data-typedoc-declaration><i></i> <a id="filter" href="#filter">filter</a>: `null` \| `ItemFilter`</code>
...
<code data-typedoc-declaration><i></i> new <a id="constructorautocompletepopoverelement" href="#constructorautocompletepopoverelement">AutocompletePopoverElement</a>(): [`AutocompletePopoverElement`](#autocompletepopoverelement)</code>
...
<code data-typedoc-declaration><i></i> <a id="offset" href="#offset">offset</a>: `undefined` \| `OffsetOptions`</code>
...
<code data-typedoc-declaration><i></i> <a id="regex" href="#regex">regex</a>: `null` \| [`RegExp`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/RegExp)</code>
...
<code data-typedoc-declaration><i></i> <a id="valuechange" href="#valuechange">valueChange</a>: [`CustomEvent`](https://developer.mozilla.org/docs/Web/API/CustomEvent)\<`string`\></code>
...
<code data-typedoc-declaration><i></i> <a id="filter-1" href="#filter-1">filter</a>: `null` \| `ItemFilter`</code>
...
<code data-typedoc-declaration><i></i> <a id="openchange" href="#openchange">openChange</a>: [`CustomEvent`](https://developer.mozilla.org/docs/Web/API/CustomEvent)\<`boolean`\></code>
...
<code data-typedoc-declaration><i></i> <a id="querychange" href="#querychange">queryChange</a>: [`CustomEvent`](https://developer.mozilla.org/docs/Web/API/CustomEvent)\<`string`\></code>
...
<code data-typedoc-declaration><i></i> <a id="regex-1" href="#regex-1">regex</a>: `null` \| [`RegExp`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/RegExp)</code>
...
<code data-typedoc-declaration><i>const</i> <a id="autocompletelistevents-1" href="#autocompletelistevents-1">autocompleteListEvents</a>: `EventDeclarations`\<[`AutocompleteListEvents`](#autocompletelistevents)\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="autocompletelistprops-1" href="#autocompletelistprops-1">autocompleteListProps</a>: `PropDeclarations`\<[`AutocompleteListProps`](#autocompletelistprops)\></code>
