...
<code data-typedoc-code>new <a id="constructor-4" href="#constructor-4">BlockHandleStateChangeEvent</a>(`state`: \{ `node`: [`ProseMirrorNode`](../pm/model.md#prosemirrornode); `pos`: `number`; \} \| `null`): [`BlockHandleStateChangeEvent`](#blockhandlestatechangeevent)</code>
...
<code data-typedoc-code><a id="detail" href="#detail">detail</a>: \{ `node`: [`ProseMirrorNode`](../pm/model.md#prosemirrornode); `pos`: `number`; \} \| `null`</code>
