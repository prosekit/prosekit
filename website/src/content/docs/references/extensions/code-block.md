...
### CodeBlockShikiOptions {#codeblockshikioptions}
...
<code data-typedoc-code><a id="nodetypes-1" href="#nodetypes-1">nodeTypes</a><i>?</i>: `string`[]</code>
...
<code data-typedoc-code><a id="themes" href="#themes">themes</a><i>?</i>: [`ShikiBundledTheme`](#shikibundledtheme)[]</code>
...
<code data-typedoc-code><a id="langs" href="#langs">langs</a><i>?</i>: ([`ShikiBundledLanguage`](#shikibundledlanguage) \| `SpecialLanguage`)[]</code>
...
<code data-typedoc-code><a id="engine" href="#engine">engine</a><i>?</i>: `Awaitable`\<`RegexEngine`\></code>
...
<code data-typedoc-code><a id="warnings" href="#warnings">warnings</a><i>?</i>: `boolean`</code>
...
<code data-typedoc-code><a id="langalias" href="#langalias">langAlias</a><i>?</i>: [`Record`](https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeys-type)\<`string`, `StringLiteralUnion`\<[`ShikiBundledLanguage`](#shikibundledlanguage), `string`\>\></code>
...
<code data-typedoc-code>type <a id="codeblockhighlightoptions" href="#codeblockhighlightoptions">CodeBlockHighlightOptions</a> = \{ `parser`: [`HighlightParser`](#highlightparser); `nodeTypes?`: `string`[]; \}</code>
...
<code data-typedoc-code><a id="nodetypes" href="#nodetypes">nodeTypes</a><i>?</i>: `string`[]</code>
...
### defineCodeBlockPreviewPlugin() {#definecodeblockpreviewplugin}

<dl>

<dt>

<code data-typedoc-code><i>function</i> <a id="definecodeblockpreviewplugin" href="#definecodeblockpreviewplugin">defineCodeBlockPreviewPlugin</a>(): `PlainExtension`</code>

</dt>

<dd>

Defines a plugin that adds a decoration to hide the code block preview when the cursor is inside a code block. Use [isCodeBlockPreviewHiddenDecoration](#iscodeblockpreviewhiddendecoration) to check whether a given decoration hides the code block preview.
...
### isCodeBlockPreviewHiddenDecoration() {#iscodeblockpreviewhiddendecoration}

<dl>

<dt>

<code data-typedoc-code><i>function</i> <a id="iscodeblockpreviewhiddendecoration" href="#iscodeblockpreviewhiddendecoration">isCodeBlockPreviewHiddenDecoration</a>(`decoration`: [`Decoration`](../pm/view.md#decoration)): `boolean`</code>
...
<code data-typedoc-code><i>function</i> <a id="definecodeblockshiki" href="#definecodeblockshiki">defineCodeBlockShiki</a>(`options?`: [`CodeBlockShikiOptions`](#codeblockshikioptions)): [`Extension`](../core.md#extension-1)</code>
