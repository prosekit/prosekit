...
<code data-typedoc-code><a id="statechange" href="#statechange">stateChange</a>: [`CustomEvent`](https://developer.mozilla.org/docs/Web/API/CustomEvent)\<\{ `node`: [`ProseMirrorNode`](../pm/model.md#prosemirrornode); `pos`: `number`; \} \| `null`\></code>
