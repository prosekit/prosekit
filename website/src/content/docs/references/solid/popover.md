...
<code data-typedoc-declaration><i>const</i> <a id="popovercontent" href="#popovercontent">PopoverContent</a>: `Component`\<`PropsWithElement`\<[`PopoverContentProps`](#popovercontentprops), [`PopoverContentElement`](../web/popover.md#popovercontentelement)\>\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="popoverroot" href="#popoverroot">PopoverRoot</a>: `Component`\<`PropsWithElement`\<[`PopoverRootProps`](#popoverrootprops), [`PopoverRootElement`](../web/popover.md#popoverrootelement)\>\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="popovertrigger" href="#popovertrigger">PopoverTrigger</a>: `Component`\<`PropsWithElement`\<[`PopoverTriggerProps`](#popovertriggerprops), [`PopoverTriggerElement`](../web/popover.md#popovertriggerelement)\>\></code>
