...
/**
 * Props for the {@link ListboxRoot} React component.
 *
 * @public
 */
...
function ListboxRootComponent(
  ...
  forwardedRef: ForwardedRef<ListboxRootElement>,
) {
  registerListboxRootElement();
...
/**
 * A React component that renders an `aria-ui-listbox-root` custom element.
 *
 * @public
 */
