 ...
 */
export function createMarkPasteRuleHandler(options: MarkPasteRuleOptions): ({ slice, view }: { slice: Slice; view: EditorView }) => Slice {
...
function replaceMarkInFragment(options: MarkPasteRuleOptions, fragment: Fragment): Fragment | undefined {
  let changed = false
...
function replaceMarkInNode(options: MarkPasteRuleOptions, node: ProseMirrorNode): ProseMirrorNode | undefined {
...
function replaceMarkInTextblockNode(options: MarkPasteRuleOptions, node: ProseMirrorNode): ProseMirrorNode | undefined {
...
function replaceMarkInInlineNode(options: MarkPasteRuleOptions, node: ProseMirrorNode): ProseMirrorNode[] | undefined {
