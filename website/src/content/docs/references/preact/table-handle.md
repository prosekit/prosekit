---
title: prosekit/preact/table-handle
sidebar:
  label: preact/table-handle
---
...
Props for the [TableHandleColumnMenuRoot](#tablehandlecolumnmenuroot) Preact component.
...
Props for the [TableHandleColumnMenuTrigger](#tablehandlecolumnmenutrigger) Preact component.

***

### TableHandleColumnPopupProps {#tablehandlecolumnpopupprops}

Props for the [TableHandleColumnPopup](#tablehandlecolumnpopup) Preact component.

***

### TableHandleColumnPositionerProps {#tablehandlecolumnpositionerprops}

Props for the [TableHandleColumnPositioner](#tablehandlecolumnpositioner) Preact component.
...
Props for the [TableHandleDragPreview](#tablehandledragpreview) Preact component.

***

### TableHandleDropIndicatorProps {#tablehandledropindicatorprops}

Props for the [TableHandleDropIndicator](#tablehandledropindicator) Preact component.

***

### TableHandleRootProps {#tablehandlerootprops}

Props for the [TableHandleRoot](#tablehandleroot) Preact component.

***

### TableHandleRowMenuRootProps {#tablehandlerowmenurootprops}

Props for the [TableHandleRowMenuRoot](#tablehandlerowmenuroot) Preact component.
...
Props for the [TableHandleRowMenuTrigger](#tablehandlerowmenutrigger) Preact component.

***

### TableHandleRowPopupProps {#tablehandlerowpopupprops}

Props for the [TableHandleRowPopup](#tablehandlerowpopup) Preact component.

***

### TableHandleRowPositionerProps {#tablehandlerowpositionerprops}

Props for the [TableHandleRowPositioner](#tablehandlerowpositioner) Preact component.
...
<code data-typedoc-code><i>const</i> <a id="tablehandlecolumnmenuroot" href="#tablehandlecolumnmenuroot">TableHandleColumnMenuRoot</a>: `ForwardRefExoticComponent`\<[`TableHandleColumnMenuRootProps`](#tablehandlecolumnmenurootprops) & `HTMLAttributes`\<[`TableHandleColumnMenuRootElement`](../web/table-handle.md#tablehandlecolumnmenurootelement)\> & `RefAttributes`\<[`TableHandleColumnMenuRootElement`](../web/table-handle.md#tablehandlecolumnmenurootelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlecolumnmenutrigger" href="#tablehandlecolumnmenutrigger">TableHandleColumnMenuTrigger</a>: `ForwardRefExoticComponent`\<[`TableHandleColumnMenuTriggerProps`](#tablehandlecolumnmenutriggerprops) & `HTMLAttributes`\<[`TableHandleColumnMenuTriggerElement`](../web/table-handle.md#tablehandlecolumnmenutriggerelement)\> & `RefAttributes`\<[`TableHandleColumnMenuTriggerElement`](../web/table-handle.md#tablehandlecolumnmenutriggerelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlecolumnpopup" href="#tablehandlecolumnpopup">TableHandleColumnPopup</a>: `ForwardRefExoticComponent`\<[`TableHandleColumnPopupProps`](#tablehandlecolumnpopupprops) & `HTMLAttributes`\<[`TableHandleColumnPopupElement`](../web/table-handle.md#tablehandlecolumnpopupelement)\> & `RefAttributes`\<[`TableHandleColumnPopupElement`](../web/table-handle.md#tablehandlecolumnpopupelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlecolumnpositioner" href="#tablehandlecolumnpositioner">TableHandleColumnPositioner</a>: `ForwardRefExoticComponent`\<[`TableHandleColumnPositionerProps`](#tablehandlecolumnpositionerprops) & `HTMLAttributes`\<[`TableHandleColumnPositionerElement`](../web/table-handle.md#tablehandlecolumnpositionerelement)\> & `RefAttributes`\<[`TableHandleColumnPositionerElement`](../web/table-handle.md#tablehandlecolumnpositionerelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandledragpreview" href="#tablehandledragpreview">TableHandleDragPreview</a>: `ForwardRefExoticComponent`\<[`TableHandleDragPreviewProps`](#tablehandledragpreviewprops) & `HTMLAttributes`\<[`TableHandleDragPreviewElement`](../web/table-handle.md#tablehandledragpreviewelement)\> & `RefAttributes`\<[`TableHandleDragPreviewElement`](../web/table-handle.md#tablehandledragpreviewelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandledropindicator" href="#tablehandledropindicator">TableHandleDropIndicator</a>: `ForwardRefExoticComponent`\<[`TableHandleDropIndicatorProps`](#tablehandledropindicatorprops) & `HTMLAttributes`\<[`TableHandleDropIndicatorElement`](../web/table-handle.md#tablehandledropindicatorelement)\> & `RefAttributes`\<[`TableHandleDropIndicatorElement`](../web/table-handle.md#tablehandledropindicatorelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandleroot" href="#tablehandleroot">TableHandleRoot</a>: `ForwardRefExoticComponent`\<[`TableHandleRootProps`](#tablehandlerootprops) & `HTMLAttributes`\<[`TableHandleRootElement`](../web/table-handle.md#tablehandlerootelement)\> & `RefAttributes`\<[`TableHandleRootElement`](../web/table-handle.md#tablehandlerootelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlerowmenuroot" href="#tablehandlerowmenuroot">TableHandleRowMenuRoot</a>: `ForwardRefExoticComponent`\<[`TableHandleRowMenuRootProps`](#tablehandlerowmenurootprops) & `HTMLAttributes`\<[`TableHandleRowMenuRootElement`](../web/table-handle.md#tablehandlerowmenurootelement)\> & `RefAttributes`\<[`TableHandleRowMenuRootElement`](../web/table-handle.md#tablehandlerowmenurootelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlerowmenutrigger" href="#tablehandlerowmenutrigger">TableHandleRowMenuTrigger</a>: `ForwardRefExoticComponent`\<[`TableHandleRowMenuTriggerProps`](#tablehandlerowmenutriggerprops) & `HTMLAttributes`\<[`TableHandleRowMenuTriggerElement`](../web/table-handle.md#tablehandlerowmenutriggerelement)\> & `RefAttributes`\<[`TableHandleRowMenuTriggerElement`](../web/table-handle.md#tablehandlerowmenutriggerelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlerowpopup" href="#tablehandlerowpopup">TableHandleRowPopup</a>: `ForwardRefExoticComponent`\<[`TableHandleRowPopupProps`](#tablehandlerowpopupprops) & `HTMLAttributes`\<[`TableHandleRowPopupElement`](../web/table-handle.md#tablehandlerowpopupelement)\> & `RefAttributes`\<[`TableHandleRowPopupElement`](../web/table-handle.md#tablehandlerowpopupelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlerowpositioner" href="#tablehandlerowpositioner">TableHandleRowPositioner</a>: `ForwardRefExoticComponent`\<[`TableHandleRowPositionerProps`](#tablehandlerowpositionerprops) & `HTMLAttributes`\<[`TableHandleRowPositionerElement`](../web/table-handle.md#tablehandlerowpositionerelement)\> & `RefAttributes`\<[`TableHandleRowPositionerElement`](../web/table-handle.md#tablehandlerowpositionerelement)\>\></code>
