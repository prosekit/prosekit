...
<code data-typedoc-code><i>function</i> <a id="triggerautocomplete" href="#triggerautocomplete">triggerAutocomplete</a>(`tr`: [`Transaction`](../pm/state.md#transaction)): [`Transaction`](../pm/state.md#transaction)</code>
