...
Props for the [PopoverPopup](#popoverpopup) React component.

***

### PopoverPositionerProps {#popoverpositionerprops}

Props for the [PopoverPositioner](#popoverpositioner) React component.
...
Props for the [PopoverRoot](#popoverroot) React component.
...
Props for the [PopoverTrigger](#popovertrigger) React component.
