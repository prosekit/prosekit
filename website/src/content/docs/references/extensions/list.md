...
<code data-typedoc-code><a id="kind" href="#kind">kind</a><i>?</i>: `"toggle"` \| `"task"` \| `"bullet"` \| `"ordered"`</code>
...
<code data-typedoc-code><a id="order" href="#order">order</a><i>?</i>: `number` \| `null`</code>
...
<code data-typedoc-code><i>function</i> <a id="insertlist" href="#insertlist">insertList</a>(`attrs?`: `ListAttributes`): [`Command`](../pm/state.md#command)</code>
