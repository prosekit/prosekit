...
<code data-typedoc-code><a id="forchild-2" href="#forchild-2">forChild</a>(`offset`: `number`, `node`: [`ProseMirrorNode`](model.md#prosemirrornode)): [`DecorationSet`](#decorationset) \| `DecorationGroup`</code>
...
<code data-typedoc-code><a id="createselectionbetween" href="#createselectionbetween">createSelectionBetween</a><i>?</i>: (`this`: `P`, `view`: [`EditorView`](#editorview), `anchor`: [`ResolvedPos`](model.md#resolvedpos), `head`: [`ResolvedPos`](model.md#resolvedpos)) => [`Selection`](state.md#selection-3) \| `null`</code>
...
<code data-typedoc-code><a id="createselectionbetween-1" href="#createselectionbetween-1">createSelectionBetween</a><i>?</i>: (`this`: `any`, `view`: [`EditorView`](#editorview), `anchor`: [`ResolvedPos`](model.md#resolvedpos), `head`: [`ResolvedPos`](model.md#resolvedpos)) => [`Selection`](state.md#selection-3) \| `null`</code>
