...
/**
 * Props for the {@link BlockHandlePopover} Vue component.
 *
 * @public
 */
...
/**
 * A Vue component that renders an `prosekit-block-handle-popover` custom element.
 *
 * @public
 */
export const BlockHandlePopover: DefineSetupFnComponent<
  BlockHandlePopoverProps & HTMLAttributes
> = /* @__PURE__ */ defineComponent<BlockHandlePopoverProps & HTMLAttributes>(
  (props, { slots }) => {
    registerBlockHandlePopoverElement();
