...
Props for the [PopoverPopup](#popoverpopup) Vue component.

***

### PopoverPositionerProps {#popoverpositionerprops}

Props for the [PopoverPositioner](#popoverpositioner) Vue component.
...
Props for the [PopoverRoot](#popoverroot) Vue component.
...
Props for the [PopoverTrigger](#popovertrigger) Vue component.
...
<code data-typedoc-code><i>const</i> <a id="popoverpopup" href="#popoverpopup">PopoverPopup</a>: `DefineSetupFnComponent`\<[`PopoverPopupProps`](#popoverpopupprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="popoverpositioner" href="#popoverpositioner">PopoverPositioner</a>: `DefineSetupFnComponent`\<[`PopoverPositionerProps`](#popoverpositionerprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="popoverroot" href="#popoverroot">PopoverRoot</a>: `DefineSetupFnComponent`\<[`PopoverRootProps`](#popoverrootprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="popovertrigger" href="#popovertrigger">PopoverTrigger</a>: `DefineSetupFnComponent`\<[`PopoverTriggerProps`](#popovertriggerprops) & `HTMLAttributes`\></code>
