...
Emits for the [BlockHandleAdd](block-handle.md#block-handle-add-4) component.
...
Emits for the [BlockHandleDraggable](block-handle.md#block-handle-draggable-4) component.
...
Emits for the [BlockHandlePopover](block-handle.md#block-handle-popover-4) component.
