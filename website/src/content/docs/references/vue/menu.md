...
Props for the [MenuItem](#menuitem) Vue component.
...
Props for the [MenuPopup](#menupopup) Vue component.
...
Props for the [MenuPositioner](#menupositioner) Vue component.
...
Props for the [MenuRoot](#menuroot) Vue component.
...
Props for the [MenuSubmenuRoot](#menusubmenuroot) Vue component.
...
Props for the [MenuSubmenuTrigger](#menusubmenutrigger) Vue component.
...
Props for the [MenuTrigger](#menutrigger) Vue component.
...
<code data-typedoc-code><i>const</i> <a id="menuitem" href="#menuitem">MenuItem</a>: `DefineSetupFnComponent`\<[`MenuItemProps`](#menuitemprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="menupopup" href="#menupopup">MenuPopup</a>: `DefineSetupFnComponent`\<[`MenuPopupProps`](#menupopupprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="menupositioner" href="#menupositioner">MenuPositioner</a>: `DefineSetupFnComponent`\<[`MenuPositionerProps`](#menupositionerprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="menuroot" href="#menuroot">MenuRoot</a>: `DefineSetupFnComponent`\<[`MenuRootProps`](#menurootprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="menusubmenuroot" href="#menusubmenuroot">MenuSubmenuRoot</a>: `DefineSetupFnComponent`\<[`MenuSubmenuRootProps`](#menusubmenurootprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="menusubmenutrigger" href="#menusubmenutrigger">MenuSubmenuTrigger</a>: `DefineSetupFnComponent`\<[`MenuSubmenuTriggerProps`](#menusubmenutriggerprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="menutrigger" href="#menutrigger">MenuTrigger</a>: `DefineSetupFnComponent`\<[`MenuTriggerProps`](#menutriggerprops) & `HTMLAttributes`\></code>
