...
Props for the [PopoverPopup](#popoverpopup) Preact component.

***

### PopoverPositionerProps {#popoverpositionerprops}

Props for the [PopoverPositioner](#popoverpositioner) Preact component.
...
Props for the [PopoverRoot](#popoverroot) Preact component.
...
Props for the [PopoverTrigger](#popovertrigger) Preact component.
...
<code data-typedoc-code><i>const</i> <a id="popoverpopup" href="#popoverpopup">PopoverPopup</a>: `ForwardRefExoticComponent`\<[`PopoverPopupProps`](#popoverpopupprops) & `HTMLAttributes`\<[`PopoverPopupElement`](../web/popover.md#popoverpopupelement)\> & `RefAttributes`\<[`PopoverPopupElement`](../web/popover.md#popoverpopupelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="popoverpositioner" href="#popoverpositioner">PopoverPositioner</a>: `ForwardRefExoticComponent`\<[`PopoverPositionerProps`](#popoverpositionerprops) & `HTMLAttributes`\<[`PopoverPositionerElement`](../web/popover.md#popoverpositionerelement)\> & `RefAttributes`\<[`PopoverPositionerElement`](../web/popover.md#popoverpositionerelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="popoverroot" href="#popoverroot">PopoverRoot</a>: `ForwardRefExoticComponent`\<[`PopoverRootProps`](#popoverrootprops) & `HTMLAttributes`\<[`PopoverRootElement`](../web/popover.md#popoverrootelement)\> & `RefAttributes`\<[`PopoverRootElement`](../web/popover.md#popoverrootelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="popovertrigger" href="#popovertrigger">PopoverTrigger</a>: `ForwardRefExoticComponent`\<[`PopoverTriggerProps`](#popovertriggerprops) & `HTMLAttributes`\<[`PopoverTriggerElement`](../web/popover.md#popovertriggerelement)\> & `RefAttributes`\<[`PopoverTriggerElement`](../web/popover.md#popovertriggerelement)\>\></code>
