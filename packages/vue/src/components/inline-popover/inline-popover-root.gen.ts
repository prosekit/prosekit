 ...
 * @public
 */
export const InlinePopoverRoot: DefineSetupFnComponent<
  InlinePopoverRootProps & HTMLAttributes
> = /* @__PURE__ */ defineComponent<InlinePopoverRootProps & HTMLAttributes>(
  (props, { slots }) => {
    registerInlinePopoverRootElement();
