...
Props for the [MenuItem](#menuitem) Solid component.
...
Props for the [MenuPopup](#menupopup) Solid component.
...
Props for the [MenuPositioner](#menupositioner) Solid component.
...
Props for the [MenuRoot](#menuroot) Solid component.
...
Props for the [MenuSubmenuRoot](#menusubmenuroot) Solid component.
...
Props for the [MenuSubmenuTrigger](#menusubmenutrigger) Solid component.
...
Props for the [MenuTrigger](#menutrigger) Solid component.
...
<code data-typedoc-code><i>const</i> <a id="menuitem" href="#menuitem">MenuItem</a>: `Component`\<[`MenuItemProps`](#menuitemprops) & `JSX.HTMLAttributes`\<[`MenuItemElement`](../web/menu.md#menuitemelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="menupopup" href="#menupopup">MenuPopup</a>: `Component`\<[`MenuPopupProps`](#menupopupprops) & `JSX.HTMLAttributes`\<[`MenuPopupElement`](../web/menu.md#menupopupelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="menupositioner" href="#menupositioner">MenuPositioner</a>: `Component`\<[`MenuPositionerProps`](#menupositionerprops) & `JSX.HTMLAttributes`\<[`MenuPositionerElement`](../web/menu.md#menupositionerelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="menuroot" href="#menuroot">MenuRoot</a>: `Component`\<[`MenuRootProps`](#menurootprops) & `JSX.HTMLAttributes`\<[`MenuRootElement`](../web/menu.md#menurootelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="menusubmenuroot" href="#menusubmenuroot">MenuSubmenuRoot</a>: `Component`\<[`MenuSubmenuRootProps`](#menusubmenurootprops) & `JSX.HTMLAttributes`\<[`MenuSubmenuRootElement`](../web/menu.md#menusubmenurootelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="menusubmenutrigger" href="#menusubmenutrigger">MenuSubmenuTrigger</a>: `Component`\<[`MenuSubmenuTriggerProps`](#menusubmenutriggerprops) & `JSX.HTMLAttributes`\<[`MenuSubmenuTriggerElement`](../web/menu.md#menusubmenutriggerelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="menutrigger" href="#menutrigger">MenuTrigger</a>: `Component`\<[`MenuTriggerProps`](#menutriggerprops) & `JSX.HTMLAttributes`\<[`MenuTriggerElement`](../web/menu.md#menutriggerelement)\>\></code>
