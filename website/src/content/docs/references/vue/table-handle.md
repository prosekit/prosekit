...
Props for the [TableHandleColumnMenuRoot](#tablehandlecolumnmenuroot) Vue component.
...
Props for the [TableHandleColumnMenuTrigger](#tablehandlecolumnmenutrigger) Vue component.

***

### TableHandleColumnPopupProps {#tablehandlecolumnpopupprops}

Props for the [TableHandleColumnPopup](#tablehandlecolumnpopup) Vue component.

***

### TableHandleColumnPositionerProps {#tablehandlecolumnpositionerprops}

Props for the [TableHandleColumnPositioner](#tablehandlecolumnpositioner) Vue component.
...
Props for the [TableHandleDragPreview](#tablehandledragpreview) Vue component.

***

### TableHandleDropIndicatorProps {#tablehandledropindicatorprops}

Props for the [TableHandleDropIndicator](#tablehandledropindicator) Vue component.

***

### TableHandleRootProps {#tablehandlerootprops}

Props for the [TableHandleRoot](#tablehandleroot) Vue component.

***

### TableHandleRowMenuRootProps {#tablehandlerowmenurootprops}

Props for the [TableHandleRowMenuRoot](#tablehandlerowmenuroot) Vue component.
...
Props for the [TableHandleRowMenuTrigger](#tablehandlerowmenutrigger) Vue component.

***

### TableHandleRowPopupProps {#tablehandlerowpopupprops}

Props for the [TableHandleRowPopup](#tablehandlerowpopup) Vue component.

***

### TableHandleRowPositionerProps {#tablehandlerowpositionerprops}

Props for the [TableHandleRowPositioner](#tablehandlerowpositioner) Vue component.
...
<code data-typedoc-code><i>const</i> <a id="tablehandlecolumnmenuroot" href="#tablehandlecolumnmenuroot">TableHandleColumnMenuRoot</a>: `DefineSetupFnComponent`\<[`TableHandleColumnMenuRootProps`](#tablehandlecolumnmenurootprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlecolumnmenutrigger" href="#tablehandlecolumnmenutrigger">TableHandleColumnMenuTrigger</a>: `DefineSetupFnComponent`\<[`TableHandleColumnMenuTriggerProps`](#tablehandlecolumnmenutriggerprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlecolumnpopup" href="#tablehandlecolumnpopup">TableHandleColumnPopup</a>: `DefineSetupFnComponent`\<[`TableHandleColumnPopupProps`](#tablehandlecolumnpopupprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlecolumnpositioner" href="#tablehandlecolumnpositioner">TableHandleColumnPositioner</a>: `DefineSetupFnComponent`\<[`TableHandleColumnPositionerProps`](#tablehandlecolumnpositionerprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandledragpreview" href="#tablehandledragpreview">TableHandleDragPreview</a>: `DefineSetupFnComponent`\<[`TableHandleDragPreviewProps`](#tablehandledragpreviewprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandledropindicator" href="#tablehandledropindicator">TableHandleDropIndicator</a>: `DefineSetupFnComponent`\<[`TableHandleDropIndicatorProps`](#tablehandledropindicatorprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandleroot" href="#tablehandleroot">TableHandleRoot</a>: `DefineSetupFnComponent`\<[`TableHandleRootProps`](#tablehandlerootprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlerowmenuroot" href="#tablehandlerowmenuroot">TableHandleRowMenuRoot</a>: `DefineSetupFnComponent`\<[`TableHandleRowMenuRootProps`](#tablehandlerowmenurootprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlerowmenutrigger" href="#tablehandlerowmenutrigger">TableHandleRowMenuTrigger</a>: `DefineSetupFnComponent`\<[`TableHandleRowMenuTriggerProps`](#tablehandlerowmenutriggerprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlerowpopup" href="#tablehandlerowpopup">TableHandleRowPopup</a>: `DefineSetupFnComponent`\<[`TableHandleRowPopupProps`](#tablehandlerowpopupprops) & `HTMLAttributes`\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlerowpositioner" href="#tablehandlerowpositioner">TableHandleRowPositioner</a>: `DefineSetupFnComponent`\<[`TableHandleRowPositionerProps`](#tablehandlerowpositionerprops) & `HTMLAttributes`\></code>
