...
- `CreateEmits`\<[`BlockHandlePopoverEvents`](../web/block-handle.md#blockhandlepopoverevents)\>
...
<code data-typedoc-declaration><i></i> <a id="statechange" href="#statechange">stateChange</a>: (`event`: `null` \| \{ `node`: [`ProseMirrorNode`](../pm/model.md#prosemirrornode); `pos`: `number`; \}) => `void`</code>
...
<code data-typedoc-declaration><i>const</i> <a id="blockhandleadd" href="#blockhandleadd">BlockHandleAdd</a>: `DefineSetupFnComponent`\<[`BlockHandleAddProps`](#blockhandleaddprops) & `HTMLAttributes`, [`BlockHandleAddEmits`](#blockhandleaddemits)\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="blockhandledraggable" href="#blockhandledraggable">BlockHandleDraggable</a>: `DefineSetupFnComponent`\<[`BlockHandleDraggableProps`](#blockhandledraggableprops) & `HTMLAttributes`, [`BlockHandleDraggableEmits`](#blockhandledraggableemits)\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="blockhandlepopover" href="#blockhandlepopover">BlockHandlePopover</a>: `DefineSetupFnComponent`\<[`BlockHandlePopoverProps`](#blockhandlepopoverprops) & `HTMLAttributes`, [`BlockHandlePopoverEmits`](#blockhandlepopoveremits)\></code>
