...
```ts
function AutocompleteEmpty(props: AutocompleteEmptyProps & RefAttributes<AutocompleteEmptyElement> & HTMLAttributes<AutocompleteEmptyElement>): ReactNode
```

## AutocompleteItem {#autocomplete-item-1}

```ts
function AutocompleteItem(props: AutocompleteItemProps & RefAttributes<AutocompleteItemElement> & HTMLAttributes<AutocompleteItemElement>): ReactNode
```

## AutocompleteList {#autocomplete-list-1}

```ts
function AutocompleteList(props: AutocompleteListProps & RefAttributes<AutocompleteListElement> & HTMLAttributes<AutocompleteListElement>): ReactNode
```

## AutocompletePopover {#autocomplete-popover-1}

```ts
function AutocompletePopover(props: AutocompletePopoverProps & RefAttributes<AutocompletePopoverElement> & HTMLAttributes<AutocompletePopoverElement>): ReactNode
```
