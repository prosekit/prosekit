...
<code data-typedoc-code><a id="mount" href="#mount">mount</a>(`place`: [`HTMLElement`](https://developer.mozilla.org/docs/Web/API/HTMLElement) \| `null` \| `undefined`): `void` \| `VoidFunction`</code>
...
<code data-typedoc-code><a id="setcontent" href="#setcontent">setContent</a>(`content`: `string` \| [`EditorNode`](pm/model.md#editornode) \| [`NodeJSON`](#nodejson) \| [`Element`](https://developer.mozilla.org/docs/Web/API/Element), `selection?`: [`Selection`](pm/state.md#abstract-selection) \| `"start"` \| [`SelectionJSON`](#selectionjson) \| `"end"`): `void`</code>
...
<code data-typedoc-code><a id="attrs" href="#attrs">attrs</a><i>?</i>: [`Attrs`](pm/model.md#attrs-4) \| `null`</code>
...
<code data-typedoc-code><a id="node" href="#node">node</a><i>?</i>: [`EditorNode`](pm/model.md#editornode)</code>
...
<code data-typedoc-code><a id="attrs-2" href="#attrs-2">attrs</a><i>?</i>: [`Attrs`](pm/model.md#attrs-4) \| `null`</code>
...
<code data-typedoc-code><a id="attrs-3" href="#attrs-3">attrs</a><i>?</i>: [`Attrs`](pm/model.md#attrs-4) \| `null`</code>
...
### SetNodeAttrsBetweenOptions {#setnodeattrsbetweenoptions}
...
<code data-typedoc-code><a id="type-6" href="#type-6">type</a>: `string` \| `string`[] \| [`NodeType`](pm/model.md#nodetype) \| [`NodeType`](pm/model.md#nodetype)[]</code>
...
<code data-typedoc-code><a id="type-7" href="#type-7">type</a>: `string` \| `string`[] \| [`NodeType`](pm/model.md#nodetype) \| [`NodeType`](pm/model.md#nodetype)[]</code>
...
<code data-typedoc-code><a id="attrs-5" href="#attrs-5">attrs</a>: [`Attrs`](pm/model.md#attrs-4)</code>
...
<code data-typedoc-code><a id="type-8" href="#type-8">type</a>: `string` \| [`MarkType`](pm/model.md#marktype-1)</code>
...
<code data-typedoc-code><a id="attrs-6" href="#attrs-6">attrs</a><i>?</i>: [`Attrs`](pm/model.md#attrs-4) \| `null`</code>
...
<code data-typedoc-code><a id="attrs-7" href="#attrs-7">attrs</a><i>?</i>: [`Attrs`](pm/model.md#attrs-4) \| `null`</code>
...
<code data-typedoc-code><a id="attrs-8" href="#attrs-8">attrs</a><i>?</i>: [`Attrs`](pm/model.md#attrs-4) \| `null`</code>
...
<code data-typedoc-code><a id="type-11" href="#type-11">type</a>: `string` \| [`NodeType`](pm/model.md#nodetype)</code>
...
<code data-typedoc-code><a id="attrs-9" href="#attrs-9">attrs</a><i>?</i>: [`Attrs`](pm/model.md#attrs-4) \| `null`</code>
...
<code data-typedoc-code><a id="nodebuilder" href="#nodebuilder">NodeBuilder</a>(`attrs`: `Attrs` \| `null`, ...`children`: [`NodeChild`](#nodechild)[]): [`EditorNode`](pm/model.md#editornode)</code>
...
<code data-typedoc-code><a id="nodebuilder" href="#nodebuilder">NodeBuilder</a>(...`children`: [`NodeChild`](#nodechild)[]): [`EditorNode`](pm/model.md#editornode)</code>
...
A [NodeBuilder](#nodebuilder) function that also has an `isActive` method for checking if
...
<code data-typedoc-code><a id="nodeaction" href="#nodeaction">NodeAction</a>(`attrs`: `Attrs` \| `null`, ...`children`: [`NodeChild`](#nodechild)[]): [`EditorNode`](pm/model.md#editornode)</code>
...
<code data-typedoc-code><a id="nodeaction" href="#nodeaction">NodeAction</a>(...`children`: [`NodeChild`](#nodechild)[]): [`EditorNode`](pm/model.md#editornode)</code>
...
<code data-typedoc-code><a id="markbuilder" href="#markbuilder">MarkBuilder</a>(`attrs`: `Attrs` \| `null`, ...`children`: [`NodeChild`](#nodechild)[]): [`EditorNode`](pm/model.md#editornode)[]</code>
...
<code data-typedoc-code><a id="markbuilder" href="#markbuilder">MarkBuilder</a>(...`children`: [`NodeChild`](#nodechild)[]): [`EditorNode`](pm/model.md#editornode)[]</code>
...
<code data-typedoc-code><a id="create" href="#create">create</a>: (`attrs?`: `Attrs` \| `null`) => [`Mark`](pm/model.md#mark)</code>

</dt>

<dd>

Creates a [Mark](pm/model.md#mark) of this type with optional attributes, without
...
A [MarkBuilder](#markbuilder) function that also has an `isActive` method for checking
...
<code data-typedoc-code><a id="markaction" href="#markaction">MarkAction</a>(`attrs`: `Attrs` \| `null`, ...`children`: [`NodeChild`](#nodechild)[]): [`EditorNode`](pm/model.md#editornode)[]</code>
...
<code data-typedoc-code><a id="markaction" href="#markaction">MarkAction</a>(...`children`: [`NodeChild`](#nodechild)[]): [`EditorNode`](pm/model.md#editornode)[]</code>
...
<code data-typedoc-code><a id="create-1" href="#create-1">create</a>: (`attrs?`: `Attrs` \| `null`) => [`Mark`](pm/model.md#mark)</code>
...
<code data-typedoc-code><a id="defaultcontent" href="#defaultcontent">defaultContent</a><i>?</i>: `string` \| [`NodeJSON`](#nodejson) \| [`Element`](https://developer.mozilla.org/docs/Web/API/Element)</code>
...
<code data-typedoc-code><a id="defaultcontent-1" href="#defaultcontent-1">defaultContent</a><i>?</i>: `string` \| [`NodeJSON`](#nodejson) \| [`Element`](https://developer.mozilla.org/docs/Web/API/Element)</code>
...
<code data-typedoc-code><a id="priority" href="#priority">priority</a><i>?</i>: [`Priority`](#priority-3)</code>
...
<code data-typedoc-code><a id="type-12" href="#type-12">type</a>: `string` \| [`MarkType`](pm/model.md#marktype-1)</code>
...
<code data-typedoc-code><a id="shouldskip" href="#shouldskip">shouldSkip</a><i>?</i>: (`node`: [`EditorNode`](pm/model.md#editornode)) => `boolean`</code>
...
<code data-typedoc-code><a id="attrs-15" href="#attrs-15">attrs</a><i>?</i>: \{ \[K in string \| number \| symbol\]: AttrSpec\<Attrs\[K\]\> \}</code>
...
<code data-typedoc-code><a id="type-13" href="#type-13">type</a>: `MarkName`</code>
...
<code data-typedoc-code><a id="todom-1" href="#todom-1">toDOM</a><i>?</i>: (`value`: `AttrType`) => \[`string`, `string`\] \| `null` \| `undefined`</code>
...
<code data-typedoc-code><a id="attrs-17" href="#attrs-17">attrs</a><i>?</i>: \{ \[key in string \| number \| symbol\]: AttrSpec\<Attrs\[key\]\> \}</code>
...
<code data-typedoc-code><a id="todom-2" href="#todom-2">toDOM</a><i>?</i>: (`node`: [`EditorNode`](pm/model.md#editornode)) => [`DOMOutputSpec`](pm/model.md#domoutputspec)</code>
...
<code data-typedoc-code><a id="todebugstring" href="#todebugstring">toDebugString</a><i>?</i>: (`node`: [`EditorNode`](pm/model.md#editornode)) => `string`</code>
...
<code data-typedoc-code><a id="leaftext" href="#leaftext">leafText</a><i>?</i>: (`node`: [`EditorNode`](pm/model.md#editornode)) => `string`</code>
...
<code data-typedoc-code><a id="type-14" href="#type-14">type</a>: `NodeName`</code>
...
<code data-typedoc-code><a id="todom-3" href="#todom-3">toDOM</a><i>?</i>: (`value`: `AttrType`) => \[`string`, `string`\] \| `null` \| `undefined`</code>
...
<code data-typedoc-code><a id="canexec-1" href="#canexec-1">canExec</a>(...`args`: `Args`): `boolean`</code>
...
<code data-typedoc-code><a id="priority-1" href="#priority-1">priority</a><i>?</i>: [`Priority`](#priority-3)</code>
...
<code data-typedoc-code><a id="schema-1" href="#schema-1">schema</a>: [`Schema`](pm/model.md#schema-3)\<`any`, `any`\> \| `null`</code>
...
<code data-typedoc-code><a id="type-15" href="#type-15">type</a>: `string`</code>
...
<code data-typedoc-code><a id="attrs-18" href="#attrs-18">attrs</a><i>?</i>: [`Record`](https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeys-type)\<`string`, `any`\></code>
...
<code data-typedoc-code><a id="type-16" href="#type-16">type</a>: `string`</code>
...
<code data-typedoc-code><a id="node-1" href="#node-1">node</a>: [`EditorNode`](pm/model.md#editornode)</code>
...
<code data-typedoc-code><a id="from-6" href="#from-6">from</a>: `number`</code>
...
<code data-typedoc-code><a id="to-6" href="#to-6">to</a>: `number`</code>
...
<code data-typedoc-code><a id="from-7" href="#from-7">from</a><i>?</i>: `number`</code>
...
<code data-typedoc-code><a id="to-7" href="#to-7">to</a><i>?</i>: `number`</code>
...
<code data-typedoc-code><a id="topnode-1" href="#topnode-1">topNode</a><i>?</i>: [`EditorNode`](pm/model.md#editornode)</code>
...
<code data-typedoc-code>type <a id="nodechild" href="#nodechild">NodeChild</a> = [`EditorNode`](pm/model.md#editornode) \| `string` \| [`NodeChild`](#nodechild)[]</code>

</dt>

<dd>

Available children parameters for [NodeBuilder](#nodebuilder) and [MarkBuilder](#markbuilder).
...
<code data-typedoc-code>type <a id="clickonhandler" href="#clickonhandler">ClickOnHandler</a> = (`view`: [`EditorView`](pm/view.md#editorview), `pos`: `number`, `node`: [`EditorNode`](pm/model.md#editornode), `nodePos`: `number`, `event`: [`MouseEvent`](https://developer.mozilla.org/docs/Web/API/MouseEvent), `direct`: `boolean`) => `boolean` \| `void`</code>
...
<code data-typedoc-code>type <a id="doubleclickonhandler" href="#doubleclickonhandler">DoubleClickOnHandler</a> = (`view`: [`EditorView`](pm/view.md#editorview), `pos`: `number`, `node`: [`EditorNode`](pm/model.md#editornode), `nodePos`: `number`, `event`: [`MouseEvent`](https://developer.mozilla.org/docs/Web/API/MouseEvent), `direct`: `boolean`) => `boolean` \| `void`</code>
...
<code data-typedoc-code>type <a id="tripleclickonhandler" href="#tripleclickonhandler">TripleClickOnHandler</a> = (`view`: [`EditorView`](pm/view.md#editorview), `pos`: `number`, `node`: [`EditorNode`](pm/model.md#editornode), `nodePos`: `number`, `event`: [`MouseEvent`](https://developer.mozilla.org/docs/Web/API/MouseEvent), `direct`: `boolean`) => `boolean` \| `void`</code>
...
### ExtractNodeBuilders {#extractnodebuilders}

<dl>

<dt>

<code data-typedoc-code>type <a id="extractnodebuilders" href="#extractnodebuilders">ExtractNodeBuilders</a>\<E\> = `ToNodeBuilder`\<[`ExtractNodes`](#extractnodes)\<`E`\>\></code>

</dt>

<dd>

Extracts the [NodeBuilder](#nodebuilder)s from an extension type.
...
### ExtractMarkBuilders {#extractmarkbuilders}

<dl>

<dt>

<code data-typedoc-code>type <a id="extractmarkbuilders" href="#extractmarkbuilders">ExtractMarkBuilders</a>\<E\> = `ToMarkBuilder`\<[`ExtractMarks`](#extractmarks)\<`E`\>\></code>

</dt>

<dd>

Extracts the [MarkBuilder](#markbuilder)s from an extension type.
...
<code data-typedoc-code>type <a id="priority-3" href="#priority-3">Priority</a> = *typeof* [`Priority`](#priority-2)\[keyof *typeof* [`Priority`](#priority-2)\]</code>
...
<code data-typedoc-code><i>const</i> <a id="priority-2" href="#priority-2">Priority</a>: `object`</code>
...
<code data-typedoc-code><i>const</i> <a id="canuseregexlookbehind" href="#canuseregexlookbehind">canUseRegexLookbehind</a>: () => `boolean` = `supportsRegexLookbehind`</code>
...
### setNodeAttrsBetween() {#setnodeattrsbetween}

<dl>

<dt>

<code data-typedoc-code><i>function</i> <a id="setnodeattrsbetween" href="#setnodeattrsbetween">setNodeAttrsBetween</a>(`options`: [`SetNodeAttrsBetweenOptions`](#setnodeattrsbetweenoptions)): [`Command`](pm/state.md#command)</code>
...
### createNodeBuilders() {#createnodebuilders}

<dl>

<dt>

<code data-typedoc-code><i>function</i> <a id="createnodebuilders" href="#createnodebuilders">createNodeBuilders</a>\<E\>(`schema`: [`Schema`](pm/model.md#schema-3)): [`ExtractNodeBuilders`](#extractnodebuilders)\<`E`\></code>

</dt>

<dd>

Creates a set of typed node builders from a [Schema](pm/model.md#schema-3).
...
### createMarkBuilders() {#createmarkbuilders}

<dl>

<dt>

<code data-typedoc-code><i>function</i> <a id="createmarkbuilders" href="#createmarkbuilders">createMarkBuilders</a>\<E\>(`schema`: [`Schema`](pm/model.md#schema-3)): [`ExtractMarkBuilders`](#extractmarkbuilders)\<`E`\></code>

</dt>

<dd>

Creates a set of typed mark builders from a [Schema](pm/model.md#schema-3).
...
<code data-typedoc-code><i>function</i> <a id="withpriority" href="#withpriority">withPriority</a>\<T\>(`extension`: `T`, `priority`: [`Priority`](#priority-3)): `T`</code>
...
<code data-typedoc-code><i>function</i> <a id="clsx" href="#clsx">clsx</a>(...`args`: (`string` \| `boolean` \| `null` \| `undefined`)[]): `string`</code>
...
<code data-typedoc-code><i>function</i> <a id="findparentnodeoftype" href="#findparentnodeoftype">findParentNodeOfType</a>(`type`: `string` \| `string`[] \| [`NodeType`](pm/model.md#nodetype) \| [`NodeType`](pm/model.md#nodetype)[], `$pos`: [`ResolvedPos`](pm/model.md#resolvedpos)): [`FindParentNodeResult`](#findparentnoderesult) \| `undefined`</code>
...
<code data-typedoc-code><i>function</i> <a id="findparentnode" href="#findparentnode">findParentNode</a>(`predicate`: (`node`: [`EditorNode`](pm/model.md#editornode)) => `boolean`, `$pos`: [`ResolvedPos`](pm/model.md#resolvedpos)): [`FindParentNodeResult`](#findparentnoderesult) \| `undefined`</code>
...
<code data-typedoc-code><i>function</i> <a id="getmarkrange" href="#getmarkrange">getMarkRange</a>(`$pos`: [`ResolvedPos`](pm/model.md#resolvedpos), `type`: `string` \| [`MarkType`](pm/model.md#marktype-1), `attrs?`: [`Attrs`](pm/model.md#attrs-4) \| `null`): [`MarkRange`](#markrange) \| `undefined`</code>
...
<code data-typedoc-code><i>function</i> <a id="jsonfromnode" href="#jsonfromnode">jsonFromNode</a>(`node`: [`EditorNode`](pm/model.md#editornode)): [`NodeJSON`](#nodejson)</code>
...
<code data-typedoc-code><i>function</i> <a id="nodefromjson" href="#nodefromjson">nodeFromJSON</a>(`json`: [`NodeJSON`](#nodejson), `options`: [`JSONParserOptions`](#jsonparseroptions)): [`EditorNode`](pm/model.md#editornode)</code>
...
<code data-typedoc-code><i>function</i> <a id="nodefromelement" href="#nodefromelement">nodeFromElement</a>(`element`: [`Node`](https://developer.mozilla.org/docs/Web/API/Node), `options`: [`DOMParserOptions`](#domparseroptions) & [`JSONParserOptions`](#jsonparseroptions)): [`EditorNode`](pm/model.md#editornode)</code>
...
<code data-typedoc-code><i>function</i> <a id="elementfromnode" href="#elementfromnode">elementFromNode</a>(`node`: [`EditorNode`](pm/model.md#editornode), `options?`: [`DOMSerializerOptions`](#domserializeroptions) & [`DOMDocumentOptions`](#domdocumentoptions)): [`HTMLElement`](https://developer.mozilla.org/docs/Web/API/HTMLElement)</code>
...
<code data-typedoc-code><i>function</i> <a id="nodefromhtml" href="#nodefromhtml">nodeFromHTML</a>(`html`: `string`, `options`: [`DOMParserOptions`](#domparseroptions) & [`JSONParserOptions`](#jsonparseroptions) & [`DOMDocumentOptions`](#domdocumentoptions)): [`EditorNode`](pm/model.md#editornode)</code>
...
<code data-typedoc-code><i>function</i> <a id="htmlfromnode" href="#htmlfromnode">htmlFromNode</a>(`node`: [`EditorNode`](pm/model.md#editornode), `options?`: [`DOMSerializerOptions`](#domserializeroptions) & [`DOMDocumentOptions`](#domdocumentoptions)): `string`</code>
...
<code data-typedoc-code><i>function</i> <a id="isprosemirrornode" href="#isprosemirrornode">isProseMirrorNode</a>(`value`: `unknown`): `value is EditorNode`</code>

</dt>

<dd>

Checks if the given object is a [ProseMirrorNode](pm/model.md#editornode) instance.
...
<code data-typedoc-code><i>function</i> <a id="isfragment" href="#isfragment">isFragment</a>(`value`: `unknown`): `value is EditorFragment`</code>

</dt>

<dd>

Checks if the given object is a [Fragment](pm/model.md#editorfragment) instance.
...
Checks if the given object is a [Selection](pm/state.md#abstract-selection) instance.
...
<code data-typedoc-code><i>function</i> <a id="istextselection" href="#istextselection">isTextSelection</a>(`value`: [`Selection`](pm/state.md#abstract-selection)): `value is TextSelection`</code>
...
<code data-typedoc-code><i>function</i> <a id="isnodeselection" href="#isnodeselection">isNodeSelection</a>(`value`: [`Selection`](pm/state.md#abstract-selection)): `value is NodeSelection`</code>
...
<code data-typedoc-code><i>function</i> <a id="isallselection" href="#isallselection">isAllSelection</a>(`value`: [`Selection`](pm/state.md#abstract-selection)): `value is AllSelection`</code>
