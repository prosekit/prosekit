...
<code data-typedoc-code><a id="attrs-5" href="#attrs-5">attrs</a><i>?</i>: [`Attrs`](pm/model.md#attrs-4) \| `null`</code>
...
<code data-typedoc-code><i>function</i> <a id="findparentnodeoftype" href="#findparentnodeoftype">findParentNodeOfType</a>(`type`: `string` \| [`NodeType`](pm/model.md#nodetype), `$pos`: [`ResolvedPos`](pm/model.md#resolvedpos)): [`FindParentNodeResult`](#findparentnoderesult) \| `undefined`</code>
