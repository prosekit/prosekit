...
<code data-typedoc-code><i>const</i> <a id="popovercontent" href="#popovercontent">PopoverContent</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`PopoverContentProps`](#popovercontentprops)\> & `RefAttributes`\<[`PopoverContentElement`](../web/popover.md#popovercontentelement)\> & `HTMLAttributes`\<[`PopoverContentElement`](../web/popover.md#popovercontentelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="popoverroot" href="#popoverroot">PopoverRoot</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`PopoverRootProps`](#popoverrootprops)\> & `RefAttributes`\<[`PopoverRootElement`](../web/popover.md#popoverrootelement)\> & `HTMLAttributes`\<[`PopoverRootElement`](../web/popover.md#popoverrootelement)\>\></code>
