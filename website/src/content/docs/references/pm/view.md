...
<code data-typedoc-code><i>static</i> <a id="create" href="#create">create</a>(`doc`: [`ProseMirrorNode`](model.md#prosemirrornode), `decorations`: [`Decoration`](#decoration)[]): [`DecorationSet`](#decorationset)</code>
...
<code data-typedoc-code><a id="forchild-1" href="#forchild-1">forChild</a>(`offset`: `number`, `node`: [`ProseMirrorNode`](model.md#prosemirrornode)): [`DecorationSet`](#decorationset) \| `DecorationGroup`</code>
