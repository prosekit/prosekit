...
description: Persist editor content as JSON or HTML, detect changes, and round-trip Markdown
sidebar:
  order: 10
---
...
ProseKit doesn't ship a Markdown serializer, but you can convert HTML to and from Markdown with [remark](https://github.com/remarkjs/remark) and [rehype](https://github.com/rehypejs/rehype). See the [Markdown guide](/guides/markdown) for the full setup and a runnable example.
