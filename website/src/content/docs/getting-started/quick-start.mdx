...
import { Code, TabItem, Tabs, CardGrid } from '@astrojs/starlight/components';
...
<LinkCard title="Saving and loading content" href="/getting-started/save-and-load" description="Discover how to save and load the editor's content." />
...
<LinkCard title="Using components" href="/getting-started/using-components" description="Learn how to use the built-in UI components to create a more interactive editor." />
</CardGrid>
