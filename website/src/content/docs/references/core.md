...
<code data-typedoc-code><a id="setcontent" href="#setcontent">setContent</a>(`content`: `string` \| [`ProseMirrorNode`](pm/model.md#prosemirrornode) \| [`NodeJSON`](#nodejson) \| [`Element`](https://developer.mozilla.org/docs/Web/API/Element), `selection?`: [`Selection`](pm/state.md#abstract-selection) \| `"start"` \| [`SelectionJSON`](#selectionjson) \| `"end"`): `void`</code>
...
<code data-typedoc-code><a id="type-7" href="#type-7">type</a>: `string` \| [`NodeType`](pm/model.md#nodetype) \| `string`[] \| [`NodeType`](pm/model.md#nodetype)[]</code>
...
<code data-typedoc-code><a id="nodeaction" href="#nodeaction">NodeAction</a>(`attrs`: `Attrs` \| `null`, ...`children`: [`NodeChild`](#nodechild)[]): [`ProseMirrorNode`](pm/model.md#prosemirrornode)</code>
...
<code data-typedoc-code><a id="markaction" href="#markaction">MarkAction</a>(`attrs`: `Attrs` \| `null`, ...`children`: [`NodeChild`](#nodechild)[]): [`ProseMirrorNode`](pm/model.md#prosemirrornode)[]</code>
...
<code data-typedoc-code><a id="attrs-13" href="#attrs-13">attrs</a><i>?</i>: \{ \[K in string \| number \| symbol\]: AttrSpec\<Attrs\[K\]\> \}</code>
...
<code data-typedoc-code><a id="type-12" href="#type-12">type</a>: `MarkName`</code>
...
<code data-typedoc-code><a id="attrs-15" href="#attrs-15">attrs</a><i>?</i>: \{ \[key in string \| number \| symbol\]: AttrSpec\<Attrs\[key\]\> \}</code>
...
<code data-typedoc-code><a id="type-13" href="#type-13">type</a>: `NodeName`</code>
...
<code data-typedoc-code><a id="attrs-16" href="#attrs-16">attrs</a><i>?</i>: [`Record`](https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeys-type)\<`string`, `any`\></code>
...
<code data-typedoc-code><a id="from-6" href="#from-6">from</a><i>?</i>: `number`</code>
...
<code data-typedoc-code><a id="to-6" href="#to-6">to</a><i>?</i>: `number`</code>
...
<code data-typedoc-code><i>function</i> <a id="findparentnodeoftype" href="#findparentnodeoftype">findParentNodeOfType</a>(`type`: `string` \| [`NodeType`](pm/model.md#nodetype) \| `string`[] \| [`NodeType`](pm/model.md#nodetype)[], `$pos`: [`ResolvedPos`](pm/model.md#resolvedpos)): [`FindParentNodeResult`](#findparentnoderesult) \| `undefined`</code>
...
<code data-typedoc-code><i>function</i> <a id="findparentnode" href="#findparentnode">findParentNode</a>(`predicate`: (`node`: [`ProseMirrorNode`](pm/model.md#prosemirrornode)) => `boolean`, `$pos`: [`ResolvedPos`](pm/model.md#resolvedpos)): [`FindParentNodeResult`](#findparentnoderesult) \| `undefined`</code>
