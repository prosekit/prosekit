...
<code data-typedoc-declaration><i>function</i> <i></i> <a id="wrapin-2" href="#wrapin-2">wrapIn</a>(`nodeType`: [`NodeType`](model.md#nodetype), `attrs?`: `null` \| [`Attrs`](model.md#attrs-7)): [`Command`](state.md#command)</code>
