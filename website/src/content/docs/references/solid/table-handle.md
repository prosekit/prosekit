...
<code data-typedoc-declaration><i>const</i> <a id="tablehandlecolumnroot" href="#tablehandlecolumnroot">TableHandleColumnRoot</a>: `Component`\<`PropsWithElement`\<[`TableHandleColumnRootProps`](#tablehandlecolumnrootprops), [`TableHandleColumnRootElement`](../web/table-handle.md#tablehandlecolumnrootelement)\>\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="tablehandlecolumntrigger" href="#tablehandlecolumntrigger">TableHandleColumnTrigger</a>: `Component`\<`PropsWithElement`\<[`TableHandleColumnTriggerProps`](#tablehandlecolumntriggerprops), [`TableHandleColumnTriggerElement`](../web/table-handle.md#tablehandlecolumntriggerelement)\>\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="tablehandlepopovercontent" href="#tablehandlepopovercontent">TableHandlePopoverContent</a>: `Component`\<`PropsWithElement`\<[`TableHandlePopoverContentProps`](#tablehandlepopovercontentprops), [`TableHandlePopoverContentElement`](../web/table-handle.md#tablehandlepopovercontentelement)\>\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="tablehandlepopoveritem" href="#tablehandlepopoveritem">TableHandlePopoverItem</a>: `Component`\<`PropsWithElement`\<[`TableHandlePopoverItemProps`](#tablehandlepopoveritemprops), [`TableHandlePopoverItemElement`](../web/table-handle.md#tablehandlepopoveritemelement)\>\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="tablehandleroot" href="#tablehandleroot">TableHandleRoot</a>: `Component`\<`PropsWithElement`\<[`TableHandleRootProps`](#tablehandlerootprops), [`TableHandleRootElement`](../web/table-handle.md#tablehandlerootelement)\>\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="tablehandlerowroot" href="#tablehandlerowroot">TableHandleRowRoot</a>: `Component`\<`PropsWithElement`\<[`TableHandleRowRootProps`](#tablehandlerowrootprops), [`TableHandleRowRootElement`](../web/table-handle.md#tablehandlerowrootelement)\>\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="tablehandlerowtrigger" href="#tablehandlerowtrigger">TableHandleRowTrigger</a>: `Component`\<`PropsWithElement`\<[`TableHandleRowTriggerProps`](#tablehandlerowtriggerprops), [`TableHandleRowTriggerElement`](../web/table-handle.md#tablehandlerowtriggerelement)\>\></code>
