...
<CardGrid>
<LinkCard title="Styling your editor" href="/guides/styling" description="Learn how to customize the appearance of your editor using CSS." />
<LinkCard title="Saving and loading" href="/guides/saving-and-loading" description="Discover how to save and load the editor's content." />
<LinkCard title="Using extensions" href="/concepts/extensions" description="Explore the various extensions available in ProseKit and how to use them." />
