...
<code data-typedoc-code><a id="contentref" href="#contentref">contentRef</a>: (`element`: [`HTMLElement`](https://developer.mozilla.org/docs/Web/API/HTMLElement) \| `null`) => `void`</code>
...
<code data-typedoc-code><a id="contentref-1" href="#contentref-1">contentRef</a>: (`element`: [`HTMLElement`](https://developer.mozilla.org/docs/Web/API/HTMLElement) \| `null`) => `void`</code>
...
<code data-typedoc-code><a id="node" href="#node">node</a>: `Writable`\<[`EditorNode`](pm/model.md#editornode)\></code>
...
<code data-typedoc-code><a id="update" href="#update">update</a><i>?</i>: (`node`: [`EditorNode`](pm/model.md#editornode), `decorations`: readonly [`Decoration`](pm/view.md#decoration)[], `innerDecorations`: [`DecorationSource`](pm/view.md#decorationsource)) => `boolean` \| `void`</code>
...
<code data-typedoc-code><a id="priority" href="#priority">priority</a><i>?</i>: [`Priority`](core.md#priority-3)</code>
...
<code data-typedoc-code><i>const</i> <a id="prosekit" href="#prosekit">ProseKit</a>: `Component`\<[`ProseKitProps`](#prosekitprops), \{ \}, `string`\></code>
...
<code data-typedoc-code><i>function</i> <a id="usedocchange" href="#usedocchange">useDocChange</a>(`handler`: (`doc`: [`EditorNode`](pm/model.md#editornode)) => `void`, `options?`: [`UseExtensionOptions`](#useextensionoptions)): `void`</code>
...
<code data-typedoc-code><i>function</i> <a id="useeditorderivedvalue" href="#useeditorderivedvalue">useEditorDerivedValue</a>\<E, Derived\>(`derive`: (`editor`: [`Editor`](core.md#editor)\<`E`\>) => `Derived`, `options?`: [`UseEditorDerivedOptions`](#useeditorderivedoptions)\<`E`\>): `Readable`\<`Derived`\></code>
...
<code data-typedoc-code><i>function</i> <a id="useextension" href="#useextension">useExtension</a>\<T\>(`extension`: `Readable`\<`T` \| `null`\>, `options?`: [`UseExtensionOptions`](#useextensionoptions)): `void`</code>
