...
<code data-typedoc-code><a id="setcontent" href="#setcontent">setContent</a>(`content`: `string` \| [`EditorNode`](../pm/model.md#editornode) \| [`NodeJSON`](../core.md#nodejson) \| [`Element`](https://developer.mozilla.org/docs/Web/API/Element), `selection?`: [`Selection`](../pm/state.md#abstract-selection) \| `"start"` \| [`SelectionJSON`](../core.md#selectionjson) \| `"end"`): `void`</code>
...
<code data-typedoc-code><a id="set" href="#set">set</a>(`doc`: [`EditorNode`](../pm/model.md#editornode)): `void`</code>
...
<code data-typedoc-code><i>function</i> <a id="extractselection" href="#extractselection">extractSelection</a>(`doc`: [`EditorNode`](../pm/model.md#editornode)): [`Selection`](../pm/state.md#abstract-selection) \| `undefined`</code>

</dt>

<dd>

Extracts a [Selection](../pm/state.md#abstract-selection) from a tagged ProseMirror document built with
