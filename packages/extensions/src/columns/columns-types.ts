...
/**
 * Attributes stored on the `columnGroup` container node.
 */
export interface ColumnGroupAttrs extends Attrs {}
...
/**
 * Configure the behavior of the column group extension.
 */
...
/**
 * Options for creating a new column group.
 */
export interface InsertColumnGroupOptions {
  /**
...
/**
 * The nearest ancestor `columnGroup` node for a resolved position.
 */
export interface FindColumnGroupResult extends FindParentNodeResult {
  node: FindParentNodeResult['node'] & { attrs: ColumnGroupAttrs }
}
...
export interface ColumnDragState {
  ...
  /**
   * Full rendered width of the column group container (including gaps), in pixels.
   */
 ...
 */
export interface ColumnGroupRuntimeState {
  /**
...
export interface ColumnBoundaryHit {
  ...
  /**
   * Position of the column group container.
   */
  containerPos: number
...
/**
 * The current layout data for a `columnGroup` container.
 */
