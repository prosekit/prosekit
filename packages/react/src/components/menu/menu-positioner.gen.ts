...
import {
  ...
  type MenuPositionerProps as MenuPositionerElementProps,
...
function MenuPositionerComponent(
  props: MenuPositionerProps,
  forwardedRef: ForwardedRef<MenuPositionerElement>,
) {
  registerMenuPositionerElement();
  ...
  const mergedRef = useCallback((element: MenuPositionerElement | null) => {
 ...
 * @public
 */
export const MenuPositioner: ForwardRefExoticComponent<
  MenuPositionerProps & RefAttributes<MenuPositionerElement>
> = /* @__PURE__ */ forwardRef(MenuPositionerComponent);
