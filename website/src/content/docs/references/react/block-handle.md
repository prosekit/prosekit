...
Props for the [BlockHandleAdd](#blockhandleadd) React component.

***

### BlockHandleDraggableProps {#blockhandledraggableprops}

Props for the [BlockHandleDraggable](#blockhandledraggable) React component.

***

### BlockHandlePopupProps {#blockhandlepopupprops}

Props for the [BlockHandlePopup](#blockhandlepopup) React component.

***

### BlockHandlePositionerProps {#blockhandlepositionerprops}

Props for the [BlockHandlePositioner](#blockhandlepositioner) React component.
...
Props for the [BlockHandleRoot](#blockhandleroot) React component.
