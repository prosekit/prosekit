...
Props for the [AutocompleteEmpty](#autocompleteempty) Svelte component.
...
Props for the [AutocompleteItem](#autocompleteitem) Svelte component.
...
Props for the [AutocompletePopup](#autocompletepopup) Svelte component.
...
Props for the [AutocompletePositioner](#autocompletepositioner) Svelte component.
...
Props for the [AutocompleteRoot](#autocompleteroot) Svelte component.
...
<code data-typedoc-code><i>const</i> <a id="autocompleteempty" href="#autocompleteempty">AutocompleteEmpty</a>: `Component`\<[`AutocompleteEmptyProps`](#autocompleteemptyprops) & `HTMLAttributes`\<[`AutocompleteEmptyElement`](../web/autocomplete.md#autocompleteemptyelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="autocompleteitem" href="#autocompleteitem">AutocompleteItem</a>: `Component`\<[`AutocompleteItemProps`](#autocompleteitemprops) & `HTMLAttributes`\<[`AutocompleteItemElement`](../web/autocomplete.md#autocompleteitemelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="autocompletepopup" href="#autocompletepopup">AutocompletePopup</a>: `Component`\<[`AutocompletePopupProps`](#autocompletepopupprops) & `HTMLAttributes`\<[`AutocompletePopupElement`](../web/autocomplete.md#autocompletepopupelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="autocompletepositioner" href="#autocompletepositioner">AutocompletePositioner</a>: `Component`\<[`AutocompletePositionerProps`](#autocompletepositionerprops) & `HTMLAttributes`\<[`AutocompletePositionerElement`](../web/autocomplete.md#autocompletepositionerelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="autocompleteroot" href="#autocompleteroot">AutocompleteRoot</a>: `Component`\<[`AutocompleteRootProps`](#autocompleterootprops) & `HTMLAttributes`\<[`AutocompleteRootElement`](../web/autocomplete.md#autocompleterootelement)\>\></code>
