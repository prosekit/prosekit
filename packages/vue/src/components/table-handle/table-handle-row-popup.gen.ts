 ...
 * @public
 */
export const TableHandleRowPopup: DefineSetupFnComponent<
  TableHandleRowPopupProps & HTMLAttributes
> = /* @__PURE__ */ defineComponent<TableHandleRowPopupProps & HTMLAttributes>(
  (props, { slots }) => {
