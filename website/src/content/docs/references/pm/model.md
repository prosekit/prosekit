...
<code data-typedoc-code><i>static</i> <a id="setfrom" href="#setfrom">setFrom</a>(`marks?`: [`Mark`](#mark) \| readonly [`Mark`](#mark)[] \| `null`): readonly [`Mark`](#mark)[]</code>
...
<code data-typedoc-code><a id="serializenode" href="#serializenode">serializeNode</a>(`node`: [`EditorNode`](#editornode), `options?`: `object`): [`HTMLElement`](https://developer.mozilla.org/docs/Web/API/HTMLElement) \| [`Text`](https://developer.mozilla.org/docs/Web/API/Text)</code>
...
<code data-typedoc-code><i>static</i> <a id="renderspec" href="#renderspec">renderSpec</a>(`doc`: [`Document`](https://developer.mozilla.org/docs/Web/API/Document), `structure`: [`DOMOutputSpec`](#domoutputspec), `xmlNS?`: `string` \| `null`): `object`</code>
...
<code data-typedoc-code>get <a id="parent" href="#parent">parent</a>(): [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code>get <a id="doc" href="#doc">doc</a>(): [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code>get <a id="nodeafter" href="#nodeafter">nodeAfter</a>(): [`EditorNode`](#editornode) \| `null`</code>
...
<code data-typedoc-code>get <a id="nodebefore" href="#nodebefore">nodeBefore</a>(): [`EditorNode`](#editornode) \| `null`</code>
...
<code data-typedoc-code><a id="node" href="#node">node</a>(`depth?`: `number` \| `null`): [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code><a id="index" href="#index">index</a>(`depth?`: `number` \| `null`): `number`</code>
...
<code data-typedoc-code><a id="indexafter" href="#indexafter">indexAfter</a>(`depth?`: `number` \| `null`): `number`</code>
...
<code data-typedoc-code><a id="start" href="#start">start</a>(`depth?`: `number` \| `null`): `number`</code>
...
<code data-typedoc-code><a id="end" href="#end">end</a>(`depth?`: `number` \| `null`): `number`</code>
...
<code data-typedoc-code><a id="before" href="#before">before</a>(`depth?`: `number` \| `null`): `number`</code>
...
<code data-typedoc-code><a id="after" href="#after">after</a>(`depth?`: `number` \| `null`): `number`</code>
...
<code data-typedoc-code><a id="posatindex" href="#posatindex">posAtIndex</a>(`index`: `number`, `depth?`: `number` \| `null`): `number`</code>
...
<code data-typedoc-code><a id="marksacross" href="#marksacross">marksAcross</a>(`$end`: [`ResolvedPos`](#resolvedpos)): readonly [`Mark`](#mark)[] \| `null`</code>
...
<code data-typedoc-code><a id="blockrange" href="#blockrange">blockRange</a>(`other?`: [`ResolvedPos`](#resolvedpos), `pred?`: (`node`: [`EditorNode`](#editornode)) => `boolean`): [`NodeRange`](#noderange) \| `null`</code>
...
<code data-typedoc-code>get <a id="start-1" href="#start-1">start</a>(): `number`</code>
...
<code data-typedoc-code>get <a id="end-1" href="#end-1">end</a>(): `number`</code>
...
<code data-typedoc-code>get <a id="parent-1" href="#parent-1">parent</a>(): [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code><i>static</i> <a id="stacktracelimit" href="#stacktracelimit">stackTraceLimit</a>: `number`</code>
...
<code data-typedoc-code><i>static</i> <a id="capturestacktrace" href="#capturestacktrace">captureStackTrace</a>(`targetObject`: `object`, `constructorOpt?`: [`Function`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function)): `void`</code>
...
<code data-typedoc-code><i>static</i> <a id="preparestacktrace" href="#preparestacktrace">prepareStackTrace</a>(`err`: [`Error`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Error), `stackTraces`: `CallSite`[]): `any`</code>
...
<code data-typedoc-code>new <a id="constructor-5" href="#constructor-5">Slice</a>(`content`: [`EditorFragment`](#editorfragment), `openStart`: `number`, `openEnd`: `number`): [`Slice`](#slice)</code>
...
<code data-typedoc-code><i>readonly</i> <a id="content" href="#content">content</a>: [`EditorFragment`](#editorfragment)</code>
...
<code data-typedoc-code><a id="eq-1" href="#eq-1">eq</a>(`other`: [`Slice`](#slice)): `boolean`</code>
...
<code data-typedoc-code><a id="tojson-1" href="#tojson-1">toJSON</a>(): `any`</code>
...
<code data-typedoc-code><i>static</i> <a id="fromjson-1" href="#fromjson-1">fromJSON</a>(`schema`: [`Schema`](#schema-3), `json`: `any`): [`Slice`](#slice)</code>
...
<code data-typedoc-code><i>static</i> <a id="maxopen" href="#maxopen">maxOpen</a>(`fragment`: [`EditorFragment`](#editorfragment), `openIsolating?`: `boolean`): [`Slice`](#slice)</code>
...
<code data-typedoc-code><a id="parse" href="#parse">parse</a>(`dom`: [`Node`](https://developer.mozilla.org/docs/Web/API/Node), `options?`: [`ParseOptions`](#parseoptions)): [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code><i>static</i> <a id="fromschema-1" href="#fromschema-1">fromSchema</a>(`schema`: [`Schema`](#schema-3)): [`DOMParser`](#domparser)</code>
...
<code data-typedoc-code><a id="markset" href="#markset">markSet</a>: readonly [`MarkType`](#marktype-1)[] \| `null`</code>
...
<code data-typedoc-code><a id="create" href="#create">create</a>(`attrs?`: [`Attrs`](#attrs-4) \| `null`, `content?`: [`EditorNode`](#editornode) \| [`EditorFragment`](#editorfragment) \| readonly [`EditorNode`](#editornode)[] \| `null`, `marks?`: readonly [`Mark`](#mark)[]): [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code><a id="createchecked" href="#createchecked">createChecked</a>(`attrs?`: [`Attrs`](#attrs-4) \| `null`, `content?`: [`EditorNode`](#editornode) \| [`EditorFragment`](#editorfragment) \| readonly [`EditorNode`](#editornode)[] \| `null`, `marks?`: readonly [`Mark`](#mark)[]): [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code><a id="createandfill" href="#createandfill">createAndFill</a>(`attrs?`: [`Attrs`](#attrs-4) \| `null`, `content?`: [`EditorNode`](#editornode) \| [`EditorFragment`](#editorfragment) \| readonly [`EditorNode`](#editornode)[] \| `null`, `marks?`: readonly [`Mark`](#mark)[]): [`EditorNode`](#editornode) \| `null`</code>
...
<code data-typedoc-code><a id="validcontent" href="#validcontent">validContent</a>(`content`: [`EditorFragment`](#editorfragment)): `boolean`</code>
...
<code data-typedoc-code><a id="create-1" href="#create-1">create</a>(`attrs?`: [`Attrs`](#attrs-4) \| `null`): [`Mark`](#mark)</code>
...
<code data-typedoc-code><a id="removefromset-1" href="#removefromset-1">removeFromSet</a>(`set`: readonly [`Mark`](#mark)[]): readonly [`Mark`](#mark)[]</code>
...
<code data-typedoc-code><a id="isinset-1" href="#isinset-1">isInSet</a>(`set`: readonly [`Mark`](#mark)[]): [`Mark`](#mark) \| `undefined`</code>
...
<code data-typedoc-code><a id="marks-6" href="#marks-6">marks</a>: `{ readonly [name in string]: MarkType }` & `object`</code>
...
<code data-typedoc-code><a id="linebreakreplacement-1" href="#linebreakreplacement-1">linebreakReplacement</a>: [`NodeType`](#nodetype) \| `null`</code>
...
<code data-typedoc-code><a id="nodefromjson" href="#nodefromjson">nodeFromJSON</a>: (`json`: `any`) => [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code><a id="markfromjson-1" href="#markfromjson-1">markFromJSON</a>: (`json`: `any`) => [`Mark`](#mark)</code>
...
<code data-typedoc-code><a id="node-2" href="#node-2">node</a>(`type`: `string` \| [`NodeType`](#nodetype), `attrs?`: [`Attrs`](#attrs-4) \| `null`, `content?`: [`EditorNode`](#editornode) \| [`EditorFragment`](#editorfragment) \| readonly [`EditorNode`](#editornode)[], `marks?`: readonly [`Mark`](#mark)[]): [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code><a id="text" href="#text">text</a>(`text`: `string`, `marks?`: readonly [`Mark`](#mark)[] \| `null`): [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code><a id="mark-4" href="#mark-4">mark</a>(`type`: `string` \| [`MarkType`](#marktype-1), `attrs?`: [`Attrs`](#attrs-4) \| `null`): [`Mark`](#mark)</code>
...
<code data-typedoc-code>new <a id="constructor-10" href="#constructor-10">EditorFragment</a>(): [`EditorFragment`](#editorfragment)</code>
...
<code data-typedoc-code><i>static</i> <a id="empty-1" href="#empty-1">empty</a>: [`EditorFragment`](#editorfragment)</code>
...
<code data-typedoc-code><i>readonly</i> <a id="content-2" href="#content-2">content</a>: readonly [`EditorNode`](#editornode)[]</code>
...
<code data-typedoc-code>get <a id="firstchild" href="#firstchild">firstChild</a>(): [`EditorNode`](#editornode) \| `null`</code>
...
<code data-typedoc-code>get <a id="lastchild" href="#lastchild">lastChild</a>(): [`EditorNode`](#editornode) \| `null`</code>
...
<code data-typedoc-code><i>static</i> <a id="fromjson-2" href="#fromjson-2">fromJSON</a>(`schema`: [`Schema`](#schema-3), `value`: `any`): [`EditorFragment`](#editorfragment)</code>
...
<code data-typedoc-code><i>static</i> <a id="fromarray" href="#fromarray">fromArray</a>(`array`: readonly [`EditorNode`](#editornode)[]): [`EditorFragment`](#editorfragment)</code>
...
<code data-typedoc-code><i>static</i> <a id="from-2" href="#from-2">from</a>(`nodes?`: [`EditorNode`](#editornode) \| [`EditorFragment`](#editorfragment) \| readonly [`EditorNode`](#editornode)[] \| `null`): [`EditorFragment`](#editorfragment)</code>
...
<code data-typedoc-code><a id="nodesbetween" href="#nodesbetween">nodesBetween</a>(`from`: `number`, `to`: `number`, `f`: (`node`: [`EditorNode`](#editornode), `start`: `number`, `parent`: [`EditorNode`](#editornode) \| `null`, `index`: `number`) => `boolean` \| `void`, `nodeStart?`: `number`, `parent?`: [`EditorNode`](#editornode)): `void`</code>
...
<code data-typedoc-code><a id="descendants" href="#descendants">descendants</a>(`f`: (`node`: [`EditorNode`](#editornode), `pos`: `number`, `parent`: [`EditorNode`](#editornode) \| `null`, `index`: `number`) => `boolean` \| `void`): `void`</code>
...
<code data-typedoc-code><a id="textbetween" href="#textbetween">textBetween</a>(`from`: `number`, `to`: `number`, `blockSeparator?`: `string` \| `null`, `leafText?`: `string` \| ((`leafNode`: [`EditorNode`](#editornode)) => `string`) \| `null`): `string`</code>
...
<code data-typedoc-code><a id="append" href="#append">append</a>(`other`: [`EditorFragment`](#editorfragment)): [`EditorFragment`](#editorfragment)</code>
...
<code data-typedoc-code><a id="cut" href="#cut">cut</a>(`from`: `number`, `to?`: `number`): [`EditorFragment`](#editorfragment)</code>
...
<code data-typedoc-code><a id="replacechild" href="#replacechild">replaceChild</a>(`index`: `number`, `node`: [`EditorNode`](#editornode)): [`EditorFragment`](#editorfragment)</code>
...
<code data-typedoc-code><a id="addtostart" href="#addtostart">addToStart</a>(`node`: [`EditorNode`](#editornode)): [`EditorFragment`](#editorfragment)</code>
...
<code data-typedoc-code><a id="addtoend" href="#addtoend">addToEnd</a>(`node`: [`EditorNode`](#editornode)): [`EditorFragment`](#editorfragment)</code>
...
<code data-typedoc-code><a id="eq-2" href="#eq-2">eq</a>(`other`: [`EditorFragment`](#editorfragment)): `boolean`</code>
...
<code data-typedoc-code><a id="child" href="#child">child</a>(`index`: `number`): [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code><a id="maybechild" href="#maybechild">maybeChild</a>(`index`: `number`): [`EditorNode`](#editornode) \| `null`</code>
...
<code data-typedoc-code><a id="foreach" href="#foreach">forEach</a>(`f`: (`node`: [`EditorNode`](#editornode), `offset`: `number`, `index`: `number`) => `void`): `void`</code>
...
<code data-typedoc-code><a id="finddiffstart" href="#finddiffstart">findDiffStart</a>(`other`: [`EditorFragment`](#editorfragment), `pos?`: `number`): `number` \| `null`</code>
...
<code data-typedoc-code><a id="finddiffend" href="#finddiffend">findDiffEnd</a>(`other`: [`EditorFragment`](#editorfragment), `pos?`: `number`, `otherPos?`: `number`): \{ `a`: `number`; `b`: `number`; \} \| `null`</code>
...
<code data-typedoc-code>get <a id="defaulttype" href="#defaulttype">defaultType</a>(): [`NodeType`](#nodetype) \| `null`</code>
...
<code data-typedoc-code><a id="matchtype" href="#matchtype">matchType</a>(`type`: [`NodeType`](#nodetype)): [`ContentMatch`](#contentmatch-1) \| `null`</code>
...
<code data-typedoc-code><a id="matchfragment" href="#matchfragment">matchFragment</a>(`frag`: [`EditorFragment`](#editorfragment), `start?`: `number`, `end?`: `number`): [`ContentMatch`](#contentmatch-1) \| `null`</code>
...
<code data-typedoc-code><a id="fillbefore" href="#fillbefore">fillBefore</a>(`after`: [`EditorFragment`](#editorfragment), `toEnd?`: `boolean`, `startIndex?`: `number`): [`EditorFragment`](#editorfragment) \| `null`</code>
...
<code data-typedoc-code><a id="findwrapping" href="#findwrapping">findWrapping</a>(`target`: [`NodeType`](#nodetype)): readonly [`NodeType`](#nodetype)[] \| `null`</code>
...
<code data-typedoc-code>new <a id="constructor-12" href="#constructor-12">EditorNode</a>(): [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code><i>readonly</i> <a id="marks-7" href="#marks-7">marks</a>: readonly [`Mark`](#mark)[]</code>
...
<code data-typedoc-code><i>readonly</i> <a id="content-3" href="#content-3">content</a>: [`EditorFragment`](#editorfragment)</code>
...
<code data-typedoc-code><i>readonly</i> <a id="text-1" href="#text-1">text</a>: `string` \| `undefined`</code>
...
<code data-typedoc-code>get <a id="children" href="#children">children</a>(): readonly [`EditorNode`](#editornode)[]</code>
...
<code data-typedoc-code>get <a id="firstchild-1" href="#firstchild-1">firstChild</a>(): [`EditorNode`](#editornode) \| `null`</code>
...
<code data-typedoc-code>get <a id="lastchild-1" href="#lastchild-1">lastChild</a>(): [`EditorNode`](#editornode) \| `null`</code>
...
<code data-typedoc-code><i>static</i> <a id="fromjson-3" href="#fromjson-3">fromJSON</a>(`schema`: [`Schema`](#schema-3), `json`: `any`): [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code><a id="child-1" href="#child-1">child</a>(`index`: `number`): [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code><a id="maybechild-1" href="#maybechild-1">maybeChild</a>(`index`: `number`): [`EditorNode`](#editornode) \| `null`</code>
...
<code data-typedoc-code><a id="foreach-1" href="#foreach-1">forEach</a>(`f`: (`node`: [`EditorNode`](#editornode), `offset`: `number`, `index`: `number`) => `void`): `void`</code>
...
<code data-typedoc-code><a id="nodesbetween-1" href="#nodesbetween-1">nodesBetween</a>(`from`: `number`, `to`: `number`, `f`: (`node`: [`EditorNode`](#editornode), `pos`: `number`, `parent`: [`EditorNode`](#editornode) \| `null`, `index`: `number`) => `boolean` \| `void`, `startPos?`: `number`): `void`</code>
...
<code data-typedoc-code><a id="descendants-1" href="#descendants-1">descendants</a>(`f`: (`node`: [`EditorNode`](#editornode), `pos`: `number`, `parent`: [`EditorNode`](#editornode) \| `null`, `index`: `number`) => `boolean` \| `void`): `void`</code>
...
<code data-typedoc-code><a id="textbetween-1" href="#textbetween-1">textBetween</a>(`from`: `number`, `to`: `number`, `blockSeparator?`: `string` \| `null`, `leafText?`: `string` \| ((`leafNode`: [`EditorNode`](#editornode)) => `string`) \| `null`): `string`</code>
...
<code data-typedoc-code><a id="eq-3" href="#eq-3">eq</a>(`other`: [`EditorNode`](#editornode)): `boolean`</code>
...
<code data-typedoc-code><a id="samemarkup" href="#samemarkup">sameMarkup</a>(`other`: [`EditorNode`](#editornode)): `boolean`</code>
...
<code data-typedoc-code><a id="hasmarkup" href="#hasmarkup">hasMarkup</a>(`type`: [`NodeType`](#nodetype), `attrs?`: [`Attrs`](#attrs-4) \| `null`, `marks?`: readonly [`Mark`](#mark)[]): `boolean`</code>
...
<code data-typedoc-code><a id="copy" href="#copy">copy</a>(`content?`: [`EditorFragment`](#editorfragment) \| `null`): [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code><a id="mark-5" href="#mark-5">mark</a>(`marks`: readonly [`Mark`](#mark)[]): [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code><a id="cut-1" href="#cut-1">cut</a>(`from`: `number`, `to?`: `number`): [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code><a id="replace" href="#replace">replace</a>(`from`: `number`, `to`: `number`, `slice`: [`Slice`](#slice)): [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code><a id="nodeat" href="#nodeat">nodeAt</a>(`pos`: `number`): [`EditorNode`](#editornode) \| `null`</code>
...
<code data-typedoc-code><a id="tostring-1" href="#tostring-1">toString</a>(): `string`</code>
...
<code data-typedoc-code><a id="canreplace" href="#canreplace">canReplace</a>(`from`: `number`, `to`: `number`, `replacement?`: [`EditorFragment`](#editorfragment), `start?`: `number`, `end?`: `number`): `boolean`</code>
...
<code data-typedoc-code><a id="canappend" href="#canappend">canAppend</a>(`other`: [`EditorNode`](#editornode)): `boolean`</code>
...
<code data-typedoc-code><a id="tojson-3" href="#tojson-3">toJSON</a>(): `any`</code>
...
<code data-typedoc-code><a id="topnode" href="#topnode">topNode</a><i>?</i>: [`EditorNode`](#editornode)</code>
...
<code data-typedoc-code><a id="node-1" href="#node-1">node</a><i>?</i>: `string`</code>
...
<code data-typedoc-code><a id="getattrs" href="#getattrs">getAttrs</a><i>?</i>: (`node`: [`HTMLElement`](https://developer.mozilla.org/docs/Web/API/HTMLElement)) => `false` \| [`Attrs`](#attrs-4) \| `null`</code>
...
<code data-typedoc-code><a id="getcontent" href="#getcontent">getContent</a><i>?</i>: (`node`: [`Node`](https://developer.mozilla.org/docs/Web/API/Node), `schema`: [`Schema`](#schema-3)) => [`EditorFragment`](#editorfragment)</code>
...
<code data-typedoc-code><a id="getattrs-1" href="#getattrs-1">getAttrs</a><i>?</i>: (`node`: `string`) => `false` \| [`Attrs`](#attrs-4) \| `null`</code>
...
<code data-typedoc-code><a id="marks-3" href="#marks-3">marks</a><i>?</i>: `{ [name in string]: MarkSpec }` \| `OrderedMap`\<[`MarkSpec`](#markspec)\></code>
...
<code data-typedoc-code><a id="pagebreak" href="#pagebreak">pageBreak</a><i>?</i>: `boolean`</code>
...
<code data-typedoc-code><a id="marks-4" href="#marks-4">marks</a><i>?</i>: `string`</code>
...
<code data-typedoc-code><a id="todom" href="#todom">toDOM</a><i>?</i>: (`node`: [`EditorNode`](#editornode)) => [`DOMOutputSpec`](#domoutputspec)</code>
...
<code data-typedoc-code><a id="todebugstring" href="#todebugstring">toDebugString</a><i>?</i>: (`node`: [`EditorNode`](#editornode)) => `string`</code>
...
<code data-typedoc-code><a id="leaftext" href="#leaftext">leafText</a><i>?</i>: (`node`: [`EditorNode`](#editornode)) => `string`</code>
...
<code data-typedoc-code><a id="excludes-1" href="#excludes-1">excludes</a><i>?</i>: `string`</code>
...
Renames and re-exports [EditorFragment](#editorfragment)

***

### ProseMirrorNode {#prosemirrornode}

Renames and re-exports [EditorNode](#editornode)
