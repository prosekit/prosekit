...
const PUNCTUATION_CHAR_PATTERN = String.raw`\.\,\;\!\?`

const STOP_CHAR_PATTERN = '[' + PUNCTUATION_CHAR_PATTERN + ']'

const END_CHAR_PATTERN = '[^' + String.raw`\s` + PUNCTUATION_CHAR_PATTERN + ']'
...
// prettier-ignore
const LINK_INPUT_PATTERN = LINK_RE_BASE_PATTERN + STOP_CHAR_PATTERN + '?' + String.raw`\s$`
// prettier-ignore
const LINK_MARK_PATTERN = LINK_RE_BASE_PATTERN + '(?=' + STOP_CHAR_PATTERN + String.raw`|\s|$)`
