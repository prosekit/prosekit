...
export const loaders = {
  ...
  'react-binding-suspense-view': lazy(() => import('./examples/react-binding-suspense-view/index.ts').then((m) => ({ default: m.ExampleEditor }))),
  'react-suspense-view': lazy(() => import('./examples/react-suspense-view/index.ts').then((m) => ({ default: m.ExampleEditor }))),
