...
<code data-typedoc-code><a id="statechange" href="#statechange">stateChange</a>: (`event`: \{ `node`: [`ProseMirrorNode`](../pm/model.md#prosemirrornode); `pos`: `number`; \} \| `null`) => `void`</code>
...
<code data-typedoc-code><i>const</i> <a id="blockhandleadd" href="#blockhandleadd">BlockHandleAdd</a>: `DefineSetupFnComponent`\<[`BlockHandleAddProps`](#blockhandleaddprops) & `HTMLAttributes`, [`BlockHandleAddEmits`](#blockhandleaddemits)\></code>
...
<code data-typedoc-code><i>const</i> <a id="blockhandledraggable" href="#blockhandledraggable">BlockHandleDraggable</a>: `DefineSetupFnComponent`\<[`BlockHandleDraggableProps`](#blockhandledraggableprops) & `HTMLAttributes`, [`BlockHandleDraggableEmits`](#blockhandledraggableemits)\></code>
...
<code data-typedoc-code><i>const</i> <a id="blockhandlepopover" href="#blockhandlepopover">BlockHandlePopover</a>: `DefineSetupFnComponent`\<[`BlockHandlePopoverProps`](#blockhandlepopoverprops) & `HTMLAttributes`, [`BlockHandlePopoverEmits`](#blockhandlepopoveremits)\></code>
