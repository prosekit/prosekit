...
<code data-typedoc-code><i></i> new <a id="constructor" href="#constructor">AutocompleteEmptyElement</a>(): [`AutocompleteEmptyElement`](#autocompleteemptyelement)</code>
...
<code data-typedoc-code><i></i> <a id="filter" href="#filter">filter</a>: `null` \| `ItemFilter`</code>
...
<code data-typedoc-code><i></i> <a id="regex" href="#regex">regex</a>: `null` \| [`RegExp`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/RegExp)</code>
...
<code data-typedoc-code><i></i> <a id="filter-1" href="#filter-1">filter</a>: `null` \| `ItemFilter`</code>
...
<code data-typedoc-code><i></i> <a id="valuechange" href="#valuechange">valueChange</a>: [`CustomEvent`](https://developer.mozilla.org/docs/Web/API/CustomEvent)\<`string`\></code>
...
<code data-typedoc-code><i></i> <a id="regex-1" href="#regex-1">regex</a>: `null` \| [`RegExp`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/RegExp)</code>
...
<code data-typedoc-code><i></i> <a id="querychange" href="#querychange">queryChange</a>: [`CustomEvent`](https://developer.mozilla.org/docs/Web/API/CustomEvent)\<`string`\></code>
