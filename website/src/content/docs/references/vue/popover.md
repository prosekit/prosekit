...
<code data-typedoc-code><i></i> <a id="escapekeydown" href="#escapekeydown">escapeKeyDown</a>: (`event`: `EscapeKeyDownEvent`) => `void`</code>
...
<code data-typedoc-code><i></i> <a id="pointerdownoutside" href="#pointerdownoutside">pointerDownOutside</a>: (`event`: `PointerDownOutsideEvent`) => `void`</code>
...
<code data-typedoc-code><i></i> <a id="focusoutside" href="#focusoutside">focusOutside</a>: (`event`: `FocusOutsideEvent`) => `void`</code>
...
<code data-typedoc-code><i></i> <a id="interactoutside" href="#interactoutside">interactOutside</a>: (`event`: `InteractOutsideEvent`) => `void`</code>
...
<code data-typedoc-code><i></i> <a id="defaultopen" href="#defaultopen">defaultOpen</a><i>?</i>: `boolean`</code>
...
<code data-typedoc-code><i>const</i> <a id="popovercontent" href="#popovercontent">PopoverContent</a>: `DefineSetupFnComponent`\<[`PopoverContentProps`](#popovercontentprops) & `HTMLAttributes`, [`PopoverContentEmits`](#popovercontentemits)\></code>
...
<code data-typedoc-code><i>const</i> <a id="popoverroot" href="#popoverroot">PopoverRoot</a>: `DefineSetupFnComponent`\<[`PopoverRootProps`](#popoverrootprops) & `HTMLAttributes`, [`PopoverRootEmits`](#popoverrootemits)\></code>
...
<code data-typedoc-code><i>const</i> <a id="popovertrigger" href="#popovertrigger">PopoverTrigger</a>: `DefineSetupFnComponent`\<[`PopoverTriggerProps`](#popovertriggerprops) & `HTMLAttributes`, [`PopoverTriggerEmits`](#popovertriggeremits)\></code>
