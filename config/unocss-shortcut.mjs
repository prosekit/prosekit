...
export const shortcuts = {
  ...
  ICON_ITALIC: 'i-ci-italic w-5 h-5',
  ICON_BOLD: 'i-ci-bold w-5 h-5',
  ICON_H1: 'i-ci-heading-h1 w-5 h-5',
  ICON_H2: 'i-ci-heading-h2 w-5 h-5',
  ICON_H3: 'i-ci-heading-h3 w-5 h-5',
  ICON_H4: 'i-ci-heading-h4 w-5 h-5',
  ICON_H5: 'i-ci-heading-h5 w-5 h-5',
  ICON_H6: 'i-ci-heading-h6 w-5 h-5',
  ICON_UNDO: 'i-ci-arrow-undo-up-left w-5 h-5',
  ICON_REDO: 'i-ci-arrow-undo-up-right w-5 h-5',
  ICON_IMAGE: 'i-ci-image-02 w-5 h-5',
