...
<code data-typedoc-code><i>readonly</i> <a id="from" href="#from">from</a>: `number`</code>
...
<code data-typedoc-code><i>readonly</i> <a id="to" href="#to">to</a>: `number`</code>
...
<code data-typedoc-code><i>static</i> <a id="widget" href="#widget">widget</a>(`pos`: `number`, `toDOM`: [`WidgetConstructor`](https://prosemirror.net/docs/ref/#view.WidgetConstructor), `spec?`: `object`): [`Decoration`](#decoration)</code>
...
<code data-typedoc-code><i>static</i> <a id="inline" href="#inline">inline</a>(`from`: `number`, `to`: `number`, `attrs`: [`DecorationAttrs`](#decorationattrs), `spec?`: `object`): [`Decoration`](#decoration)</code>
...
<code data-typedoc-code><i>static</i> <a id="node" href="#node">node</a>(`from`: `number`, `to`: `number`, `attrs`: [`DecorationAttrs`](#decorationattrs), `spec?`: `any`): [`Decoration`](#decoration)</code>
...
<code data-typedoc-code><i>static</i> <a id="empty" href="#empty">empty</a>: [`DecorationSet`](#decorationset)</code>
...
<code data-typedoc-code><i>static</i> <a id="create" href="#create">create</a>(`doc`: [`EditorNode`](model.md#editornode), `decorations`: [`Decoration`](#decoration)[]): [`DecorationSet`](#decorationset)</code>
...
<code data-typedoc-code><a id="map-1" href="#map-1">map</a>(`mapping`: [`Mapping`](transform.md#mapping), `doc`: [`EditorNode`](model.md#editornode), `options?`: `object`): [`DecorationSet`](#decorationset)</code>
...
<code data-typedoc-code><a id="add" href="#add">add</a>(`doc`: [`EditorNode`](model.md#editornode), `decorations`: [`Decoration`](#decoration)[]): [`DecorationSet`](#decorationset)</code>
...
<code data-typedoc-code><a id="forchild-1" href="#forchild-1">forChild</a>(`offset`: `number`, `node`: [`EditorNode`](model.md#editornode)): [`DecorationSet`](#decorationset) \| `DecorationGroup`</code>
...
<code data-typedoc-code><a id="foreachset-1" href="#foreachset-1">forEachSet</a>(`f`: (`set`: [`DecorationSet`](#decorationset)) => `void`): `void`</code>
...
<code data-typedoc-code>new <a id="constructor-2" href="#constructor-2">EditorView</a>(`place`: [`Node`](https://developer.mozilla.org/docs/Web/API/Node) \| ((`editor`: [`HTMLElement`](https://developer.mozilla.org/docs/Web/API/HTMLElement)) => `void`) \| \{ `mount`: [`HTMLElement`](https://developer.mozilla.org/docs/Web/API/HTMLElement); \} \| `null`, `props`: [`DirectEditorProps`](#directeditorprops)): [`EditorView`](#editorview)</code>
...
<code data-typedoc-code><i>readonly</i> <a id="dom-2" href="#dom-2">dom</a>: [`HTMLElement`](https://developer.mozilla.org/docs/Web/API/HTMLElement)</code>
...
<code data-typedoc-code><a id="dragging" href="#dragging">dragging</a>: \{ `slice`: [`Slice`](model.md#slice); `move`: `boolean`; \} \| `null`</code>
...
<code data-typedoc-code><a id="update-2" href="#update-2">update</a>(`props`: [`DirectEditorProps`](#directeditorprops)): `void`</code>
...
<code data-typedoc-code><a id="someprop" href="#someprop">someProp</a>\<PropName, Result\>(`propName`: `PropName`, `f`: (`value`: [`NonNullable`](https://www.typescriptlang.org/docs/handbook/utility-types.html#nonnullabletype)\<[`EditorProps`](#editorprops)\<`any`\>\[`PropName`\]\>) => `Result`): `Result` \| `undefined`</code>
...
<code data-typedoc-code><a id="someprop" href="#someprop">someProp</a>\<PropName\>(`propName`: `PropName`): [`NonNullable`](https://www.typescriptlang.org/docs/handbook/utility-types.html#nonnullabletype)\<[`EditorProps`](#editorprops)\<`any`\>\[`PropName`\]\> \| `undefined`</code>
...
<code data-typedoc-code><a id="posatcoords" href="#posatcoords">posAtCoords</a>(`coords`: `object`): \{ `pos`: `number`; `inside`: `number`; \} \| `null`</code>
...
<code data-typedoc-code><a id="nodedom" href="#nodedom">nodeDOM</a>(`pos`: `number`): [`Node`](https://developer.mozilla.org/docs/Web/API/Node) \| `null`</code>
...
<code data-typedoc-code><a id="map" href="#map">map</a>: (`mapping`: [`Mapping`](transform.md#mapping), `node`: [`EditorNode`](model.md#editornode)) => [`DecorationSource`](#decorationsource)</code>
...
<code data-typedoc-code><a id="forchild" href="#forchild">forChild</a>(`offset`: `number`, `child`: [`EditorNode`](model.md#editornode)): [`DecorationSource`](#decorationsource)</code>
...
<code data-typedoc-code><a id="dom" href="#dom">dom</a>: [`HTMLElement`](https://developer.mozilla.org/docs/Web/API/HTMLElement)</code>
...
<code data-typedoc-code><a id="contentdom" href="#contentdom">contentDOM</a><i>?</i>: [`HTMLElement`](https://developer.mozilla.org/docs/Web/API/HTMLElement) \| `null`</code>
...
<code data-typedoc-code><a id="update" href="#update">update</a><i>?</i>: (`node`: [`EditorNode`](model.md#editornode), `decorations`: readonly [`Decoration`](#decoration)[], `innerDecorations`: [`DecorationSource`](#decorationsource)) => `boolean`</code>
...
<code data-typedoc-code><a id="dom-1" href="#dom-1">dom</a>: [`HTMLElement`](https://developer.mozilla.org/docs/Web/API/HTMLElement)</code>
...
<code data-typedoc-code><a id="contentdom-1" href="#contentdom-1">contentDOM</a><i>?</i>: [`HTMLElement`](https://developer.mozilla.org/docs/Web/API/HTMLElement) \| `null`</code>
...
<code data-typedoc-code><a id="update-1" href="#update-1">update</a><i>?</i>: (`mark`: [`Mark`](model.md#mark)) => `boolean`</code>
...
<code data-typedoc-code>\[event: `string`\]: `any`</code>
...
<code data-typedoc-code><a id="valueschange" href="#valueschange">valuesChange</a>: [`ValuesChangeEvent`](../web/autocomplete.md#valueschangeevent)</code>
...
<code data-typedoc-code><a id="valuechange" href="#valuechange">valueChange</a>: [`ValueChangeEvent`](../web/autocomplete.md#valuechangeevent)</code>
...
<code data-typedoc-code><a id="openchange" href="#openchange">openChange</a>: [`OpenChangeEvent`](../web/autocomplete.md#openchangeevent)</code>
...
<code data-typedoc-code><a id="handleclickon" href="#handleclickon">handleClickOn</a><i>?</i>: (`this`: `P`, `view`: [`EditorView`](#editorview), `pos`: `number`, `node`: [`EditorNode`](model.md#editornode), `nodePos`: `number`, `event`: [`MouseEvent`](https://developer.mozilla.org/docs/Web/API/MouseEvent), `direct`: `boolean`) => `boolean` \| `void`</code>
...
<code data-typedoc-code><a id="handledoubleclickon" href="#handledoubleclickon">handleDoubleClickOn</a><i>?</i>: (`this`: `P`, `view`: [`EditorView`](#editorview), `pos`: `number`, `node`: [`EditorNode`](model.md#editornode), `nodePos`: `number`, `event`: [`MouseEvent`](https://developer.mozilla.org/docs/Web/API/MouseEvent), `direct`: `boolean`) => `boolean` \| `void`</code>
...
<code data-typedoc-code><a id="handletripleclickon" href="#handletripleclickon">handleTripleClickOn</a><i>?</i>: (`this`: `P`, `view`: [`EditorView`](#editorview), `pos`: `number`, `node`: [`EditorNode`](model.md#editornode), `nodePos`: `number`, `event`: [`MouseEvent`](https://developer.mozilla.org/docs/Web/API/MouseEvent), `direct`: `boolean`) => `boolean` \| `void`</code>
...
<code data-typedoc-code><a id="createselectionbetween" href="#createselectionbetween">createSelectionBetween</a><i>?</i>: (`this`: `P`, `view`: [`EditorView`](#editorview), `anchor`: [`ResolvedPos`](model.md#resolvedpos), `head`: [`ResolvedPos`](model.md#resolvedpos)) => [`Selection`](state.md#abstract-selection) \| `null`</code>
...
<code data-typedoc-code><a id="transformpasted" href="#transformpasted">transformPasted</a><i>?</i>: (`this`: `P`, `slice`: [`Slice`](model.md#slice), `view`: [`EditorView`](#editorview), `plain`: `boolean`) => [`Slice`](model.md#slice)</code>
...
<code data-typedoc-code><a id="decorations" href="#decorations">decorations</a><i>?</i>: (`this`: `P`, `state`: [`EditorState`](state.md#editorstate)) => [`DecorationSource`](#decorationsource) \| `null` \| `undefined`</code>
...
<code data-typedoc-code><a id="handleclickon-1" href="#handleclickon-1">handleClickOn</a><i>?</i>: (`this`: `any`, `view`: [`EditorView`](#editorview), `pos`: `number`, `node`: [`EditorNode`](model.md#editornode), `nodePos`: `number`, `event`: [`MouseEvent`](https://developer.mozilla.org/docs/Web/API/MouseEvent), `direct`: `boolean`) => `boolean` \| `void`</code>
...
<code data-typedoc-code><a id="handledoubleclickon-1" href="#handledoubleclickon-1">handleDoubleClickOn</a><i>?</i>: (`this`: `any`, `view`: [`EditorView`](#editorview), `pos`: `number`, `node`: [`EditorNode`](model.md#editornode), `nodePos`: `number`, `event`: [`MouseEvent`](https://developer.mozilla.org/docs/Web/API/MouseEvent), `direct`: `boolean`) => `boolean` \| `void`</code>
...
<code data-typedoc-code><a id="handletripleclickon-1" href="#handletripleclickon-1">handleTripleClickOn</a><i>?</i>: (`this`: `any`, `view`: [`EditorView`](#editorview), `pos`: `number`, `node`: [`EditorNode`](model.md#editornode), `nodePos`: `number`, `event`: [`MouseEvent`](https://developer.mozilla.org/docs/Web/API/MouseEvent), `direct`: `boolean`) => `boolean` \| `void`</code>
...
<code data-typedoc-code><a id="createselectionbetween-1" href="#createselectionbetween-1">createSelectionBetween</a><i>?</i>: (`this`: `any`, `view`: [`EditorView`](#editorview), `anchor`: [`ResolvedPos`](model.md#resolvedpos), `head`: [`ResolvedPos`](model.md#resolvedpos)) => [`Selection`](state.md#abstract-selection) \| `null`</code>
...
<code data-typedoc-code><a id="transformpasted-1" href="#transformpasted-1">transformPasted</a><i>?</i>: (`this`: `any`, `slice`: [`Slice`](model.md#slice), `view`: [`EditorView`](#editorview), `plain`: `boolean`) => [`Slice`](model.md#slice)</code>
...
<code data-typedoc-code><a id="decorations-1" href="#decorations-1">decorations</a><i>?</i>: (`this`: `any`, `state`: [`EditorState`](state.md#editorstate)) => [`DecorationSource`](#decorationsource) \| `null` \| `undefined`</code>
...
<code data-typedoc-code>type <a id="decorationattrs" href="#decorationattrs">DecorationAttrs</a> = \{\[`attribute`: `string`\]: `string` \| `undefined`; `nodeName?`: `string`; `class?`: `string`; `style?`: `string`; \}</code>
...
<code data-typedoc-code>\[attribute: `string`\]: `string` \| `undefined`</code>
...
<code data-typedoc-code>type <a id="viewmutationrecord" href="#viewmutationrecord">ViewMutationRecord</a> = [`MutationRecord`](https://developer.mozilla.org/docs/Web/API/MutationRecord) \| \{ `type`: `"selection"`; `target`: [`DOMNode`](https://developer.mozilla.org/en-US/docs/Web/API/Node); \}</code>
