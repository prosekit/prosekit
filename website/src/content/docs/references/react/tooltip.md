...
<code data-typedoc-declaration><i>const</i> <a id="tooltipcontent" href="#tooltipcontent">TooltipContent</a>: `ForwardRefExoticComponent`\<[`TooltipContentProps`](#tooltipcontentprops) & `RefAttributes`\<[`TooltipContentElement`](../web/tooltip.md#tooltipcontentelement)\> & `HTMLAttributes`\<[`TooltipContentElement`](../web/tooltip.md#tooltipcontentelement)\>\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="tooltiproot" href="#tooltiproot">TooltipRoot</a>: `ForwardRefExoticComponent`\<[`TooltipRootProps`](#tooltiprootprops) & `RefAttributes`\<[`TooltipRootElement`](../web/tooltip.md#tooltiprootelement)\> & `HTMLAttributes`\<[`TooltipRootElement`](../web/tooltip.md#tooltiprootelement)\>\></code>
