...
<code data-typedoc-declaration><i></i> <a id="closedelay" href="#closedelay">closeDelay</a><i>?</i>: `number`</code>
...
<code data-typedoc-declaration><i></i> <a id="opendelay" href="#opendelay">openDelay</a><i>?</i>: `number`</code>
...
<code data-typedoc-declaration><i>const</i> <a id="tooltipcontent" href="#tooltipcontent">TooltipContent</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`TooltipContentProps`](#tooltipcontentprops)\> & `RefAttributes`\<[`TooltipContentElement`](../web/tooltip.md#tooltipcontentelement)\> & `HTMLAttributes`\<[`TooltipContentElement`](../web/tooltip.md#tooltipcontentelement)\>\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="tooltiproot" href="#tooltiproot">TooltipRoot</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`TooltipRootProps`](#tooltiprootprops)\> & `RefAttributes`\<[`TooltipRootElement`](../web/tooltip.md#tooltiprootelement)\> & `HTMLAttributes`\<[`TooltipRootElement`](../web/tooltip.md#tooltiprootelement)\>\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="tooltiptrigger" href="#tooltiptrigger">TooltipTrigger</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`TooltipTriggerProps`](#tooltiptriggerprops)\> & `RefAttributes`\<[`TooltipTriggerElement`](../web/tooltip.md#tooltiptriggerelement)\> & `HTMLAttributes`\<[`TooltipTriggerElement`](../web/tooltip.md#tooltiptriggerelement)\>\></code>
