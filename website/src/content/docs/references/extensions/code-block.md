...
<code data-typedoc-declaration><i></i> <a id="language" href="#language">language</a>: `string`</code>
...
<code data-typedoc-declaration><i></i> <a id="aliases" href="#aliases">aliases</a><i>?</i>: `string`[]</code>
...
<code data-typedoc-declaration><i></i> <a id="import" href="#import">import</a>: `DynamicImportLanguageRegistration`</code>
...
<code data-typedoc-declaration><i></i> <a id="displayname" href="#displayname">displayName</a>: `string`</code>
...
<code data-typedoc-declaration><i></i> <a id="id-1" href="#id-1">id</a>: `string`</code>
...
<code data-typedoc-declaration><i></i> <a id="import-1" href="#import-1">import</a>: `DynamicImportThemeRegistration`</code>
...
<code data-typedoc-declaration><i></i> <a id="type" href="#type">type</a>: `"light"` \| `"dark"`</code>
...
<code data-typedoc-declaration><i></i> type <a id="codeblockhighlightoptions" href="#codeblockhighlightoptions">CodeBlockHighlightOptions</a> = \{ `parser`: [`HighlightParser`](#highlightparser); \}</code>
...
<code data-typedoc-declaration><i></i> <a id="parser" href="#parser">parser</a>: [`HighlightParser`](#highlightparser)</code>
...
<code data-typedoc-declaration><i></i> type <a id="highlightparser" href="#highlightparser">HighlightParser</a> = `Parser`</code>
...
<code data-typedoc-declaration><i>const</i> <a id="shikibundledlanguagesinfo" href="#shikibundledlanguagesinfo">shikiBundledLanguagesInfo</a>: [`ShikiBundledLanguageInfo`](#shikibundledlanguageinfo)[]</code>
...
<code data-typedoc-declaration><i>const</i> <a id="shikibundledthemesinfo" href="#shikibundledthemesinfo">shikiBundledThemesInfo</a>: [`ShikiBundledThemeInfo`](#shikibundledthemeinfo)[]</code>
...
<code data-typedoc-declaration><i>function</i> <i></i> <a id="definecodeblock-2" href="#definecodeblock-2">defineCodeBlock</a>(): `CodeBlockExtension`</code>
...
<code data-typedoc-declaration><i>function</i> <i></i> <a id="definecodeblockcommands-2" href="#definecodeblockcommands-2">defineCodeBlockCommands</a>(): `CodeBlockCommandsExtension`</code>
...
<code data-typedoc-declaration><i>function</i> <i></i> <a id="definecodeblockenterrule-2" href="#definecodeblockenterrule-2">defineCodeBlockEnterRule</a>(): `PlainExtension`</code>
...
<code data-typedoc-declaration><i>function</i> <i></i> <a id="definecodeblockhighlight-2" href="#definecodeblockhighlight-2">defineCodeBlockHighlight</a>(`options`: [`CodeBlockHighlightOptions`](#codeblockhighlightoptions)): [`Extension`](../core.md#extension-1)</code>
...
<code data-typedoc-declaration><i>function</i> <i></i> <a id="definecodeblockinputrule-2" href="#definecodeblockinputrule-2">defineCodeBlockInputRule</a>(): `PlainExtension`</code>
...
<code data-typedoc-declaration><i>function</i> <i></i> <a id="definecodeblockkeymap-2" href="#definecodeblockkeymap-2">defineCodeBlockKeymap</a>(): `PlainExtension`</code>
...
<code data-typedoc-declaration><i>function</i> <i></i> <a id="definecodeblockshiki-2" href="#definecodeblockshiki-2">defineCodeBlockShiki</a>(`options`: `CodeBlockShikiOptions`): [`Extension`](../core.md#extension-1)</code>
...
<code data-typedoc-declaration><i>function</i> <i></i> <a id="definecodeblockspec-2" href="#definecodeblockspec-2">defineCodeBlockSpec</a>(): `CodeBlockSpecExtension`</code>
