...
import {
  ...
  type MenuPopupProps as MenuPopupElementProps,
...
function MenuPopupComponent(
  props: MenuPopupProps,
  forwardedRef: ForwardedRef<MenuPopupElement>,
) {
  registerMenuPopupElement();
 ...
 * @public
 */
export const MenuPopup: ForwardRefExoticComponent<
  MenuPopupProps & RefAttributes<MenuPopupElement>
> = /* @__PURE__ */ forwardRef(MenuPopupComponent);
