...
<code data-typedoc-declaration><i>const</i> <a id="popovercontent" href="#popovercontent">PopoverContent</a>: `ForwardRefExoticComponent`\<[`PopoverContentProps`](#popovercontentprops) & `RefAttributes`\<[`PopoverContentElement`](../web/popover.md#popovercontentelement)\> & `HTMLAttributes`\<[`PopoverContentElement`](../web/popover.md#popovercontentelement)\>\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="popoverroot" href="#popoverroot">PopoverRoot</a>: `ForwardRefExoticComponent`\<[`PopoverRootProps`](#popoverrootprops) & `RefAttributes`\<[`PopoverRootElement`](../web/popover.md#popoverrootelement)\> & `HTMLAttributes`\<[`PopoverRootElement`](../web/popover.md#popoverrootelement)\>\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="popovertrigger" href="#popovertrigger">PopoverTrigger</a>: `ForwardRefExoticComponent`\<[`PopoverTriggerProps`](#popovertriggerprops) & `RefAttributes`\<[`PopoverTriggerElement`](../web/popover.md#popovertriggerelement)\> & `HTMLAttributes`\<[`PopoverTriggerElement`](../web/popover.md#popovertriggerelement)\>\></code>
