...
<code data-typedoc-declaration><i>const</i> <a id="inlinepopover" href="#inlinepopover">InlinePopover</a>: `ForwardRefExoticComponent`\<[`InlinePopoverProps`](#inlinepopoverprops) & `RefAttributes`\<[`InlinePopoverElement`](../web/inline-popover.md#inlinepopoverelement)\> & `HTMLAttributes`\<[`InlinePopoverElement`](../web/inline-popover.md#inlinepopoverelement)\>\></code>
