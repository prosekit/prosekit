...
<code data-typedoc-declaration><i></i> <a id="attrs" href="#attrs">attrs</a><i>?</i>: `null` \| [`Attrs`](pm/model.md#attrs-4)</code>
...
<code data-typedoc-declaration><i></i> <a id="node" href="#node">node</a><i>?</i>: [`ProseMirrorNode`](pm/model.md#prosemirrornode)</code>
...
<code data-typedoc-declaration><i></i> <a id="attrs-1" href="#attrs-1">attrs</a><i>?</i>: [`Attrs`](pm/model.md#attrs-4)</code>
...
<code data-typedoc-declaration><i></i> <a id="type-3" href="#type-3">type</a>: `string` \| [`MarkType`](pm/model.md#marktype-1)</code>
...
<code data-typedoc-declaration><i></i> <a id="attrs-2" href="#attrs-2">attrs</a><i>?</i>: `null` \| [`Attrs`](pm/model.md#attrs-4)</code>
...
<code data-typedoc-declaration><i></i> <a id="type-4" href="#type-4">type</a>: `string` \| [`NodeType`](pm/model.md#nodetype)</code>
...
<code data-typedoc-declaration><i></i> <a id="type-5" href="#type-5">type</a>: `string` \| [`NodeType`](pm/model.md#nodetype)</code>
...
<code data-typedoc-declaration><i></i> <a id="attrs-3" href="#attrs-3">attrs</a><i>?</i>: `null` \| [`Attrs`](pm/model.md#attrs-4)</code>
...
<code data-typedoc-declaration><i></i> <a id="type-6" href="#type-6">type</a>: `string` \| [`NodeType`](pm/model.md#nodetype) \| `string`[] \| [`NodeType`](pm/model.md#nodetype)[]</code>
...
<code data-typedoc-declaration><i></i> <a id="attrs-4" href="#attrs-4">attrs</a>: [`Attrs`](pm/model.md#attrs-4)</code>
...
<code data-typedoc-declaration><i></i> <a id="type-7" href="#type-7">type</a>: `string` \| [`MarkType`](pm/model.md#marktype-1)</code>
...
<code data-typedoc-declaration><i></i> <a id="attrs-5" href="#attrs-5">attrs</a><i>?</i>: `null` \| [`Attrs`](pm/model.md#attrs-4)</code>
...
<code data-typedoc-declaration><i></i> <a id="type-8" href="#type-8">type</a>: `string` \| [`NodeType`](pm/model.md#nodetype)</code>
...
<code data-typedoc-declaration><i></i> <a id="attrs-6" href="#attrs-6">attrs</a><i>?</i>: `null` \| [`Attrs`](pm/model.md#attrs-4)</code>
...
<code data-typedoc-declaration><i></i> <a id="attrs-7" href="#attrs-7">attrs</a><i>?</i>: `null` \| [`Attrs`](pm/model.md#attrs-4)</code>
...
<code data-typedoc-declaration><i></i> <a id="type-10" href="#type-10">type</a>: `string` \| [`NodeType`](pm/model.md#nodetype)</code>
...
<code data-typedoc-declaration><i></i> <a id="attrs-8" href="#attrs-8">attrs</a><i>?</i>: `null` \| [`Attrs`](pm/model.md#attrs-4)</code>
...
<code data-typedoc-declaration><i></i> <a id="depth" href="#depth">depth</a><i>?</i>: `number`</code>
...
<code data-typedoc-declaration><i></i> <a id="attrs-12" href="#attrs-12">attrs</a><i>?</i>: \{ \[K in string \| number \| symbol\]: AttrSpec\<Attrs\[K\]\> \}</code>
...
<code data-typedoc-declaration><i></i> <a id="todom" href="#todom">toDOM</a><i>?</i>: (`mark`: [`Mark`](pm/model.md#mark), `inline`: `boolean`) => [`DOMOutputSpec`](pm/model.md#domoutputspec)</code>
...
<code data-typedoc-declaration><i></i> <a id="parsedom" href="#parsedom">parseDOM</a><i>?</i>: readonly [`ParseRule`](pm/model.md#parserule)[]</code>
...
<code data-typedoc-declaration><i></i> <a id="type-11" href="#type-11">type</a>: `MarkName`</code>
...
<code data-typedoc-declaration><i></i> <a id="todom-1" href="#todom-1">toDOM</a><i>?</i>: (`value`: `AttrType`) => `undefined` \| `null` \| \[`string`, `string`\]</code>
...
<code data-typedoc-declaration><i></i> <a id="parsedom-1" href="#parsedom-1">parseDOM</a><i>?</i>: (`node`: [`HTMLElement`](https://developer.mozilla.org/docs/Web/API/HTMLElement)) => `AttrType`</code>
...
<code data-typedoc-declaration><i></i> <a id="default" href="#default">default</a><i>?</i>: `AttrType`</code>
...
<code data-typedoc-declaration><i></i> <a id="topnode" href="#topnode">topNode</a><i>?</i>: `boolean`</code>
...
<code data-typedoc-declaration><i></i> <a id="attrs-14" href="#attrs-14">attrs</a><i>?</i>: \{ \[key in string \| number \| symbol\]: AttrSpec\<Attrs\[key\]\> \}</code>
...
<code data-typedoc-declaration><i></i> <a id="content" href="#content">content</a><i>?</i>: `string`</code>
...
<code data-typedoc-declaration><i></i> <a id="marks-1" href="#marks-1">marks</a><i>?</i>: `string`</code>
...
<code data-typedoc-declaration><i></i> <a id="todom-2" href="#todom-2">toDOM</a><i>?</i>: (`node`: [`ProseMirrorNode`](pm/model.md#prosemirrornode)) => [`DOMOutputSpec`](pm/model.md#domoutputspec)</code>
...
<code data-typedoc-declaration><i></i> <a id="parsedom-2" href="#parsedom-2">parseDOM</a><i>?</i>: readonly [`TagParseRule`](pm/model.md#tagparserule)[]</code>
...
<code data-typedoc-declaration><i></i> <a id="type-12" href="#type-12">type</a>: `NodeName`</code>
...
<code data-typedoc-declaration><i></i> <a id="todom-3" href="#todom-3">toDOM</a><i>?</i>: (`value`: `AttrType`) => `undefined` \| `null` \| \[`string`, `string`\]</code>
...
<code data-typedoc-declaration><i></i> <a id="parsedom-3" href="#parsedom-3">parseDOM</a><i>?</i>: (`node`: [`HTMLElement`](https://developer.mozilla.org/docs/Web/API/HTMLElement)) => `AttrType`</code>
...
<code data-typedoc-declaration><i></i> <a id="priority" href="#priority">priority</a><i>?</i>: [`Priority`](#priority-1)</code>
...
<code data-typedoc-declaration><i></i> <a id="type-13" href="#type-13">type</a>: `string`</code>
...
<code data-typedoc-declaration><i></i> <a id="marks-2" href="#marks-2">marks</a><i>?</i>: `object`[]</code>
...
<code data-typedoc-declaration><i></i> <a id="content-1" href="#content-1">content</a><i>?</i>: [`NodeJSON`](#nodejson)[]</code>
...
<code data-typedoc-declaration><i></i> <a id="attrs-15" href="#attrs-15">attrs</a><i>?</i>: [`Record`](https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeys-type)\<`string`, `any`\></code>
...
<code data-typedoc-declaration><i></i> <a id="type-14" href="#type-14">type</a>: `string`</code>
...
<code data-typedoc-declaration><i></i> <a id="node-1" href="#node-1">node</a>: [`ProseMirrorNode`](pm/model.md#prosemirrornode)</code>
...
<code data-typedoc-declaration><i></i> <a id="pos-4" href="#pos-4">pos</a>: `number`</code>
...
<code data-typedoc-declaration><i></i> <a id="topnode-1" href="#topnode-1">topNode</a><i>?</i>: [`ProseMirrorNode`](pm/model.md#prosemirrornode)</code>
...
<code data-typedoc-declaration><i></i> <a id="topmatch" href="#topmatch">topMatch</a><i>?</i>: [`ContentMatch`](pm/model.md#contentmatch-1)</code>
...
<code data-typedoc-declaration><i></i> type <a id="pastehandler" href="#pastehandler">PasteHandler</a> = (`view`: [`EditorView`](pm/view.md#editorview), `event`: [`ClipboardEvent`](https://developer.mozilla.org/docs/Web/API/ClipboardEvent), `slice`: [`Slice`](pm/model.md#slice)) => `boolean` \| `void`</code>
...
<code data-typedoc-declaration><i></i> type <a id="drophandler" href="#drophandler">DropHandler</a> = (`view`: [`EditorView`](pm/view.md#editorview), `event`: [`DragEvent`](https://developer.mozilla.org/docs/Web/API/DragEvent), `slice`: [`Slice`](pm/model.md#slice), `moved`: `boolean`) => `boolean` \| `void`</code>
...
<code data-typedoc-declaration><i></i> type <a id="anyattrs" href="#anyattrs">AnyAttrs</a> = [`Attrs`](pm/model.md#attrs-4)</code>
...
<code data-typedoc-declaration><i>function</i> <i></i> <a id="withpriority" href="#withpriority">withPriority</a>\<T\>(`extension`: `T`, `priority`: [`Priority`](#priority-1)): `T`</code>
...
<code data-typedoc-declaration><i>function</i> <i></i> <a id="istextselection" href="#istextselection">isTextSelection</a>(`value`: [`Selection`](pm/state.md#selection-3)): `value is TextSelection`</code>
...
<code data-typedoc-declaration><i>function</i> <i></i> <a id="isnodeselection" href="#isnodeselection">isNodeSelection</a>(`value`: [`Selection`](pm/state.md#selection-3)): `value is NodeSelection`</code>
...
<code data-typedoc-declaration><i>function</i> <i></i> <a id="isallselection" href="#isallselection">isAllSelection</a>(`value`: [`Selection`](pm/state.md#selection-3)): `value is AllSelection`</code>
