...
<code data-typedoc-code><i></i> <a id="language" href="#language">language</a>: `string`</code>
...
<code data-typedoc-code><i></i> <a id="import" href="#import">import</a>: `DynamicImportLanguageRegistration`</code>
...
<code data-typedoc-code><i></i> <a id="aliases" href="#aliases">aliases</a><i>?</i>: `string`[]</code>
...
<code data-typedoc-code><i></i> <a id="id-1" href="#id-1">id</a>: `string`</code>
...
<code data-typedoc-code><i></i> <a id="displayname" href="#displayname">displayName</a>: `string`</code>
...
<code data-typedoc-code><i></i> <a id="type" href="#type">type</a>: `"light"` \| `"dark"`</code>
...
<code data-typedoc-code><i></i> <a id="import-1" href="#import-1">import</a>: `DynamicImportThemeRegistration`</code>
...
<code data-typedoc-code><i></i> type <a id="highlightparser" href="#highlightparser">HighlightParser</a> = `Parser`</code>
...
<code data-typedoc-code><i></i> type <a id="codeblockhighlightoptions" href="#codeblockhighlightoptions">CodeBlockHighlightOptions</a> = \{ `parser`: [`HighlightParser`](#highlightparser); \}</code>
...
<code data-typedoc-code><i></i> <a id="parser" href="#parser">parser</a>: [`HighlightParser`](#highlightparser)</code>
...
<code data-typedoc-code><i>function</i> <i></i> <a id="definecodeblockcommands" href="#definecodeblockcommands">defineCodeBlockCommands</a>(): `CodeBlockCommandsExtension`</code>
...
<code data-typedoc-code><i>function</i> <i></i> <a id="definecodeblockhighlight" href="#definecodeblockhighlight">defineCodeBlockHighlight</a>(`options`: [`CodeBlockHighlightOptions`](#codeblockhighlightoptions)): [`Extension`](../core.md#extension-1)</code>
...
<code data-typedoc-code><i>function</i> <i></i> <a id="definecodeblockinputrule" href="#definecodeblockinputrule">defineCodeBlockInputRule</a>(): `PlainExtension`</code>
...
<code data-typedoc-code><i>function</i> <i></i> <a id="definecodeblockenterrule" href="#definecodeblockenterrule">defineCodeBlockEnterRule</a>(): `PlainExtension`</code>
...
<code data-typedoc-code><i>function</i> <i></i> <a id="definecodeblockkeymap" href="#definecodeblockkeymap">defineCodeBlockKeymap</a>(): `PlainExtension`</code>
...
<code data-typedoc-code><i>function</i> <i></i> <a id="definecodeblockshiki" href="#definecodeblockshiki">defineCodeBlockShiki</a>(`options`: `CodeBlockShikiOptions`): [`Extension`](../core.md#extension-1)</code>
...
<code data-typedoc-code><i>function</i> <i></i> <a id="definecodeblockspec" href="#definecodeblockspec">defineCodeBlockSpec</a>(): `CodeBlockSpecExtension`</code>
...
<code data-typedoc-code><i>function</i> <i></i> <a id="definecodeblock" href="#definecodeblock">defineCodeBlock</a>(): `CodeBlockExtension`</code>
