...
<code data-typedoc-code><i></i> <a id="contentelement" href="#contentelement">contentElement</a><i>?</i>: `string` \| [`HTMLElement`](https://developer.mozilla.org/docs/Web/API/HTMLElement) \| (`node`: [`Node`](https://developer.mozilla.org/docs/Web/API/Node)) => [`HTMLElement`](https://developer.mozilla.org/docs/Web/API/HTMLElement)</code>
