---
title: CodeBlock
description: Code blocks with optional syntax highlighting
---
...
You can render diagram-oriented DSL previews inside code blocks by combining `defineCodeBlock` with a custom node view. ProseKit includes a built-in example for [Mermaid](https://mermaid.js.org).

See the [DSL diagram rendering](/guides/dsl) guide for complete setup instructions and code examples. For LaTeX-style math, prefer the dedicated `math` extension instead of rendering it inside a code block.
