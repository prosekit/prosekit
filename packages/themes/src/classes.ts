...
export const EDITOR_VIEWPORT = cn(
  'box-border h-full w-full min-h-36 overflow-y-hidden overflow-x-hidden rounded-md border border-solid border-gray-200 dark:border-zinc-700 shadow flex flex-col bg-background color-black dark:color-white',
)
