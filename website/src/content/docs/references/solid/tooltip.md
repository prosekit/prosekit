...
Props for the [TooltipPopup](#tooltippopup) Solid component.

***

### TooltipPositionerProps {#tooltippositionerprops}

Props for the [TooltipPositioner](#tooltippositioner) Solid component.
...
Props for the [TooltipRoot](#tooltiproot) Solid component.
...
Props for the [TooltipTrigger](#tooltiptrigger) Solid component.
...
<code data-typedoc-code><i>const</i> <a id="tooltippopup" href="#tooltippopup">TooltipPopup</a>: `Component`\<[`TooltipPopupProps`](#tooltippopupprops) & `JSX.HTMLAttributes`\<[`TooltipPopupElement`](../web/tooltip.md#tooltippopupelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tooltippositioner" href="#tooltippositioner">TooltipPositioner</a>: `Component`\<[`TooltipPositionerProps`](#tooltippositionerprops) & `JSX.HTMLAttributes`\<[`TooltipPositionerElement`](../web/tooltip.md#tooltippositionerelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tooltiproot" href="#tooltiproot">TooltipRoot</a>: `Component`\<[`TooltipRootProps`](#tooltiprootprops) & `JSX.HTMLAttributes`\<[`TooltipRootElement`](../web/tooltip.md#tooltiprootelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tooltiptrigger" href="#tooltiptrigger">TooltipTrigger</a>: `Component`\<[`TooltipTriggerProps`](#tooltiptriggerprops) & `JSX.HTMLAttributes`\<[`TooltipTriggerElement`](../web/tooltip.md#tooltiptriggerelement)\>\></code>
