...
export { createMarkActions, createNodeActions } from './editor/action.ts'
...
export { BaseExtension } from './facets/base-extension.ts'
export { FacetNode, unionFacetNode, subtractFacetNode } from './facets/facet-node.ts'
