...
```ts
function PopoverContent(props: PopoverContentProps & RefAttributes<PopoverContentElement> & HTMLAttributes<PopoverContentElement>): ReactNode
```

## PopoverRoot {#popover-root-1}

```ts
function PopoverRoot(props: PopoverRootProps & RefAttributes<PopoverRootElement> & HTMLAttributes<PopoverRootElement>): ReactNode
```

## PopoverTrigger {#popover-trigger-1}

```ts
function PopoverTrigger(props: PopoverTriggerProps & RefAttributes<PopoverTriggerElement> & HTMLAttributes<PopoverTriggerElement>): ReactNode
```
