...
<code data-typedoc-declaration><i></i> new <a id="constructorinlinepopoverelement" href="#constructorinlinepopoverelement">InlinePopoverElement</a>(): [`InlinePopoverElement`](#inlinepopoverelement)</code>
...
<code data-typedoc-declaration><i></i> <a id="dismissonescape" href="#dismissonescape">dismissOnEscape</a>: `boolean`</code>
...
- [`Omit`](https://www.typescriptlang.org/docs/handbook/utility-types.html#omittype-keys)\<`OverlayPositionerProps`, `"placement"` \| `"offset"` \| `"hide"` \| `"overlap"` \| `"inline"` \| `"overflowPadding"`\>
...
<code data-typedoc-declaration><i></i> <a id="dismissonescape-1" href="#dismissonescape-1">dismissOnEscape</a>: `boolean`</code>
