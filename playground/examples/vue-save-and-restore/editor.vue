...
<template>
  <div>
    <button
      ...
      class="my-2 border border-solid bg-white p-2 text-black"
      :class="{
        'disabled:cursor-not-allowed disabled:text-gray-500': !hasUnsavedChange,
      }"
    >
  ...
  <div class="EDITOR_VIEWPORT">
    <div ref="editorMount" class="EDITOR_CONTENT"></div>
  </div>
