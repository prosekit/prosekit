...
Props for the [TableHandleColumnMenuRoot](#tablehandlecolumnmenuroot) React component.
...
Props for the [TableHandleColumnMenuTrigger](#tablehandlecolumnmenutrigger) React component.

***

### TableHandleColumnPopupProps {#tablehandlecolumnpopupprops}

Props for the [TableHandleColumnPopup](#tablehandlecolumnpopup) React component.

***

### TableHandleColumnPositionerProps {#tablehandlecolumnpositionerprops}

Props for the [TableHandleColumnPositioner](#tablehandlecolumnpositioner) React component.
...
Props for the [TableHandleDragPreview](#tablehandledragpreview) React component.

***

### TableHandleDropIndicatorProps {#tablehandledropindicatorprops}

Props for the [TableHandleDropIndicator](#tablehandledropindicator) React component.

***

### TableHandleRootProps {#tablehandlerootprops}

Props for the [TableHandleRoot](#tablehandleroot) React component.

***

### TableHandleRowMenuRootProps {#tablehandlerowmenurootprops}

Props for the [TableHandleRowMenuRoot](#tablehandlerowmenuroot) React component.
...
Props for the [TableHandleRowMenuTrigger](#tablehandlerowmenutrigger) React component.

***

### TableHandleRowPopupProps {#tablehandlerowpopupprops}

Props for the [TableHandleRowPopup](#tablehandlerowpopup) React component.

***

### TableHandleRowPositionerProps {#tablehandlerowpositionerprops}

Props for the [TableHandleRowPositioner](#tablehandlerowpositioner) React component.
