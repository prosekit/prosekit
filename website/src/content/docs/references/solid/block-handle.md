...
Props for the [BlockHandleAdd](#blockhandleadd) Solid component.

***

### BlockHandleDraggableProps {#blockhandledraggableprops}

Props for the [BlockHandleDraggable](#blockhandledraggable) Solid component.

***

### BlockHandlePopupProps {#blockhandlepopupprops}

Props for the [BlockHandlePopup](#blockhandlepopup) Solid component.

***

### BlockHandlePositionerProps {#blockhandlepositionerprops}

Props for the [BlockHandlePositioner](#blockhandlepositioner) Solid component.
...
Props for the [BlockHandleRoot](#blockhandleroot) Solid component.
...
<code data-typedoc-code><i>const</i> <a id="blockhandleadd" href="#blockhandleadd">BlockHandleAdd</a>: `Component`\<[`BlockHandleAddProps`](#blockhandleaddprops) & `JSX.HTMLAttributes`\<[`BlockHandleAddElement`](../web/block-handle.md#blockhandleaddelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="blockhandledraggable" href="#blockhandledraggable">BlockHandleDraggable</a>: `Component`\<[`BlockHandleDraggableProps`](#blockhandledraggableprops) & `JSX.HTMLAttributes`\<[`BlockHandleDraggableElement`](../web/block-handle.md#blockhandledraggableelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="blockhandlepopup" href="#blockhandlepopup">BlockHandlePopup</a>: `Component`\<[`BlockHandlePopupProps`](#blockhandlepopupprops) & `JSX.HTMLAttributes`\<[`BlockHandlePopupElement`](../web/block-handle.md#blockhandlepopupelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="blockhandlepositioner" href="#blockhandlepositioner">BlockHandlePositioner</a>: `Component`\<[`BlockHandlePositionerProps`](#blockhandlepositionerprops) & `JSX.HTMLAttributes`\<[`BlockHandlePositionerElement`](../web/block-handle.md#blockhandlepositionerelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="blockhandleroot" href="#blockhandleroot">BlockHandleRoot</a>: `Component`\<[`BlockHandleRootProps`](#blockhandlerootprops) & `JSX.HTMLAttributes`\<[`BlockHandleRootElement`](../web/block-handle.md#blockhandlerootelement)\>\></code>
