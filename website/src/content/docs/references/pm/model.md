...
<code data-typedoc-code>get <a id="nodeafter" href="#nodeafter">nodeAfter</a>(): [`ProseMirrorNode`](#prosemirrornode) \| `null`</code>
...
<code data-typedoc-code>get <a id="nodebefore" href="#nodebefore">nodeBefore</a>(): [`ProseMirrorNode`](#prosemirrornode) \| `null`</code>
...
<code data-typedoc-code><a id="node" href="#node">node</a>(`depth?`: `number` \| `null`): [`ProseMirrorNode`](#prosemirrornode)</code>
...
<code data-typedoc-code><a id="blockrange" href="#blockrange">blockRange</a>(`other?`: [`ResolvedPos`](#resolvedpos), `pred?`: (`node`: [`ProseMirrorNode`](#prosemirrornode)) => `boolean`): [`NodeRange`](#noderange) \| `null`</code>
...
<code data-typedoc-code><a id="create" href="#create">create</a>(`attrs?`: [`Attrs`](#attrs-4) \| `null`, `content?`: [`ProseMirrorNode`](#prosemirrornode) \| [`ProseMirrorFragment`](#prosemirrorfragment) \| readonly [`ProseMirrorNode`](#prosemirrornode)[] \| `null`, `marks?`: readonly [`Mark`](#mark)[]): [`ProseMirrorNode`](#prosemirrornode)</code>
...
<code data-typedoc-code><a id="createchecked" href="#createchecked">createChecked</a>(`attrs?`: [`Attrs`](#attrs-4) \| `null`, `content?`: [`ProseMirrorNode`](#prosemirrornode) \| [`ProseMirrorFragment`](#prosemirrorfragment) \| readonly [`ProseMirrorNode`](#prosemirrornode)[] \| `null`, `marks?`: readonly [`Mark`](#mark)[]): [`ProseMirrorNode`](#prosemirrornode)</code>
...
<code data-typedoc-code><a id="createandfill" href="#createandfill">createAndFill</a>(`attrs?`: [`Attrs`](#attrs-4) \| `null`, `content?`: [`ProseMirrorNode`](#prosemirrornode) \| [`ProseMirrorFragment`](#prosemirrorfragment) \| readonly [`ProseMirrorNode`](#prosemirrornode)[] \| `null`, `marks?`: readonly [`Mark`](#mark)[]): [`ProseMirrorNode`](#prosemirrornode) \| `null`</code>
...
<code data-typedoc-code><a id="node-2" href="#node-2">node</a>(`type`: `string` \| [`NodeType`](#nodetype), `attrs?`: [`Attrs`](#attrs-4) \| `null`, `content?`: [`ProseMirrorNode`](#prosemirrornode) \| [`ProseMirrorFragment`](#prosemirrorfragment) \| readonly [`ProseMirrorNode`](#prosemirrornode)[], `marks?`: readonly [`Mark`](#mark)[]): [`ProseMirrorNode`](#prosemirrornode)</code>
...
<code data-typedoc-code><a id="text" href="#text">text</a>(`text`: `string`, `marks?`: readonly [`Mark`](#mark)[] \| `null`): [`ProseMirrorNode`](#prosemirrornode)</code>
...
<code data-typedoc-code>get <a id="firstchild" href="#firstchild">firstChild</a>(): [`ProseMirrorNode`](#prosemirrornode) \| `null`</code>
...
<code data-typedoc-code>get <a id="lastchild" href="#lastchild">lastChild</a>(): [`ProseMirrorNode`](#prosemirrornode) \| `null`</code>
...
<code data-typedoc-code><i>static</i> <a id="fromjson-2" href="#fromjson-2">fromJSON</a>(`schema`: [`Schema`](#schema-3), `value`: `any`): [`ProseMirrorFragment`](#prosemirrorfragment)</code>
...
<code data-typedoc-code><i>static</i> <a id="from-2" href="#from-2">from</a>(`nodes?`: [`ProseMirrorNode`](#prosemirrornode) \| [`ProseMirrorFragment`](#prosemirrorfragment) \| readonly [`ProseMirrorNode`](#prosemirrornode)[] \| `null`): [`ProseMirrorFragment`](#prosemirrorfragment)</code>
...
<code data-typedoc-code><a id="nodesbetween" href="#nodesbetween">nodesBetween</a>(`from`: `number`, `to`: `number`, `f`: (`node`: [`ProseMirrorNode`](#prosemirrornode), `start`: `number`, `parent`: [`ProseMirrorNode`](#prosemirrornode) \| `null`, `index`: `number`) => `boolean` \| `void`, `nodeStart?`: `number`, `parent?`: [`ProseMirrorNode`](#prosemirrornode)): `void`</code>
...
<code data-typedoc-code><a id="descendants" href="#descendants">descendants</a>(`f`: (`node`: [`ProseMirrorNode`](#prosemirrornode), `pos`: `number`, `parent`: [`ProseMirrorNode`](#prosemirrornode) \| `null`, `index`: `number`) => `boolean` \| `void`): `void`</code>
...
<code data-typedoc-code><a id="textbetween" href="#textbetween">textBetween</a>(`from`: `number`, `to`: `number`, `blockSeparator?`: `string` \| `null`, `leafText?`: `string` \| ((`leafNode`: [`ProseMirrorNode`](#prosemirrornode)) => `string`) \| `null`): `string`</code>
...
<code data-typedoc-code><a id="eq-2" href="#eq-2">eq</a>(`other`: [`ProseMirrorFragment`](#prosemirrorfragment)): `boolean`</code>
...
<code data-typedoc-code><a id="maybechild" href="#maybechild">maybeChild</a>(`index`: `number`): [`ProseMirrorNode`](#prosemirrornode) \| `null`</code>
...
<code data-typedoc-code><a id="finddiffstart" href="#finddiffstart">findDiffStart</a>(`other`: [`ProseMirrorFragment`](#prosemirrorfragment), `pos?`: `number`): `number` \| `null`</code>
...
<code data-typedoc-code><a id="finddiffend" href="#finddiffend">findDiffEnd</a>(`other`: [`ProseMirrorFragment`](#prosemirrorfragment), `pos?`: `number`, `otherPos?`: `number`): \{ `a`: `number`; `b`: `number`; \} \| `null`</code>
...
<code data-typedoc-code><a id="matchfragment" href="#matchfragment">matchFragment</a>(`frag`: [`ProseMirrorFragment`](#prosemirrorfragment), `start?`: `number`, `end?`: `number`): [`ContentMatch`](#contentmatch-1) \| `null`</code>
...
<code data-typedoc-code><a id="fillbefore" href="#fillbefore">fillBefore</a>(`after`: [`ProseMirrorFragment`](#prosemirrorfragment), `toEnd?`: `boolean`, `startIndex?`: `number`): [`ProseMirrorFragment`](#prosemirrorfragment) \| `null`</code>
...
<code data-typedoc-code>get <a id="firstchild-1" href="#firstchild-1">firstChild</a>(): [`ProseMirrorNode`](#prosemirrornode) \| `null`</code>
...
<code data-typedoc-code>get <a id="lastchild-1" href="#lastchild-1">lastChild</a>(): [`ProseMirrorNode`](#prosemirrornode) \| `null`</code>
...
<code data-typedoc-code><i>static</i> <a id="fromjson-3" href="#fromjson-3">fromJSON</a>(`schema`: [`Schema`](#schema-3), `json`: `any`): [`ProseMirrorNode`](#prosemirrornode)</code>
...
<code data-typedoc-code><a id="child-1" href="#child-1">child</a>(`index`: `number`): [`ProseMirrorNode`](#prosemirrornode)</code>
...
<code data-typedoc-code><a id="maybechild-1" href="#maybechild-1">maybeChild</a>(`index`: `number`): [`ProseMirrorNode`](#prosemirrornode) \| `null`</code>
...
<code data-typedoc-code><a id="foreach-1" href="#foreach-1">forEach</a>(`f`: (`node`: [`ProseMirrorNode`](#prosemirrornode), `offset`: `number`, `index`: `number`) => `void`): `void`</code>
...
<code data-typedoc-code><a id="nodesbetween-1" href="#nodesbetween-1">nodesBetween</a>(`from`: `number`, `to`: `number`, `f`: (`node`: [`ProseMirrorNode`](#prosemirrornode), `pos`: `number`, `parent`: [`ProseMirrorNode`](#prosemirrornode) \| `null`, `index`: `number`) => `boolean` \| `void`, `startPos?`: `number`): `void`</code>
...
<code data-typedoc-code><a id="descendants-1" href="#descendants-1">descendants</a>(`f`: (`node`: [`ProseMirrorNode`](#prosemirrornode), `pos`: `number`, `parent`: [`ProseMirrorNode`](#prosemirrornode) \| `null`, `index`: `number`) => `boolean` \| `void`): `void`</code>
...
<code data-typedoc-code><a id="textbetween-1" href="#textbetween-1">textBetween</a>(`from`: `number`, `to`: `number`, `blockSeparator?`: `string` \| `null`, `leafText?`: `string` \| ((`leafNode`: [`ProseMirrorNode`](#prosemirrornode)) => `string`) \| `null`): `string`</code>
...
<code data-typedoc-code><a id="eq-3" href="#eq-3">eq</a>(`other`: [`ProseMirrorNode`](#prosemirrornode)): `boolean`</code>
...
<code data-typedoc-code><a id="copy" href="#copy">copy</a>(`content?`: [`ProseMirrorFragment`](#prosemirrorfragment) \| `null`): [`ProseMirrorNode`](#prosemirrornode)</code>
...
<code data-typedoc-code><a id="mark-5" href="#mark-5">mark</a>(`marks`: readonly [`Mark`](#mark)[]): [`ProseMirrorNode`](#prosemirrornode)</code>
...
<code data-typedoc-code><a id="cut-1" href="#cut-1">cut</a>(`from`: `number`, `to?`: `number`): [`ProseMirrorNode`](#prosemirrornode)</code>
...
<code data-typedoc-code><a id="nodeat" href="#nodeat">nodeAt</a>(`pos`: `number`): [`ProseMirrorNode`](#prosemirrornode) \| `null`</code>
...
<code data-typedoc-code>type <a id="domoutputspec" href="#domoutputspec">DOMOutputSpec</a> = `string` \| [`DOMNode`](https://developer.mozilla.org/en-US/docs/Web/API/Node) \| \{ `dom`: [`DOMNode`](https://developer.mozilla.org/en-US/docs/Web/API/Node); `contentDOM?`: [`HTMLElement`](https://developer.mozilla.org/docs/Web/API/HTMLElement); \} \| readonly \[`string`, `...any[]`\]</code>
