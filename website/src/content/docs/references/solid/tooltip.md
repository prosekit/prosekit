...
```ts
function TooltipContent(props: PropsWithElement): Element
```

## TooltipRoot {#tooltip-root-2}

```ts
function TooltipRoot(props: PropsWithElement): Element
```

## TooltipTrigger {#tooltip-trigger-2}

```ts
function TooltipTrigger(props: PropsWithElement): Element
```
