...
<code data-typedoc-code><i>protected</i> <a id="result-2" href="#result-2">result</a>: `Result` \| `undefined`</code>
...
<code data-typedoc-code><i>protected</i> <a id="error" href="#error">error</a>: [`Error`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Error) \| `undefined`</code>
...
<code data-typedoc-code><i>static</i> <a id="get" href="#get">get</a>\<Result\>(`objectURL`: `string`): [`UploadTask`](#uploadtask)\<`Result`\> \| `undefined`</code>
