...
<code data-typedoc-code><i>abstract</i> <a id="invert-2" href="#invert-2">invert</a>(`doc`: [`ProseMirrorNode`](model.md#prosemirrornode)): [`Step`](#abstract-step)</code>
...
<code data-typedoc-code><i>readonly</i> <a id="doc" href="#doc">doc</a>: [`ProseMirrorNode`](model.md#prosemirrornode) \| `null`</code>
...
<code data-typedoc-code><a id="apply-1" href="#apply-1">apply</a>(`doc`: [`ProseMirrorNode`](model.md#prosemirrornode)): [`StepResult`](#stepresult)</code>
...
<code data-typedoc-code><a id="apply-3" href="#apply-3">apply</a>(`doc`: [`ProseMirrorNode`](model.md#prosemirrornode)): [`StepResult`](#stepresult)</code>
...
<code data-typedoc-code><a id="invert-5" href="#invert-5">invert</a>(`doc`: [`ProseMirrorNode`](model.md#prosemirrornode)): [`Step`](#abstract-step)</code>
...
<code data-typedoc-code><a id="invert-6" href="#invert-6">invert</a>(`doc`: [`ProseMirrorNode`](model.md#prosemirrornode)): [`Step`](#abstract-step)</code>
...
<code data-typedoc-code><a id="apply-5" href="#apply-5">apply</a>(`doc`: [`ProseMirrorNode`](model.md#prosemirrornode)): [`StepResult`](#stepresult)</code>
...
<code data-typedoc-code><a id="invert-7" href="#invert-7">invert</a>(`doc`: [`ProseMirrorNode`](model.md#prosemirrornode)): [`ReplaceStep`](#replacestep)</code>
...
<code data-typedoc-code><a id="invert-8" href="#invert-8">invert</a>(`doc`: [`ProseMirrorNode`](model.md#prosemirrornode)): [`ReplaceAroundStep`](#replacearoundstep)</code>
...
<code data-typedoc-code><a id="apply-7" href="#apply-7">apply</a>(`doc`: [`ProseMirrorNode`](model.md#prosemirrornode)): [`StepResult`](#stepresult)</code>
...
<code data-typedoc-code><a id="invert-9" href="#invert-9">invert</a>(`doc`: [`ProseMirrorNode`](model.md#prosemirrornode)): [`AttrStep`](#attrstep)</code>
...
<code data-typedoc-code><a id="invert-10" href="#invert-10">invert</a>(`doc`: [`ProseMirrorNode`](model.md#prosemirrornode)): [`DocAttrStep`](#docattrstep)</code>
...
<code data-typedoc-code><i>function</i> <a id="cansplit" href="#cansplit">canSplit</a>(`doc`: [`ProseMirrorNode`](model.md#prosemirrornode), `pos`: `number`, `depth?`: `number`, `typesAfter?`: (\{ `type`: [`NodeType`](model.md#nodetype); `attrs?`: [`Attrs`](model.md#attrs-4) \| `null`; \} \| `null`)[]): `boolean`</code>
...
<code data-typedoc-code><i>function</i> <a id="joinpoint" href="#joinpoint">joinPoint</a>(`doc`: [`ProseMirrorNode`](model.md#prosemirrornode), `pos`: `number`, `dir?`: `number`): `number` \| `undefined`</code>
...
<code data-typedoc-code><i>function</i> <a id="insertpoint" href="#insertpoint">insertPoint</a>(`doc`: [`ProseMirrorNode`](model.md#prosemirrornode), `pos`: `number`, `nodeType`: [`NodeType`](model.md#nodetype)): `number` \| `null`</code>
...
<code data-typedoc-code><i>function</i> <a id="droppoint" href="#droppoint">dropPoint</a>(`doc`: [`ProseMirrorNode`](model.md#prosemirrornode), `pos`: `number`, `slice`: [`Slice`](model.md#slice)): `number` \| `null`</code>
...
<code data-typedoc-code><i>function</i> <a id="replacestep-1" href="#replacestep-1">replaceStep</a>(`doc`: [`ProseMirrorNode`](model.md#prosemirrornode), `from`: `number`, `to?`: `number`, `slice?`: [`Slice`](model.md#slice)): [`Step`](#abstract-step) \| `null`</code>
