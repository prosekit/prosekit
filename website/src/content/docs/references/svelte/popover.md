...
Props for the [PopoverPopup](#popoverpopup) Svelte component.
...
Props for the [PopoverPositioner](#popoverpositioner) Svelte component.
...
Props for the [PopoverRoot](#popoverroot) Svelte component.
...
Props for the [PopoverTrigger](#popovertrigger) Svelte component.
...
<code data-typedoc-code><i>const</i> <a id="popoverpopup" href="#popoverpopup">PopoverPopup</a>: `Component`\<[`PopoverPopupProps`](#popoverpopupprops) & `HTMLAttributes`\<[`PopoverPopupElement`](../web/popover.md#popoverpopupelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="popoverpositioner" href="#popoverpositioner">PopoverPositioner</a>: `Component`\<[`PopoverPositionerProps`](#popoverpositionerprops) & `HTMLAttributes`\<[`PopoverPositionerElement`](../web/popover.md#popoverpositionerelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="popoverroot" href="#popoverroot">PopoverRoot</a>: `Component`\<[`PopoverRootProps`](#popoverrootprops) & `HTMLAttributes`\<[`PopoverRootElement`](../web/popover.md#popoverrootelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="popovertrigger" href="#popovertrigger">PopoverTrigger</a>: `Component`\<[`PopoverTriggerProps`](#popovertriggerprops) & `HTMLAttributes`\<[`PopoverTriggerElement`](../web/popover.md#popovertriggerelement)\>\></code>
