...
<code data-typedoc-declaration><i></i> <a id="_type" href="#_type">_type</a><i>?</i>: `T`</code>
...
<code data-typedoc-declaration><i></i> type <a id="nodecontent" href="#nodecontent">NodeContent</a> = [`ProseMirrorNode`](pm/model.md#prosemirrornode) \| [`ProseMirrorFragment`](pm/model.md#prosemirrorfragment) \| [`NodeContent`](#nodecontent)[]</code>
...
<code data-typedoc-declaration><i>function</i> <i></i> <a id="collectchildren-2" href="#collectchildren-2">collectChildren</a>(`parent`: [`ProseMirrorNode`](pm/model.md#prosemirrornode) \| [`ProseMirrorFragment`](pm/model.md#prosemirrorfragment)): [`ProseMirrorNode`](pm/model.md#prosemirrornode)[]</code>
...
<code data-typedoc-declaration><i>function</i> <i></i> <a id="collectnodes-2" href="#collectnodes-2">collectNodes</a>(`content`: [`NodeContent`](#nodecontent)): [`ProseMirrorNode`](pm/model.md#prosemirrornode)[]</code>
