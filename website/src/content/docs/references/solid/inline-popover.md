...
<code data-typedoc-code><i></i> <a id="dismissonescape" href="#dismissonescape">dismissOnEscape</a><i>?</i>: `boolean`</code>
...
<code data-typedoc-code><i>const</i> <a id="inlinepopover" href="#inlinepopover">InlinePopover</a>: `Component`\<`PropsWithElement`\<[`InlinePopoverProps`](#inlinepopoverprops), [`InlinePopoverElement`](../web/inline-popover.md#inlinepopoverelement)\>\></code>
