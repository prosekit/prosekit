...
<code data-typedoc-code><i>const</i> <a id="tooltipcontent" href="#tooltipcontent">TooltipContent</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`TooltipContentProps`](#tooltipcontentprops)\> & `RefAttributes`\<[`TooltipContentElement`](../web/tooltip.md#tooltipcontentelement)\> & `HTMLAttributes`\<[`TooltipContentElement`](../web/tooltip.md#tooltipcontentelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tooltiproot" href="#tooltiproot">TooltipRoot</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`TooltipRootProps`](#tooltiprootprops)\> & `RefAttributes`\<[`TooltipRootElement`](../web/tooltip.md#tooltiprootelement)\> & `HTMLAttributes`\<[`TooltipRootElement`](../web/tooltip.md#tooltiprootelement)\>\></code>
