...
<code data-typedoc-declaration><i>const</i> <a id="popovercontent" href="#popovercontent">PopoverContent</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`PopoverContentProps`](#popovercontentprops)\> & `RefAttributes`\<[`PopoverContentElement`](../web/popover.md#popovercontentelement)\> & `HTMLAttributes`\<[`PopoverContentElement`](../web/popover.md#popovercontentelement)\>\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="popoverroot" href="#popoverroot">PopoverRoot</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`PopoverRootProps`](#popoverrootprops)\> & `RefAttributes`\<[`PopoverRootElement`](../web/popover.md#popoverrootelement)\> & `HTMLAttributes`\<[`PopoverRootElement`](../web/popover.md#popoverrootelement)\>\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="popovertrigger" href="#popovertrigger">PopoverTrigger</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`PopoverTriggerProps`](#popovertriggerprops)\> & `RefAttributes`\<[`PopoverTriggerElement`](../web/popover.md#popovertriggerelement)\> & `HTMLAttributes`\<[`PopoverTriggerElement`](../web/popover.md#popovertriggerelement)\>\></code>
