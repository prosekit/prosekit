...
<code data-typedoc-declaration><i>const</i> <a id="tooltipcontent" href="#tooltipcontent">TooltipContent</a>: `DefineSetupFnComponent`\<[`TooltipContentProps`](#tooltipcontentprops) & `HTMLAttributes`, [`TooltipContentEmits`](#tooltipcontentemits)\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="tooltiproot" href="#tooltiproot">TooltipRoot</a>: `DefineSetupFnComponent`\<[`TooltipRootProps`](#tooltiprootprops) & `HTMLAttributes`, [`TooltipRootEmits`](#tooltiprootemits)\></code>
...
<code data-typedoc-declaration><i>const</i> <a id="tooltiptrigger" href="#tooltiptrigger">TooltipTrigger</a>: `DefineSetupFnComponent`\<[`TooltipTriggerProps`](#tooltiptriggerprops) & `HTMLAttributes`, [`TooltipTriggerEmits`](#tooltiptriggeremits)\></code>
