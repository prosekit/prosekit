...
<code data-typedoc-code><i>function</i> <a id="splitblockas" href="#splitblockas">splitBlockAs</a>(`splitNode?`: (`node`: [`EditorNode`](model.md#editornode), `atEnd`: `boolean`, `$from`: [`ResolvedPos`](model.md#resolvedpos)) => \{ `type`: [`NodeType`](model.md#nodetype); `attrs?`: [`Attrs`](model.md#attrs-4); \} \| `null`): [`Command`](state.md#command)</code>
...
<code data-typedoc-code><i>function</i> <a id="autojoin" href="#autojoin">autoJoin</a>(`command`: [`Command`](state.md#command), `isJoinable`: readonly `string`[] \| ((`before`: [`EditorNode`](model.md#editornode), `after`: [`EditorNode`](model.md#editornode)) => `boolean`)): [`Command`](state.md#command)</code>
