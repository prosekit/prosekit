...
<code data-typedoc-code><i>const</i> <a id="popovercontent" href="#popovercontent">PopoverContent</a>: `ForwardRefExoticComponent`\<[`PopoverContentProps`](#popovercontentprops) & `RefAttributes`\<[`PopoverContentElement`](../web/popover.md#popovercontentelement)\> & `HTMLAttributes`\<[`PopoverContentElement`](../web/popover.md#popovercontentelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="popoverroot" href="#popoverroot">PopoverRoot</a>: `ForwardRefExoticComponent`\<[`PopoverRootProps`](#popoverrootprops) & `RefAttributes`\<[`PopoverRootElement`](../web/popover.md#popoverrootelement)\> & `HTMLAttributes`\<[`PopoverRootElement`](../web/popover.md#popoverrootelement)\>\></code>
