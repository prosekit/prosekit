...
Props for the [AutocompleteEmpty](#autocompleteempty) React component.

***

### AutocompleteItemProps {#autocompleteitemprops}

Props for the [AutocompleteItem](#autocompleteitem) React component.
...
Props for the [AutocompletePopup](#autocompletepopup) React component.
...
Props for the [AutocompletePositioner](#autocompletepositioner) React component.
...
Props for the [AutocompleteRoot](#autocompleteroot) React component.
