...
```ts
function BlockHandleAdd(props: PropsWithElement): Element
```

## BlockHandleDraggable {#block-handle-draggable-2}

```ts
function BlockHandleDraggable(props: PropsWithElement): Element
```

## BlockHandlePopover {#block-handle-popover-2}

```ts
function BlockHandlePopover(props: PropsWithElement): Element
```
