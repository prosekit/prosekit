    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          isAvailable: editor.commands.toggleTextColor.canExec({ color: 'gray' }),
          onClick: () => editor.commands.toggleTextColor({ color: 'gray' }),
        },
        {
          key: 'orange',
          label: 'Orange Text',
          ...
          isAvailable: editor.commands.toggleTextColor.canExec({ color: 'orange' }),
          onClick: () => editor.commands.toggleTextColor({ color: 'orange' }),
        },
        {
          key: 'yellow',
          label: 'Yellow Text',
          ...
          isAvailable: editor.commands.toggleTextColor.canExec({ color: 'yellow' }),
          onClick: () => editor.commands.toggleTextColor({ color: 'yellow' }),
        },
        {
          key: 'green',
          label: 'Green Text',
          ...
          isAvailable: editor.commands.toggleTextColor.canExec({ color: 'green' }),
        ...
        },
        {
          ...
          isAvailable: editor.commands.toggleTextColor.canExec({ color: 'blue' }),
        ...
        },
        {
          ...
          isAvailable: editor.commands.toggleTextColor.canExec({ color: 'purple' }),
          onClick: () => editor.commands.toggleTextColor({ color: 'purple' }),
        },
        {
          key: 'pink',
          label: 'Pink Text',
          ...
          isAvailable: editor.commands.toggleTextColor.canExec({ color: 'pink' }),
          onClick: () => editor.commands.toggleTextColor({ color: 'pink' }),
        },
        {
          key: 'red',
          label: 'Red Text',
          ...
          isAvailable: editor.commands.toggleTextColor.canExec({ color: 'red' }),
