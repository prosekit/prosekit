...
Props for the [InlinePopoverPopup](#inlinepopoverpopup) Preact component.

***

### InlinePopoverPositionerProps {#inlinepopoverpositionerprops}

Props for the [InlinePopoverPositioner](#inlinepopoverpositioner) Preact component.
...
Props for the [InlinePopoverRoot](#inlinepopoverroot) Preact component.
...
<code data-typedoc-code><i>const</i> <a id="inlinepopoverpopup" href="#inlinepopoverpopup">InlinePopoverPopup</a>: `ForwardRefExoticComponent`\<[`InlinePopoverPopupProps`](#inlinepopoverpopupprops) & `HTMLAttributes`\<[`InlinePopoverPopupElement`](../web/inline-popover.md#inlinepopoverpopupelement)\> & `RefAttributes`\<[`InlinePopoverPopupElement`](../web/inline-popover.md#inlinepopoverpopupelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="inlinepopoverpositioner" href="#inlinepopoverpositioner">InlinePopoverPositioner</a>: `ForwardRefExoticComponent`\<[`InlinePopoverPositionerProps`](#inlinepopoverpositionerprops) & `HTMLAttributes`\<[`InlinePopoverPositionerElement`](../web/inline-popover.md#inlinepopoverpositionerelement)\> & `RefAttributes`\<[`InlinePopoverPositionerElement`](../web/inline-popover.md#inlinepopoverpositionerelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="inlinepopoverroot" href="#inlinepopoverroot">InlinePopoverRoot</a>: `ForwardRefExoticComponent`\<[`InlinePopoverRootProps`](#inlinepopoverrootprops) & `HTMLAttributes`\<[`InlinePopoverRootElement`](../web/inline-popover.md#inlinepopoverrootelement)\> & `RefAttributes`\<[`InlinePopoverRootElement`](../web/inline-popover.md#inlinepopoverrootelement)\>\></code>
