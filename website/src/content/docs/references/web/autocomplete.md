...
<code data-typedoc-code><a id="filter" href="#filter">filter</a>: `null` \| `ItemFilter`</code>
...
<code data-typedoc-code><a id="regex" href="#regex">regex</a>: `null` \| [`RegExp`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/RegExp)</code>
...
<code data-typedoc-code><a id="filter-1" href="#filter-1">filter</a>: `null` \| `ItemFilter`</code>
...
<code data-typedoc-code><a id="regex-1" href="#regex-1">regex</a>: `null` \| [`RegExp`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/RegExp)</code>
