...
Props for the [AutocompleteEmpty](#autocompleteempty) Preact component.

***

### AutocompleteItemProps {#autocompleteitemprops}

Props for the [AutocompleteItem](#autocompleteitem) Preact component.
...
Props for the [AutocompletePopup](#autocompletepopup) Preact component.
...
Props for the [AutocompletePositioner](#autocompletepositioner) Preact component.
...
Props for the [AutocompleteRoot](#autocompleteroot) Preact component.
...
<code data-typedoc-code><a id="querybuilder" href="#querybuilder">queryBuilder</a><i>?</i>: [`QueryBuilder`](../web/autocomplete.md#querybuilder-2)</code>
...
<code data-typedoc-code><a id="anchor" href="#anchor">anchor</a><i>?</i>: `AnchorReference`</code>
...
<code data-typedoc-code><i>const</i> <a id="autocompleteempty" href="#autocompleteempty">AutocompleteEmpty</a>: `ForwardRefExoticComponent`\<[`AutocompleteEmptyProps`](#autocompleteemptyprops) & `HTMLAttributes`\<[`AutocompleteEmptyElement`](../web/autocomplete.md#autocompleteemptyelement)\> & `RefAttributes`\<[`AutocompleteEmptyElement`](../web/autocomplete.md#autocompleteemptyelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="autocompletepopup" href="#autocompletepopup">AutocompletePopup</a>: `ForwardRefExoticComponent`\<[`AutocompletePopupProps`](#autocompletepopupprops) & `HTMLAttributes`\<[`AutocompletePopupElement`](../web/autocomplete.md#autocompletepopupelement)\> & `RefAttributes`\<[`AutocompletePopupElement`](../web/autocomplete.md#autocompletepopupelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="autocompletepositioner" href="#autocompletepositioner">AutocompletePositioner</a>: `ForwardRefExoticComponent`\<[`AutocompletePositionerProps`](#autocompletepositionerprops) & `HTMLAttributes`\<[`AutocompletePositionerElement`](../web/autocomplete.md#autocompletepositionerelement)\> & `RefAttributes`\<[`AutocompletePositionerElement`](../web/autocomplete.md#autocompletepositionerelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="autocompleteroot" href="#autocompleteroot">AutocompleteRoot</a>: `ForwardRefExoticComponent`\<[`AutocompleteRootProps`](#autocompleterootprops) & `HTMLAttributes`\<[`AutocompleteRootElement`](../web/autocomplete.md#autocompleterootelement)\> & `RefAttributes`\<[`AutocompleteRootElement`](../web/autocomplete.md#autocompleterootelement)\>\></code>
