...
<code data-typedoc-code><a id="doc-1" href="#doc-1">doc</a>: [`EditorNode`](model.md#editornode)</code>
...
<code data-typedoc-code><a id="selection-1" href="#selection-1">selection</a>: [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><a id="storedmarks-1" href="#storedmarks-1">storedMarks</a>: readonly [`Mark`](model.md#mark)[] \| `null`</code>
...
<code data-typedoc-code><a id="getstate" href="#getstate">getState</a>(`state`: [`EditorState`](#editorstate)): `PluginState` \| `undefined`</code>
...
<code data-typedoc-code><a id="get" href="#get">get</a>(`state`: [`EditorState`](#editorstate)): [`ProseMirrorPlugin`](#prosemirrorplugin)\<`PluginState`\> \| `undefined`</code>
...
<code data-typedoc-code><a id="getstate-1" href="#getstate-1">getState</a>(`state`: [`EditorState`](#editorstate)): `PluginState` \| `undefined`</code>
...
<code data-typedoc-code>new <a id="constructor-3" href="#constructor-3">Transaction</a>(`doc`: [`EditorNode`](model.md#editornode)): [`Transaction`](#transaction)</code>
...
<code data-typedoc-code><a id="storedmarks-2" href="#storedmarks-2">storedMarks</a>: readonly [`Mark`](model.md#mark)[] \| `null`</code>
...
<code data-typedoc-code><a id="doc-2" href="#doc-2">doc</a>: [`EditorNode`](model.md#editornode)</code>
...
<code data-typedoc-code><i>readonly</i> <a id="steps" href="#steps">steps</a>: [`Step`](transform.md#abstract-step)[]</code>
...
<code data-typedoc-code><i>readonly</i> <a id="docs" href="#docs">docs</a>: [`EditorNode`](model.md#editornode)[]</code>
...
<code data-typedoc-code>get <a id="selection-2" href="#selection-2">selection</a>(): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code>get <a id="before" href="#before">before</a>(): [`EditorNode`](model.md#editornode)</code>
...
<code data-typedoc-code><a id="setselection" href="#setselection">setSelection</a>(`selection`: [`Selection`](#abstract-selection)): `this`</code>
...
<code data-typedoc-code><a id="setstoredmarks" href="#setstoredmarks">setStoredMarks</a>(`marks`: readonly [`Mark`](model.md#mark)[] \| `null`): `this`</code>
...
<code data-typedoc-code><a id="replaceselectionwith" href="#replaceselectionwith">replaceSelectionWith</a>(`node`: [`EditorNode`](model.md#editornode), `inheritMarks?`: `boolean`): `this`</code>
...
<code data-typedoc-code><a id="step" href="#step">step</a>(`step`: [`Step`](transform.md#abstract-step)): `this`</code>
...
<code data-typedoc-code><a id="maybestep" href="#maybestep">maybeStep</a>(`step`: [`Step`](transform.md#abstract-step)): [`StepResult`](transform.md#stepresult)</code>
...
<code data-typedoc-code><a id="changedrange" href="#changedrange">changedRange</a>(): \{ `from`: `number`; `to`: `number`; \} \| `null`</code>
...
<code data-typedoc-code><a id="replacewith" href="#replacewith">replaceWith</a>(`from`: `number`, `to`: `number`, `content`: [`EditorNode`](model.md#editornode) \| [`EditorFragment`](model.md#editorfragment) \| readonly [`EditorNode`](model.md#editornode)[]): `this`</code>
...
<code data-typedoc-code><a id="insert" href="#insert">insert</a>(`pos`: `number`, `content`: [`EditorNode`](model.md#editornode) \| [`EditorFragment`](model.md#editorfragment) \| readonly [`EditorNode`](model.md#editornode)[]): `this`</code>
...
<code data-typedoc-code><a id="replacerangewith" href="#replacerangewith">replaceRangeWith</a>(`from`: `number`, `to`: `number`, `node`: [`EditorNode`](model.md#editornode)): `this`</code>
...
<code data-typedoc-code><a id="setblocktype" href="#setblocktype">setBlockType</a>(`from`: `number`, `to`: `number` \| `undefined`, `type`: [`NodeType`](model.md#nodetype), `attrs?`: [`Attrs`](model.md#attrs-4) \| ((`oldNode`: [`EditorNode`](model.md#editornode)) => [`Attrs`](model.md#attrs-4)) \| `null`): `this`</code>
...
<code data-typedoc-code><a id="setnodemarkup" href="#setnodemarkup">setNodeMarkup</a>(`pos`: `number`, `type?`: [`NodeType`](model.md#nodetype) \| `null`, `attrs?`: [`Attrs`](model.md#attrs-4) \| `null`, `marks?`: readonly [`Mark`](model.md#mark)[]): `this`</code>
...
<code data-typedoc-code><a id="split" href="#split">split</a>(`pos`: `number`, `depth?`: `number`, `typesAfter?`: (\{ `type`: [`NodeType`](model.md#nodetype); `attrs?`: [`Attrs`](model.md#attrs-4) \| `null`; \} \| `null`)[]): `this`</code>
...
<code data-typedoc-code><a id="removemark" href="#removemark">removeMark</a>(`from`: `number`, `to`: `number`, `mark?`: [`MarkType`](model.md#marktype-1) \| [`Mark`](model.md#mark) \| `null`): `this`</code>
...
<code data-typedoc-code>new <a id="constructor-4" href="#constructor-4">Selection</a>(`$anchor`: [`ResolvedPos`](model.md#resolvedpos), `$head`: [`ResolvedPos`](model.md#resolvedpos), `ranges?`: readonly [`SelectionRange`](#selectionrange)[]): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><i>abstract</i> <a id="eq" href="#eq">eq</a>(`selection`: [`Selection`](#abstract-selection)): `boolean`</code>
...
<code data-typedoc-code><i>abstract</i> <a id="map" href="#map">map</a>(`doc`: [`EditorNode`](model.md#editornode), `mapping`: [`Mappable`](transform.md#mappable)): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><a id="replace-1" href="#replace-1">replace</a>(`tr`: [`Transaction`](#transaction), `content?`: [`Slice`](model.md#slice)): `void`</code>
...
<code data-typedoc-code><a id="replacewith-1" href="#replacewith-1">replaceWith</a>(`tr`: [`Transaction`](#transaction), `node`: [`EditorNode`](model.md#editornode)): `void`</code>
...
<code data-typedoc-code><i>abstract</i> <a id="tojson-2" href="#tojson-2">toJSON</a>(): `any`</code>
...
<code data-typedoc-code><i>static</i> <a id="findfrom" href="#findfrom">findFrom</a>(`$pos`: [`ResolvedPos`](model.md#resolvedpos), `dir`: `number`, `textOnly?`: `boolean`): [`Selection`](#abstract-selection) \| `null`</code>
...
<code data-typedoc-code><i>static</i> <a id="near" href="#near">near</a>(`$pos`: [`ResolvedPos`](model.md#resolvedpos), `bias?`: `number`): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><i>static</i> <a id="atstart" href="#atstart">atStart</a>(`doc`: [`EditorNode`](model.md#editornode)): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><i>static</i> <a id="atend" href="#atend">atEnd</a>(`doc`: [`EditorNode`](model.md#editornode)): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><i>static</i> <a id="fromjson-2" href="#fromjson-2">fromJSON</a>(`doc`: [`EditorNode`](model.md#editornode), `json`: `any`): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code>get <a id="cursor" href="#cursor">$cursor</a>(): [`ResolvedPos`](model.md#resolvedpos) \| `null`</code>
...
<code data-typedoc-code><a id="content-1" href="#content-1">content</a>(): [`Slice`](model.md#slice)</code>
...
<code data-typedoc-code><a id="replacewith-2" href="#replacewith-2">replaceWith</a>(`tr`: [`Transaction`](#transaction), `node`: [`EditorNode`](model.md#editornode)): `void`</code>
...
<code data-typedoc-code><i>static</i> <a id="findfrom-1" href="#findfrom-1">findFrom</a>(`$pos`: [`ResolvedPos`](model.md#resolvedpos), `dir`: `number`, `textOnly?`: `boolean`): [`Selection`](#abstract-selection) \| `null`</code>
...
<code data-typedoc-code><i>static</i> <a id="near-1" href="#near-1">near</a>(`$pos`: [`ResolvedPos`](model.md#resolvedpos), `bias?`: `number`): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><i>static</i> <a id="atstart-1" href="#atstart-1">atStart</a>(`doc`: [`EditorNode`](model.md#editornode)): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><i>static</i> <a id="atend-1" href="#atend-1">atEnd</a>(`doc`: [`EditorNode`](model.md#editornode)): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><i>static</i> <a id="fromjson-3" href="#fromjson-3">fromJSON</a>(`doc`: [`EditorNode`](model.md#editornode), `json`: `any`): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><i>static</i> <a id="jsonid-1" href="#jsonid-1">jsonID</a>(`id`: `string`, `selectionClass`: `object`): `object`</code>
...
<code data-typedoc-code><a id="map-2" href="#map-2">map</a>(`doc`: [`EditorNode`](model.md#editornode), `mapping`: [`Mappable`](transform.md#mappable)): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><a id="eq-1" href="#eq-1">eq</a>(`other`: [`Selection`](#abstract-selection)): `boolean`</code>
...
<code data-typedoc-code><a id="getbookmark-1" href="#getbookmark-1">getBookmark</a>(): [`TextBookmark`](https://prosemirror.net/docs/ref/#state.TextBookmark)</code>
...
<code data-typedoc-code><i>static</i> <a id="create-1" href="#create-1">create</a>(`doc`: [`EditorNode`](model.md#editornode), `anchor`: `number`, `head?`: `number`): [`TextSelection`](#textselection)</code>
...
<code data-typedoc-code><i>static</i> <a id="between" href="#between">between</a>(`$anchor`: [`ResolvedPos`](model.md#resolvedpos), `$head`: [`ResolvedPos`](model.md#resolvedpos), `bias?`: `number`): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><a id="node" href="#node">node</a>: [`EditorNode`](model.md#editornode)</code>
...
<code data-typedoc-code><a id="replace-3" href="#replace-3">replace</a>(`tr`: [`Transaction`](#transaction), `content?`: [`Slice`](model.md#slice)): `void`</code>
...
<code data-typedoc-code><a id="replacewith-3" href="#replacewith-3">replaceWith</a>(`tr`: [`Transaction`](#transaction), `node`: [`EditorNode`](model.md#editornode)): `void`</code>
...
<code data-typedoc-code><i>static</i> <a id="findfrom-2" href="#findfrom-2">findFrom</a>(`$pos`: [`ResolvedPos`](model.md#resolvedpos), `dir`: `number`, `textOnly?`: `boolean`): [`Selection`](#abstract-selection) \| `null`</code>
...
<code data-typedoc-code><i>static</i> <a id="near-2" href="#near-2">near</a>(`$pos`: [`ResolvedPos`](model.md#resolvedpos), `bias?`: `number`): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><i>static</i> <a id="atstart-2" href="#atstart-2">atStart</a>(`doc`: [`EditorNode`](model.md#editornode)): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><i>static</i> <a id="atend-2" href="#atend-2">atEnd</a>(`doc`: [`EditorNode`](model.md#editornode)): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><i>static</i> <a id="fromjson-4" href="#fromjson-4">fromJSON</a>(`doc`: [`EditorNode`](model.md#editornode), `json`: `any`): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><a id="map-3" href="#map-3">map</a>(`doc`: [`EditorNode`](model.md#editornode), `mapping`: [`Mappable`](transform.md#mappable)): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><a id="eq-2" href="#eq-2">eq</a>(`other`: [`Selection`](#abstract-selection)): `boolean`</code>
...
<code data-typedoc-code><a id="getbookmark-2" href="#getbookmark-2">getBookmark</a>(): [`NodeBookmark`](https://prosemirror.net/docs/ref/#state.NodeBookmark)</code>
...
<code data-typedoc-code><i>static</i> <a id="create-2" href="#create-2">create</a>(`doc`: [`EditorNode`](model.md#editornode), `from`: `number`): [`NodeSelection`](#nodeselection)</code>
...
<code data-typedoc-code><i>static</i> <a id="isselectable" href="#isselectable">isSelectable</a>(`node`: [`EditorNode`](model.md#editornode)): `boolean`</code>
...
<code data-typedoc-code>new <a id="constructor-8" href="#constructor-8">AllSelection</a>(`doc`: [`EditorNode`](model.md#editornode)): [`AllSelection`](#allselection)</code>
...
<code data-typedoc-code><a id="content-3" href="#content-3">content</a>(): [`Slice`](model.md#slice)</code>
...
<code data-typedoc-code><a id="replacewith-4" href="#replacewith-4">replaceWith</a>(`tr`: [`Transaction`](#transaction), `node`: [`EditorNode`](model.md#editornode)): `void`</code>
...
<code data-typedoc-code><i>static</i> <a id="findfrom-3" href="#findfrom-3">findFrom</a>(`$pos`: [`ResolvedPos`](model.md#resolvedpos), `dir`: `number`, `textOnly?`: `boolean`): [`Selection`](#abstract-selection) \| `null`</code>
...
<code data-typedoc-code><i>static</i> <a id="near-3" href="#near-3">near</a>(`$pos`: [`ResolvedPos`](model.md#resolvedpos), `bias?`: `number`): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><i>static</i> <a id="atstart-3" href="#atstart-3">atStart</a>(`doc`: [`EditorNode`](model.md#editornode)): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><i>static</i> <a id="atend-3" href="#atend-3">atEnd</a>(`doc`: [`EditorNode`](model.md#editornode)): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><i>static</i> <a id="fromjson-5" href="#fromjson-5">fromJSON</a>(`doc`: [`EditorNode`](model.md#editornode), `json`: `any`): [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><i>static</i> <a id="jsonid-3" href="#jsonid-3">jsonID</a>(`id`: `string`, `selectionClass`: `object`): `object`</code>
...
<code data-typedoc-code><a id="map-4" href="#map-4">map</a>(`doc`: [`EditorNode`](model.md#editornode)): [`AllSelection`](#allselection)</code>
...
<code data-typedoc-code><a id="eq-3" href="#eq-3">eq</a>(`other`: [`Selection`](#abstract-selection)): `boolean`</code>
...
<code data-typedoc-code><a id="getbookmark-3" href="#getbookmark-3">getBookmark</a>(): `object`</code>
...
<code data-typedoc-code><a id="doc" href="#doc">doc</a><i>?</i>: [`EditorNode`](model.md#editornode)</code>
...
<code data-typedoc-code><a id="selection" href="#selection">selection</a><i>?</i>: [`Selection`](#abstract-selection)</code>
...
<code data-typedoc-code><a id="storedmarks" href="#storedmarks">storedMarks</a><i>?</i>: readonly [`Mark`](model.md#mark)[] \| `null`</code>
...
<code data-typedoc-code><a id="appendtransaction" href="#appendtransaction">appendTransaction</a><i>?</i>: (`transactions`: readonly [`Transaction`](#transaction)[], `oldState`: [`EditorState`](#editorstate), `newState`: [`EditorState`](#editorstate)) => [`Transaction`](#transaction) \| `null` \| `undefined`</code>
...
<code data-typedoc-code><a id="apply-1" href="#apply-1">apply</a>: (`tr`: [`Transaction`](#transaction), `value`: `T`, `oldState`: [`EditorState`](#editorstate), `newState`: [`EditorState`](#editorstate)) => `T`</code>
...
<code data-typedoc-code><a id="tojson-1" href="#tojson-1">toJSON</a><i>?</i>: (`value`: `T`) => `any`</code>
...
<code data-typedoc-code><a id="fromjson-1" href="#fromjson-1">fromJSON</a><i>?</i>: (`config`: [`EditorStateConfig`](#editorstateconfig), `value`: `any`, `state`: [`EditorState`](#editorstate)) => `T`</code>
...
<code data-typedoc-code><a id="map-1" href="#map-1">map</a>: (`mapping`: [`Mappable`](transform.md#mappable)) => [`SelectionBookmark`](#selectionbookmark)</code>
...
<code data-typedoc-code><a id="resolve" href="#resolve">resolve</a>: (`doc`: [`EditorNode`](model.md#editornode)) => [`Selection`](#abstract-selection)</code>
