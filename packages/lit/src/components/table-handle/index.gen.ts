...
export { TableHandleDndIndicatorElement as TableHandleDndIndicator } from '@prosekit/web/table-handle'

export { TableHandleDndPreviewElement as TableHandleDndPreview } from '@prosekit/web/table-handle'
