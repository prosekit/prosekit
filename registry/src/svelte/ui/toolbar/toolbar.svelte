...
<div class="CSS_TOOLBAR">
  ...
  {#if $items.blockquote}
    <Button
      ...
      tooltip="Blockquote"
    >
      <div class="CSS_ICON_BLOCKQUOTE"></div>
    </Button>
  {/if}
  {#if $items.bulletList}
    <Button
      ...
      tooltip="Bullet List"
    >
      <div class="CSS_ICON_LIST_BULLET"></div>
    </Button>
  {/if}
  {#if $items.orderedList}
    ...
    >
      <div class="CSS_ICON_LIST_ORDERED"></div>
    </Button>
  {/if}
  {#if $items.taskList}
    <Button
      ...
      tooltip="Task List"
    >
      <div class="CSS_ICON_LIST_TASK"></div>
    </Button>
  {/if}
  {#if $items.toggleList}
    <Button
      ...
      tooltip="Toggle List"
    >
      <div class="CSS_ICON_LIST_TOGGLE"></div>
    </Button>
  {/if}
  {#if $items.indentList}
    <Button
    ...
    >
      <div class="CSS_ICON_LIST_INDENT"></div>
    </Button>
  {/if}
  {#if $items.dedentList}
    <Button
    ...
    >
      <div class="CSS_ICON_LIST_DEDENT"></div>
    </Button>
  {/if}
