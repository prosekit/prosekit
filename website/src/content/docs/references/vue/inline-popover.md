...
<code data-typedoc-declaration><i>const</i> <a id="inlinepopover" href="#inlinepopover">InlinePopover</a>: `DefineSetupFnComponent`\<[`InlinePopoverProps`](#inlinepopoverprops) & `HTMLAttributes`, [`InlinePopoverEmits`](#inlinepopoveremits)\></code>
