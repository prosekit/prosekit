...
<code data-typedoc-code><i>const</i> <a id="tooltipcontent" href="#tooltipcontent">TooltipContent</a>: `Component`\<`PropsWithElement`\<[`TooltipContentProps`](#tooltipcontentprops), [`TooltipContentElement`](../web/tooltip.md#tooltipcontentelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tooltiproot" href="#tooltiproot">TooltipRoot</a>: `Component`\<`PropsWithElement`\<[`TooltipRootProps`](#tooltiprootprops), [`TooltipRootElement`](../web/tooltip.md#tooltiprootelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tooltiptrigger" href="#tooltiptrigger">TooltipTrigger</a>: `Component`\<`PropsWithElement`\<[`TooltipTriggerProps`](#tooltiptriggerprops), [`TooltipTriggerElement`](../web/tooltip.md#tooltiptriggerelement)\>\></code>
