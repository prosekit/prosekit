...
<code data-typedoc-code><a id="editor" href="#editor">editor</a><i>?</i>: `null` \| [`Editor`](../core.md#editor)\<`TableCommandsExtension`\></code>
...
<code data-typedoc-code><a id="editor-1" href="#editor-1">editor</a><i>?</i>: `null` \| [`Editor`](../core.md#editor)\<`any`\></code>
...
<code data-typedoc-code><a id="editor-2" href="#editor-2">editor</a><i>?</i>: `null` \| [`Editor`](../core.md#editor)\<`TableCommandsExtension`\></code>
...
<code data-typedoc-code><a id="editor-3" href="#editor-3">editor</a><i>?</i>: `null` \| [`Editor`](../core.md#editor)\<`any`\></code>
...
<code data-typedoc-code><a id="editor-4" href="#editor-4">editor</a><i>?</i>: `null` \| [`Editor`](../core.md#editor)\<`TableCommandsExtension`\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlecolumnroot" href="#tablehandlecolumnroot">TableHandleColumnRoot</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`TableHandleColumnRootProps`](#tablehandlecolumnrootprops)\> & `RefAttributes`\<[`TableHandleColumnRootElement`](../web/table-handle.md#tablehandlecolumnrootelement)\> & `HTMLAttributes`\<[`TableHandleColumnRootElement`](../web/table-handle.md#tablehandlecolumnrootelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlecolumntrigger" href="#tablehandlecolumntrigger">TableHandleColumnTrigger</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`TableHandleColumnTriggerProps`](#tablehandlecolumntriggerprops)\> & `RefAttributes`\<[`TableHandleColumnTriggerElement`](../web/table-handle.md#tablehandlecolumntriggerelement)\> & `HTMLAttributes`\<[`TableHandleColumnTriggerElement`](../web/table-handle.md#tablehandlecolumntriggerelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandledragpreview" href="#tablehandledragpreview">TableHandleDragPreview</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`TableHandleDragPreviewProps`](#tablehandledragpreviewprops)\> & `RefAttributes`\<[`TableHandleDragPreviewElement`](../web/table-handle.md#tablehandledragpreviewelement)\> & `HTMLAttributes`\<[`TableHandleDragPreviewElement`](../web/table-handle.md#tablehandledragpreviewelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandledropindicator" href="#tablehandledropindicator">TableHandleDropIndicator</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`TableHandleDropIndicatorProps`](#tablehandledropindicatorprops)\> & `RefAttributes`\<[`TableHandleDropIndicatorElement`](../web/table-handle.md#tablehandledropindicatorelement)\> & `HTMLAttributes`\<[`TableHandleDropIndicatorElement`](../web/table-handle.md#tablehandledropindicatorelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlepopovercontent" href="#tablehandlepopovercontent">TableHandlePopoverContent</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`TableHandlePopoverContentProps`](#tablehandlepopovercontentprops)\> & `RefAttributes`\<[`TableHandlePopoverContentElement`](../web/table-handle.md#tablehandlepopovercontentelement)\> & `HTMLAttributes`\<[`TableHandlePopoverContentElement`](../web/table-handle.md#tablehandlepopovercontentelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlepopoveritem" href="#tablehandlepopoveritem">TableHandlePopoverItem</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`TableHandlePopoverItemProps`](#tablehandlepopoveritemprops)\> & `RefAttributes`\<[`TableHandlePopoverItemElement`](../web/table-handle.md#tablehandlepopoveritemelement)\> & `HTMLAttributes`\<[`TableHandlePopoverItemElement`](../web/table-handle.md#tablehandlepopoveritemelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandleroot" href="#tablehandleroot">TableHandleRoot</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`TableHandleRootProps`](#tablehandlerootprops)\> & `RefAttributes`\<[`TableHandleRootElement`](../web/table-handle.md#tablehandlerootelement)\> & `HTMLAttributes`\<[`TableHandleRootElement`](../web/table-handle.md#tablehandlerootelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlerowroot" href="#tablehandlerowroot">TableHandleRowRoot</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`TableHandleRowRootProps`](#tablehandlerowrootprops)\> & `RefAttributes`\<[`TableHandleRowRootElement`](../web/table-handle.md#tablehandlerowrootelement)\> & `HTMLAttributes`\<[`TableHandleRowRootElement`](../web/table-handle.md#tablehandlerowrootelement)\>\></code>
...
<code data-typedoc-code><i>const</i> <a id="tablehandlerowtrigger" href="#tablehandlerowtrigger">TableHandleRowTrigger</a>: `ForwardRefExoticComponent`\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`TableHandleRowTriggerProps`](#tablehandlerowtriggerprops)\> & `RefAttributes`\<[`TableHandleRowTriggerElement`](../web/table-handle.md#tablehandlerowtriggerelement)\> & `HTMLAttributes`\<[`TableHandleRowTriggerElement`](../web/table-handle.md#tablehandlerowtriggerelement)\>\></code>
